...
public:
	...
	struct FMovieSceneSequencePlaybackSettings    PlaybackSettings;                                  // 0x047C(0x0014)(Net, NoDestructor, Protected, NativeAccessSpecifierProtected)
	struct FMovieSceneRootEvaluationTemplateInstance RootTemplateInstance;                           // 0x0490(0x00E8)(Transient, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_578[0x68];                                     // 0x0578(0x0068)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMovieSceneSequenceReplProperties      NetSyncProps;                                      // 0x05E0(0x0010)(Net, NoDestructor, Protected, NativeAccessSpecifierProtected)
	TScriptInterface<class IMovieScenePlaybackClient> PlaybackClient;                                // 0x05F0(0x0010)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	class UMovieSceneSequenceTickManager*         TickManager;                                       // 0x0600(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMovieSceneSequencePlayer) == 0x000678, "Wrong size on UMovieSceneSequencePlayer");
...
static_assert(offsetof(UMovieSceneSequencePlayer, CurrentNumLoops) == 0x000478, "Member 'UMovieSceneSequencePlayer::CurrentNumLoops' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, PlaybackSettings) == 0x00047C, "Member 'UMovieSceneSequencePlayer::PlaybackSettings' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, RootTemplateInstance) == 0x000490, "Member 'UMovieSceneSequencePlayer::RootTemplateInstance' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, NetSyncProps) == 0x0005E0, "Member 'UMovieSceneSequencePlayer::NetSyncProps' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, PlaybackClient) == 0x0005F0, "Member 'UMovieSceneSequencePlayer::PlaybackClient' has a wrong offset!");
static_assert(offsetof(UMovieSceneSequencePlayer, TickManager) == 0x000600, "Member 'UMovieSceneSequencePlayer::TickManager' has a wrong offset!");
