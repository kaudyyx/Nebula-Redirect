...
static_assert(sizeof(FortAthenaLivingWorldPointProviderInterface_IsEnabled) == 0x000002, "Wrong size on FortAthenaLivingWorldPointProviderInterface_IsEnabled");
...
static_assert(offsetof(FortAthenaLivingWorldPointProviderInterface_IsEnabled, ReturnValue) == 0x000001, "Member 'FortAthenaLivingWorldPointProviderInterface_IsEnabled::ReturnValue' has a wrong offset!");
