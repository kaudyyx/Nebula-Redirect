...
static_assert(sizeof(UAthenaVariantTileButton_C) == 0x000C18, "Wrong size on UAthenaVariantTileButton_C");
static_assert(offsetof(UAthenaVariantTileButton_C, UberGraphFrame) == 0x000C10, "Member 'UAthenaVariantTileButton_C::UberGraphFrame' has a wrong offset!");
