...
public:
	...
	bool                                          CallFunc_IsMobilePlatform_ReturnValue;             // 0x0104(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_Not_PreBool_ReturnValue;                  // 0x0105(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
static_assert(offsetof(BP_Pawn_DangerGrape_C_ExecuteUbergraph_BP_Pawn_DangerGrape, CallFunc_SpawnEmitterAttached_ReturnValue) == 0x000008, "Member 'BP_Pawn_DangerGrape_C_ExecuteUbergraph_BP_Pawn_DangerGrape::CallFunc_SpawnEmitterAttached_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Pawn_DangerGrape_C_ExecuteUbergraph_BP_Pawn_DangerGrape, K2Node_Event_Damage) == 0x000010, "Member 'BP_Pawn_DangerGrape_C_ExecuteUbergraph_BP_Pawn_DangerGrape::K2Node_Event_Damage' has a wrong offset!");
static_assert(offsetof(BP_Pawn_DangerGrape_C_ExecuteUbergraph_BP_Pawn_DangerGrape, K2Node_Event_DamageTags) == 0x000018, "Member 'BP_Pawn_DangerGrape_C_ExecuteUbergraph_BP_Pawn_DangerGrape::K2Node_Event_DamageTags' has a wrong offset!");
static_assert(offsetof(BP_Pawn_DangerGrape_C_ExecuteUbergraph_BP_Pawn_DangerGrape, K2Node_Event_Momentum) == 0x000038, "Member 'BP_Pawn_DangerGrape_C_ExecuteUbergraph_BP_Pawn_DangerGrape::K2Node_Event_Momentum' has a wrong offset!");
static_assert(offsetof(BP_Pawn_DangerGrape_C_ExecuteUbergraph_BP_Pawn_DangerGrape, K2Node_Event_HitInfo) == 0x000044, "Member 'BP_Pawn_DangerGrape_C_ExecuteUbergraph_BP_Pawn_DangerGrape::K2Node_Event_HitInfo' has a wrong offset!");
static_assert(offsetof(BP_Pawn_DangerGrape_C_ExecuteUbergraph_BP_Pawn_DangerGrape, K2Node_Event_InstigatedBy) == 0x0000D0, "Member 'BP_Pawn_DangerGrape_C_ExecuteUbergraph_BP_Pawn_DangerGrape::K2Node_Event_InstigatedBy' has a wrong offset!");
static_assert(offsetof(BP_Pawn_DangerGrape_C_ExecuteUbergraph_BP_Pawn_DangerGrape, K2Node_Event_DamageCauser) == 0x0000D8, "Member 'BP_Pawn_DangerGrape_C_ExecuteUbergraph_BP_Pawn_DangerGrape::K2Node_Event_DamageCauser' has a wrong offset!");
static_assert(offsetof(BP_Pawn_DangerGrape_C_ExecuteUbergraph_BP_Pawn_DangerGrape, K2Node_Event_EffectContext) == 0x0000E0, "Member 'BP_Pawn_DangerGrape_C_ExecuteUbergraph_BP_Pawn_DangerGrape::K2Node_Event_EffectContext' has a wrong offset!");
...
static_assert(offsetof(BP_Pawn_DangerGrape_C_ExecuteUbergraph_BP_Pawn_DangerGrape, CallFunc_IsMobilePlatform_ReturnValue) == 0x000104, "Member 'BP_Pawn_DangerGrape_C_ExecuteUbergraph_BP_Pawn_DangerGrape::CallFunc_IsMobilePlatform_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Pawn_DangerGrape_C_ExecuteUbergraph_BP_Pawn_DangerGrape, CallFunc_Not_PreBool_ReturnValue) == 0x000105, "Member 'BP_Pawn_DangerGrape_C_ExecuteUbergraph_BP_Pawn_DangerGrape::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
