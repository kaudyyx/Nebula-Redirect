...
static_assert(sizeof(FProceduralScatter2DPoint) == 0x000040, "Wrong size on FProceduralScatter2DPoint");
...
static_assert(offsetof(FProceduralScatter2DPoint, Scale) == 0x00000C, "Member 'FProceduralScatter2DPoint::Scale' has a wrong offset!");
static_assert(offsetof(FProceduralScatter2DPoint, ScatterSettings) == 0x000010, "Member 'FProceduralScatter2DPoint::ScatterSettings' has a wrong offset!");
static_assert(offsetof(FProceduralScatter2DPoint, MaxAABB) == 0x000018, "Member 'FProceduralScatter2DPoint::MaxAABB' has a wrong offset!");
static_assert(offsetof(FProceduralScatter2DPoint, CollisionRadius) == 0x00002C, "Member 'FProceduralScatter2DPoint::CollisionRadius' has a wrong offset!");
static_assert(offsetof(FProceduralScatter2DPoint, bBlocker) == 0x000030, "Member 'FProceduralScatter2DPoint::bBlocker' has a wrong offset!");
static_assert(offsetof(FProceduralScatter2DPoint, RandomNumber) == 0x000034, "Member 'FProceduralScatter2DPoint::RandomNumber' has a wrong offset!");
...
static_assert(alignof(FProceduralHitPoint) == 0x000004, "Wrong alignment on FProceduralHitPoint");
static_assert(sizeof(FProceduralHitPoint) == 0x000024, "Wrong size on FProceduralHitPoint");
...
static_assert(offsetof(FProceduralHitPoint, position) == 0x000004, "Member 'FProceduralHitPoint::position' has a wrong offset!");
static_assert(offsetof(FProceduralHitPoint, Normal) == 0x000010, "Member 'FProceduralHitPoint::Normal' has a wrong offset!");
static_assert(offsetof(FProceduralHitPoint, Component) == 0x00001C, "Member 'FProceduralHitPoint::Component' has a wrong offset!");
...
static_assert(sizeof(FProceduralPointCloudPoint) == 0x000070, "Wrong size on FProceduralPointCloudPoint");
...
static_assert(offsetof(FProceduralPointCloudPoint, SurfaceNormal) == 0x000030, "Member 'FProceduralPointCloudPoint::SurfaceNormal' has a wrong offset!");
static_assert(offsetof(FProceduralPointCloudPoint, SurfaceObject) == 0x000040, "Member 'FProceduralPointCloudPoint::SurfaceObject' has a wrong offset!");
static_assert(offsetof(FProceduralPointCloudPoint, Object) == 0x000048, "Member 'FProceduralPointCloudPoint::Object' has a wrong offset!");
static_assert(offsetof(FProceduralPointCloudPoint, ObjectVariation) == 0x000050, "Member 'FProceduralPointCloudPoint::ObjectVariation' has a wrong offset!");
static_assert(offsetof(FProceduralPointCloudPoint, Tags) == 0x000058, "Member 'FProceduralPointCloudPoint::Tags' has a wrong offset!");
static_assert(offsetof(FProceduralPointCloudPoint, CollisionRadius) == 0x000068, "Member 'FProceduralPointCloudPoint::CollisionRadius' has a wrong offset!");
static_assert(offsetof(FProceduralPointCloudPoint, SourcePointGeneratorIndex) == 0x00006C, "Member 'FProceduralPointCloudPoint::SourcePointGeneratorIndex' has a wrong offset!");
...
static_assert(sizeof(FProceduralScatterPoint) == 0x000060, "Wrong size on FProceduralScatterPoint");
...
static_assert(offsetof(FProceduralScatterPoint, Rotation) == 0x00000C, "Member 'FProceduralScatterPoint::Rotation' has a wrong offset!");
static_assert(offsetof(FProceduralScatterPoint, Scale) == 0x000018, "Member 'FProceduralScatterPoint::Scale' has a wrong offset!");
static_assert(offsetof(FProceduralScatterPoint, ScatterSettings) == 0x000020, "Member 'FProceduralScatterPoint::ScatterSettings' has a wrong offset!");
static_assert(offsetof(FProceduralScatterPoint, VariationIdx) == 0x000028, "Member 'FProceduralScatterPoint::VariationIdx' has a wrong offset!");
static_assert(offsetof(FProceduralScatterPoint, GenerationLocation) == 0x00002C, "Member 'FProceduralScatterPoint::GenerationLocation' has a wrong offset!");
static_assert(offsetof(FProceduralScatterPoint, HitPoint) == 0x000038, "Member 'FProceduralScatterPoint::HitPoint' has a wrong offset!");
...
static_assert(sizeof(FProceduralScatterProjectionPoint) == 0x000070, "Wrong size on FProceduralScatterProjectionPoint");
...
static_assert(offsetof(FProceduralScatterProjectionPoint, Rotation) == 0x00000C, "Member 'FProceduralScatterProjectionPoint::Rotation' has a wrong offset!");
static_assert(offsetof(FProceduralScatterProjectionPoint, Scale) == 0x000018, "Member 'FProceduralScatterProjectionPoint::Scale' has a wrong offset!");
static_assert(offsetof(FProceduralScatterProjectionPoint, ScatterSettings) == 0x000020, "Member 'FProceduralScatterProjectionPoint::ScatterSettings' has a wrong offset!");
static_assert(offsetof(FProceduralScatterProjectionPoint, VariationIdx) == 0x000028, "Member 'FProceduralScatterProjectionPoint::VariationIdx' has a wrong offset!");
static_assert(offsetof(FProceduralScatterProjectionPoint, StartTrace) == 0x00002C, "Member 'FProceduralScatterProjectionPoint::StartTrace' has a wrong offset!");
static_assert(offsetof(FProceduralScatterProjectionPoint, EndTrace) == 0x000038, "Member 'FProceduralScatterProjectionPoint::EndTrace' has a wrong offset!");
static_assert(offsetof(FProceduralScatterProjectionPoint, HitPoint) == 0x000044, "Member 'FProceduralScatterProjectionPoint::HitPoint' has a wrong offset!");
