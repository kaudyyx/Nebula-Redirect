...
static_assert(sizeof(UPlayerSurveyPanelContentsAnswerRatingWidget_C) == 0x0003E0, "Wrong size on UPlayerSurveyPanelContentsAnswerRatingWidget_C");
...
static_assert(offsetof(UPlayerSurveyPanelContentsAnswerRatingWidget_C, RatingButtons) == 0x0003B8, "Member 'UPlayerSurveyPanelContentsAnswerRatingWidget_C::RatingButtons' has a wrong offset!");
static_assert(offsetof(UPlayerSurveyPanelContentsAnswerRatingWidget_C, Text_Subtitle) == 0x0003C8, "Member 'UPlayerSurveyPanelContentsAnswerRatingWidget_C::Text_Subtitle' has a wrong offset!");
