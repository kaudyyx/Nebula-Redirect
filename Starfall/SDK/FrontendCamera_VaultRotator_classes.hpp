...
static_assert(offsetof(AFrontendCamera_VaultRotator_C, IsBattlepass) == 0x0007F0, "Member 'AFrontendCamera_VaultRotator_C::IsBattlepass' has a wrong offset!");
static_assert(offsetof(AFrontendCamera_VaultRotator_C, ActiveVaultRotator) == 0x0007F8, "Member 'AFrontendCamera_VaultRotator_C::ActiveVaultRotator' has a wrong offset!");
