...
static_assert(sizeof(UGAT_GenericTriggeredAbility_C) == 0x000B88, "Wrong size on UGAT_GenericTriggeredAbility_C");
...
static_assert(offsetof(UGAT_GenericTriggeredAbility_C, FortPlayerPawn) == 0x000B78, "Member 'UGAT_GenericTriggeredAbility_C::FortPlayerPawn' has a wrong offset!");
static_assert(offsetof(UGAT_GenericTriggeredAbility_C, isAutoCommitted) == 0x000B80, "Member 'UGAT_GenericTriggeredAbility_C::isAutoCommitted' has a wrong offset!");
static_assert(offsetof(UGAT_GenericTriggeredAbility_C, isStaminaLockedOut) == 0x000B81, "Member 'UGAT_GenericTriggeredAbility_C::isStaminaLockedOut' has a wrong offset!");
