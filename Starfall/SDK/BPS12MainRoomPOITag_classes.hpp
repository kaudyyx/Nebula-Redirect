...
static_assert(sizeof(UBPS12MainRoomPOITag_C) == 0x0002E0, "Wrong size on UBPS12MainRoomPOITag_C");
...
static_assert(offsetof(UBPS12MainRoomPOITag_C, LocationNames) == 0x0002D0, "Member 'UBPS12MainRoomPOITag_C::LocationNames' has a wrong offset!");
