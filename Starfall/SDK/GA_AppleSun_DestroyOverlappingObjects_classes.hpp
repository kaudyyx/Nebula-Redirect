...
static_assert(sizeof(UGA_AppleSun_DestroyOverlappingObjects_C) == 0x000AB0, "Wrong size on UGA_AppleSun_DestroyOverlappingObjects_C");
static_assert(offsetof(UGA_AppleSun_DestroyOverlappingObjects_C, UberGraphFrame) == 0x000AA8, "Member 'UGA_AppleSun_DestroyOverlappingObjects_C::UberGraphFrame' has a wrong offset!");
