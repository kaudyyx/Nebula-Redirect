...
static_assert(sizeof(AbilityFunctions_C_GetDistanceSquaredBetweenActors) == 0x000048, "Wrong size on AbilityFunctions_C_GetDistanceSquaredBetweenActors");
...
static_assert(offsetof(AbilityFunctions_C_GetDistanceSquaredBetweenActors, CallFunc_K2_GetActorLocation_ReturnValue) == 0x00001C, "Member 'AbilityFunctions_C_GetDistanceSquaredBetweenActors::CallFunc_K2_GetActorLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(AbilityFunctions_C_GetDistanceSquaredBetweenActors, CallFunc_K2_GetActorLocation_ReturnValue_1) == 0x000028, "Member 'AbilityFunctions_C_GetDistanceSquaredBetweenActors::CallFunc_K2_GetActorLocation_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(AbilityFunctions_C_GetDistanceSquaredBetweenActors, CallFunc_Subtract_VectorVector_ReturnValue) == 0x000034, "Member 'AbilityFunctions_C_GetDistanceSquaredBetweenActors::CallFunc_Subtract_VectorVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(AbilityFunctions_C_GetDistanceSquaredBetweenActors, CallFunc_VSizeSquared_ReturnValue) == 0x000040, "Member 'AbilityFunctions_C_GetDistanceSquaredBetweenActors::CallFunc_VSizeSquared_ReturnValue' has a wrong offset!");
