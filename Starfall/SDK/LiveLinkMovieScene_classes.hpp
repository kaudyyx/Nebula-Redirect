...
public:
	...
	TArray<bool>                                  ChannelMask;                                       // 0x0120(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class UMovieSceneLiveLinkSubSection*>  SubSections;                                       // 0x0130(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	TArray<class FName>                           CurveNames;                                        // 0x0208(0x0010)(ZeroConstructor, Deprecated, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FMovieSceneFloatChannel>        PropertyFloatChannels;                             // 0x0218(0x0010)(ZeroConstructor, Deprecated, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	TSubclassOf<class ULiveLinkRole>              TrackRole;                                         // 0x00B0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMovieSceneLiveLinkTrack) == 0x0000B8, "Wrong size on UMovieSceneLiveLinkTrack");
static_assert(offsetof(UMovieSceneLiveLinkTrack, TrackRole) == 0x0000B0, "Member 'UMovieSceneLiveLinkTrack::TrackRole' has a wrong offset!");
