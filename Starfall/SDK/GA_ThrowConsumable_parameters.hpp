...
static_assert(offsetof(GA_ThrowConsumable_C_GetProjectileTrajectoryPoints, CallFunc_CalculateProjectileTrajectorySplineWithHitProfile_OutHitResult) == 0x0000D4, "Member 'GA_ThrowConsumable_C_GetProjectileTrajectoryPoints::CallFunc_CalculateProjectileTrajectorySplineWithHitProfile_OutHitResult' has a wrong offset!");
static_assert(offsetof(GA_ThrowConsumable_C_GetProjectileTrajectoryPoints, CallFunc_CalculateProjectileTrajectorySplineWithHitProfile_OutSplinePoints) == 0x000160, "Member 'GA_ThrowConsumable_C_GetProjectileTrajectoryPoints::CallFunc_CalculateProjectileTrajectorySplineWithHitProfile_OutSplinePoints' has a wrong offset!");
static_assert(offsetof(GA_ThrowConsumable_C_GetProjectileTrajectoryPoints, CallFunc_CalculateProjectileTrajectorySplineWithHitProfile_OutSplineTangents) == 0x000170, "Member 'GA_ThrowConsumable_C_GetProjectileTrajectoryPoints::CallFunc_CalculateProjectileTrajectorySplineWithHitProfile_OutSplineTangents' has a wrong offset!");
static_assert(offsetof(GA_ThrowConsumable_C_GetProjectileTrajectoryPoints, CallFunc_CalculateProjectileTrajectorySplineWithHit_OutHitResult) == 0x000180, "Member 'GA_ThrowConsumable_C_GetProjectileTrajectoryPoints::CallFunc_CalculateProjectileTrajectorySplineWithHit_OutHitResult' has a wrong offset!");
static_assert(offsetof(GA_ThrowConsumable_C_GetProjectileTrajectoryPoints, CallFunc_CalculateProjectileTrajectorySplineWithHit_OutSplinePoints) == 0x000210, "Member 'GA_ThrowConsumable_C_GetProjectileTrajectoryPoints::CallFunc_CalculateProjectileTrajectorySplineWithHit_OutSplinePoints' has a wrong offset!");
static_assert(offsetof(GA_ThrowConsumable_C_GetProjectileTrajectoryPoints, CallFunc_CalculateProjectileTrajectorySplineWithHit_OutSplineTangents) == 0x000220, "Member 'GA_ThrowConsumable_C_GetProjectileTrajectoryPoints::CallFunc_CalculateProjectileTrajectorySplineWithHit_OutSplineTangents' has a wrong offset!");
static_assert(offsetof(GA_ThrowConsumable_C_GetProjectileTrajectoryPoints, CallFunc_GetOwningPlayer_Player_Pawn) == 0x000230, "Member 'GA_ThrowConsumable_C_GetProjectileTrajectoryPoints::CallFunc_GetOwningPlayer_Player_Pawn' has a wrong offset!");
