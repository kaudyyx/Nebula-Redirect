...
static_assert(sizeof(FSourceEffectBitCrusherSettings) == 0x000020, "Wrong size on FSourceEffectBitCrusherSettings");
static_assert(offsetof(FSourceEffectBitCrusherSettings, SampleRateModulation) == 0x000000, "Member 'FSourceEffectBitCrusherSettings::SampleRateModulation' has a wrong offset!");
static_assert(offsetof(FSourceEffectBitCrusherSettings, BitModulation) == 0x000010, "Member 'FSourceEffectBitCrusherSettings::BitModulation' has a wrong offset!");
...
static_assert(sizeof(FSourceEffectChorusSettings) == 0x000090, "Wrong size on FSourceEffectChorusSettings");
...
static_assert(offsetof(FSourceEffectChorusSettings, DepthModulation) == 0x000008, "Member 'FSourceEffectChorusSettings::DepthModulation' has a wrong offset!");
static_assert(offsetof(FSourceEffectChorusSettings, Frequency) == 0x000018, "Member 'FSourceEffectChorusSettings::Frequency' has a wrong offset!");
static_assert(offsetof(FSourceEffectChorusSettings, FrequencyModulation) == 0x000020, "Member 'FSourceEffectChorusSettings::FrequencyModulation' has a wrong offset!");
static_assert(offsetof(FSourceEffectChorusSettings, Feedback) == 0x000030, "Member 'FSourceEffectChorusSettings::Feedback' has a wrong offset!");
...
static_assert(offsetof(FSourceEffectChorusSettings, WetLevel) == 0x000048, "Member 'FSourceEffectChorusSettings::WetLevel' has a wrong offset!");
static_assert(offsetof(FSourceEffectChorusSettings, WetModulation) == 0x000050, "Member 'FSourceEffectChorusSettings::WetModulation' has a wrong offset!");
static_assert(offsetof(FSourceEffectChorusSettings, DryLevel) == 0x000060, "Member 'FSourceEffectChorusSettings::DryLevel' has a wrong offset!");
static_assert(offsetof(FSourceEffectChorusSettings, DryModulation) == 0x000068, "Member 'FSourceEffectChorusSettings::DryModulation' has a wrong offset!");
static_assert(offsetof(FSourceEffectChorusSettings, Spread) == 0x000078, "Member 'FSourceEffectChorusSettings::Spread' has a wrong offset!");
static_assert(offsetof(FSourceEffectChorusSettings, SpreadModulation) == 0x000080, "Member 'FSourceEffectChorusSettings::SpreadModulation' has a wrong offset!");
