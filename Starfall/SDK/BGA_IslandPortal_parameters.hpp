...
static_assert(offsetof(BGA_IslandPortal_C_NotifyTeleportedVehicle, VehicleActor_0) == 0x000000, "Member 'BGA_IslandPortal_C_NotifyTeleportedVehicle::VehicleActor_0' has a wrong offset!");
...
static_assert(offsetof(BGA_IslandPortal_C_StartTeleport, OverlapActor_0) == 0x000000, "Member 'BGA_IslandPortal_C_StartTeleport::OverlapActor_0' has a wrong offset!");
...
static_assert(offsetof(BGA_IslandPortal_C_StartTeleportByInteractionOnServer, OverlapActor_0) == 0x000000, "Member 'BGA_IslandPortal_C_StartTeleportByInteractionOnServer::OverlapActor_0' has a wrong offset!");
