...
static_assert(sizeof(USpatialFrontend_C) == 0x0003A0, "Wrong size on USpatialFrontend_C");
static_assert(offsetof(USpatialFrontend_C, UberGraphFrame) == 0x000398, "Member 'USpatialFrontend_C::UberGraphFrame' has a wrong offset!");
