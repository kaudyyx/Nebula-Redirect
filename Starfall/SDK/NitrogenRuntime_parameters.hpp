...
static_assert(offsetof(FortCheatManager_Nitrogen_TeleportToNitrogenRespawnActor, Index_0) == 0x000000, "Member 'FortCheatManager_Nitrogen_TeleportToNitrogenRespawnActor::Index_0' has a wrong offset!");
...
static_assert(offsetof(FortCheatManager_Nitrogen_TeleportToNitrogenSpawnActor, Index_0) == 0x000000, "Member 'FortCheatManager_Nitrogen_TeleportToNitrogenSpawnActor::Index_0' has a wrong offset!");
...
static_assert(offsetof(FortCheatManager_Nitrogen_TeleportToSquadStartAtIndex, Index_0) == 0x000000, "Member 'FortCheatManager_Nitrogen_TeleportToSquadStartAtIndex::Index_0' has a wrong offset!");
...
static_assert(alignof(NitrogenFare_DropOffPointExited) == 0x000008, "Wrong alignment on NitrogenFare_DropOffPointExited");
static_assert(sizeof(NitrogenFare_DropOffPointExited) == 0x000010, "Wrong size on NitrogenFare_DropOffPointExited");
static_assert(offsetof(NitrogenFare_DropOffPointExited, TraversePoint) == 0x000000, "Member 'NitrogenFare_DropOffPointExited::TraversePoint' has a wrong offset!");
static_assert(offsetof(NitrogenFare_DropOffPointExited, PlayerState) == 0x000008, "Member 'NitrogenFare_DropOffPointExited::PlayerState' has a wrong offset!");
...
static_assert(alignof(NitrogenFare_PickUpPointExited) == 0x000008, "Wrong alignment on NitrogenFare_PickUpPointExited");
static_assert(sizeof(NitrogenFare_PickUpPointExited) == 0x000010, "Wrong size on NitrogenFare_PickUpPointExited");
static_assert(offsetof(NitrogenFare_PickUpPointExited, TraversePoint) == 0x000000, "Member 'NitrogenFare_PickUpPointExited::TraversePoint' has a wrong offset!");
static_assert(offsetof(NitrogenFare_PickUpPointExited, PlayerState) == 0x000008, "Member 'NitrogenFare_PickUpPointExited::PlayerState' has a wrong offset!");
...
static_assert(alignof(NitrogenTraversePoint_OnEndOverlap) == 0x000008, "Wrong alignment on NitrogenTraversePoint_OnEndOverlap");
static_assert(sizeof(NitrogenTraversePoint_OnEndOverlap) == 0x000010, "Wrong size on NitrogenTraversePoint_OnEndOverlap");
static_assert(offsetof(NitrogenTraversePoint_OnEndOverlap, OverlappedActor) == 0x000000, "Member 'NitrogenTraversePoint_OnEndOverlap::OverlappedActor' has a wrong offset!");
static_assert(offsetof(NitrogenTraversePoint_OnEndOverlap, OtherActor) == 0x000008, "Member 'NitrogenTraversePoint_OnEndOverlap::OtherActor' has a wrong offset!");
