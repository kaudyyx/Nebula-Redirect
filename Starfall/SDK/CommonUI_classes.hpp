...
static_assert(offsetof(UCommonUserWidget, bConsumePointerInput) == 0x000280, "Member 'UCommonUserWidget::bConsumePointerInput' has a wrong offset!");
...
static_assert(sizeof(UCommonButton) == 0x000BA0, "Wrong size on UCommonButton");
...
static_assert(offsetof(UCommonButton, bHideInputAction) == 0x000298, "Member 'UCommonButton::bHideInputAction' has a wrong offset!");
...
static_assert(offsetof(UCommonButton, ClickMethod) == 0x0002D2, "Member 'UCommonButton::ClickMethod' has a wrong offset!");
static_assert(offsetof(UCommonButton, TouchMethod) == 0x0002D3, "Member 'UCommonButton::TouchMethod' has a wrong offset!");
static_assert(offsetof(UCommonButton, PressMethod) == 0x0002D4, "Member 'UCommonButton::PressMethod' has a wrong offset!");
static_assert(offsetof(UCommonButton, InputPriority) == 0x0002D8, "Member 'UCommonButton::InputPriority' has a wrong offset!");
static_assert(offsetof(UCommonButton, TriggeringInputAction) == 0x0002E0, "Member 'UCommonButton::TriggeringInputAction' has a wrong offset!");
static_assert(offsetof(UCommonButton, bIsPersistentBinding) == 0x000300, "Member 'UCommonButton::bIsPersistentBinding' has a wrong offset!");
static_assert(offsetof(UCommonButton, InputModeOverride) == 0x000301, "Member 'UCommonButton::InputModeOverride' has a wrong offset!");
static_assert(offsetof(UCommonButton, OnSelectedChanged) == 0x000308, "Member 'UCommonButton::OnSelectedChanged' has a wrong offset!");
static_assert(offsetof(UCommonButton, OnButtonClicked) == 0x000318, "Member 'UCommonButton::OnButtonClicked' has a wrong offset!");
static_assert(offsetof(UCommonButton, OnButtonDoubleClicked) == 0x000328, "Member 'UCommonButton::OnButtonDoubleClicked' has a wrong offset!");
static_assert(offsetof(UCommonButton, OnButtonHovered) == 0x000338, "Member 'UCommonButton::OnButtonHovered' has a wrong offset!");
static_assert(offsetof(UCommonButton, OnButtonUnhovered) == 0x000348, "Member 'UCommonButton::OnButtonUnhovered' has a wrong offset!");
static_assert(offsetof(UCommonButton, SingleMaterialStyleMID) == 0x000388, "Member 'UCommonButton::SingleMaterialStyleMID' has a wrong offset!");
static_assert(offsetof(UCommonButton, NormalStyle) == 0x000390, "Member 'UCommonButton::NormalStyle' has a wrong offset!");
static_assert(offsetof(UCommonButton, SelectedStyle) == 0x000608, "Member 'UCommonButton::SelectedStyle' has a wrong offset!");
static_assert(offsetof(UCommonButton, DisabledStyle) == 0x000880, "Member 'UCommonButton::DisabledStyle' has a wrong offset!");
static_assert(offsetof(UCommonButton, InputActionWidget) == 0x000B98, "Member 'UCommonButton::InputActionWidget' has a wrong offset!");
...
static_assert(sizeof(UCommonActivatablePanel) == 0x000458, "Wrong size on UCommonActivatablePanel");
static_assert(offsetof(UCommonActivatablePanel, OnWidgetActivated) == 0x000328, "Member 'UCommonActivatablePanel::OnWidgetActivated' has a wrong offset!");
static_assert(offsetof(UCommonActivatablePanel, OnWidgetDeactivated) == 0x000338, "Member 'UCommonActivatablePanel::OnWidgetDeactivated' has a wrong offset!");
static_assert(offsetof(UCommonActivatablePanel, bConsumeAllActions) == 0x000348, "Member 'UCommonActivatablePanel::bConsumeAllActions' has a wrong offset!");
static_assert(offsetof(UCommonActivatablePanel, bExposeActionsExternally) == 0x000349, "Member 'UCommonActivatablePanel::bExposeActionsExternally' has a wrong offset!");
static_assert(offsetof(UCommonActivatablePanel, bShouldBypassStack) == 0x00034A, "Member 'UCommonActivatablePanel::bShouldBypassStack' has a wrong offset!");
...
static_assert(offsetof(UCommonVisibilitySwitcher, OnActiveWidgetChangedLegacyEvent) == 0x000130, "Member 'UCommonVisibilitySwitcher::OnActiveWidgetChangedLegacyEvent' has a wrong offset!");
...
static_assert(sizeof(UCommonWidgetStack) == 0x000168, "Wrong size on UCommonWidgetStack");
...
static_assert(sizeof(UCommonInputReflector) == 0x0002B8, "Wrong size on UCommonInputReflector");
static_assert(offsetof(UCommonInputReflector, ButtonType) == 0x000288, "Member 'UCommonInputReflector::ButtonType' has a wrong offset!");
static_assert(offsetof(UCommonInputReflector, ActiveButtons) == 0x000290, "Member 'UCommonInputReflector::ActiveButtons' has a wrong offset!");
static_assert(offsetof(UCommonInputReflector, InactiveButtons) == 0x0002A0, "Member 'UCommonInputReflector::InactiveButtons' has a wrong offset!");
...
static_assert(sizeof(UCommonPopupButton) == 0x000BB0, "Wrong size on UCommonPopupButton");
static_assert(offsetof(UCommonPopupButton, PopupMenuAnchor) == 0x000BA0, "Member 'UCommonPopupButton::PopupMenuAnchor' has a wrong offset!");
static_assert(offsetof(UCommonPopupButton, PopupMenu) == 0x000BA8, "Member 'UCommonPopupButton::PopupMenu' has a wrong offset!");
...
static_assert(sizeof(UCommonPopupMenu) == 0x000470, "Wrong size on UCommonPopupMenu");
static_assert(offsetof(UCommonPopupMenu, bUseInputStack) == 0x000458, "Member 'UCommonPopupMenu::bUseInputStack' has a wrong offset!");
static_assert(offsetof(UCommonPopupMenu, OwningMenuAnchor) == 0x00045C, "Member 'UCommonPopupMenu::OwningMenuAnchor' has a wrong offset!");
static_assert(offsetof(UCommonPopupMenu, ContextProvidingObject) == 0x000464, "Member 'UCommonPopupMenu::ContextProvidingObject' has a wrong offset!");
...
static_assert(sizeof(UCommonTabListWidget) == 0x000358, "Wrong size on UCommonTabListWidget");
static_assert(offsetof(UCommonTabListWidget, OnTabSelected) == 0x000288, "Member 'UCommonTabListWidget::OnTabSelected' has a wrong offset!");
static_assert(offsetof(UCommonTabListWidget, OnTabButtonCreated) == 0x000298, "Member 'UCommonTabListWidget::OnTabButtonCreated' has a wrong offset!");
static_assert(offsetof(UCommonTabListWidget, OnTabButtonRemoved) == 0x0002A8, "Member 'UCommonTabListWidget::OnTabButtonRemoved' has a wrong offset!");
static_assert(offsetof(UCommonTabListWidget, NextTabInputActionData) == 0x0002B8, "Member 'UCommonTabListWidget::NextTabInputActionData' has a wrong offset!");
static_assert(offsetof(UCommonTabListWidget, PreviousTabInputActionData) == 0x0002C8, "Member 'UCommonTabListWidget::PreviousTabInputActionData' has a wrong offset!");
static_assert(offsetof(UCommonTabListWidget, bAutoListenForInput) == 0x0002D8, "Member 'UCommonTabListWidget::bAutoListenForInput' has a wrong offset!");
static_assert(offsetof(UCommonTabListWidget, LinkedSwitcher) == 0x0002DC, "Member 'UCommonTabListWidget::LinkedSwitcher' has a wrong offset!");
static_assert(offsetof(UCommonTabListWidget, RegisteredTabsByID) == 0x0002E8, "Member 'UCommonTabListWidget::RegisteredTabsByID' has a wrong offset!");
static_assert(offsetof(UCommonTabListWidget, TabButtonGroup) == 0x000338, "Member 'UCommonTabListWidget::TabButtonGroup' has a wrong offset!");
