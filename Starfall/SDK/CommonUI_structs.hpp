...
static_assert(sizeof(FCommonInputActionData) == 0x000670, "Wrong size on FCommonInputActionData");
...
static_assert(offsetof(FCommonInputActionData, DefaultGamepadInputTypeInfo) == 0x0000E0, "Member 'FCommonInputActionData::DefaultGamepadInputTypeInfo' has a wrong offset!");
static_assert(offsetof(FCommonInputActionData, GamepadInputTypeInfoOverrides) == 0x000188, "Member 'FCommonInputActionData::GamepadInputTypeInfoOverrides' has a wrong offset!");
static_assert(offsetof(FCommonInputActionData, GamepadInputTypeInfos) == 0x0001D8, "Member 'FCommonInputActionData::GamepadInputTypeInfos' has a wrong offset!");
static_assert(offsetof(FCommonInputActionData, TouchInputTypeInfo) == 0x0005C8, "Member 'FCommonInputActionData::TouchInputTypeInfo' has a wrong offset!");
