...
static_assert(sizeof(FChaosSolverConfiguration) == 0x000050, "Wrong size on FChaosSolverConfiguration");
static_assert(offsetof(FChaosSolverConfiguration, CollisionIterations) == 0x000000, "Member 'FChaosSolverConfiguration::CollisionIterations' has a wrong offset!");
static_assert(offsetof(FChaosSolverConfiguration, PushOutIterations) == 0x000004, "Member 'FChaosSolverConfiguration::PushOutIterations' has a wrong offset!");
static_assert(offsetof(FChaosSolverConfiguration, PushOutPairIterations) == 0x000008, "Member 'FChaosSolverConfiguration::PushOutPairIterations' has a wrong offset!");
static_assert(offsetof(FChaosSolverConfiguration, ClusterConnectionFactor) == 0x00000C, "Member 'FChaosSolverConfiguration::ClusterConnectionFactor' has a wrong offset!");
static_assert(offsetof(FChaosSolverConfiguration, ClusterUnionConnectionType) == 0x000010, "Member 'FChaosSolverConfiguration::ClusterUnionConnectionType' has a wrong offset!");
static_assert(offsetof(FChaosSolverConfiguration, bGenerateCollisionData) == 0x000011, "Member 'FChaosSolverConfiguration::bGenerateCollisionData' has a wrong offset!");
static_assert(offsetof(FChaosSolverConfiguration, CollisionFilterSettings) == 0x000014, "Member 'FChaosSolverConfiguration::CollisionFilterSettings' has a wrong offset!");
static_assert(offsetof(FChaosSolverConfiguration, bGenerateBreakData) == 0x000024, "Member 'FChaosSolverConfiguration::bGenerateBreakData' has a wrong offset!");
static_assert(offsetof(FChaosSolverConfiguration, BreakingFilterSettings) == 0x000028, "Member 'FChaosSolverConfiguration::BreakingFilterSettings' has a wrong offset!");
static_assert(offsetof(FChaosSolverConfiguration, bGenerateTrailingData) == 0x000038, "Member 'FChaosSolverConfiguration::bGenerateTrailingData' has a wrong offset!");
static_assert(offsetof(FChaosSolverConfiguration, TrailingFilterSettings) == 0x00003C, "Member 'FChaosSolverConfiguration::TrailingFilterSettings' has a wrong offset!");
static_assert(offsetof(FChaosSolverConfiguration, bGenerateContactGraph) == 0x00004C, "Member 'FChaosSolverConfiguration::bGenerateContactGraph' has a wrong offset!");
