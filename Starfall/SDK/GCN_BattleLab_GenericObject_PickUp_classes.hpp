...
static_assert(alignof(UGCN_BattleLab_GenericObject_PickUp_C) == 0x000008, "Wrong alignment on UGCN_BattleLab_GenericObject_PickUp_C");
static_assert(sizeof(UGCN_BattleLab_GenericObject_PickUp_C) == 0x0001C0, "Wrong size on UGCN_BattleLab_GenericObject_PickUp_C");
static_assert(offsetof(UGCN_BattleLab_GenericObject_PickUp_C, Pick_Up_Sound) == 0x0001B8, "Member 'UGCN_BattleLab_GenericObject_PickUp_C::Pick_Up_Sound' has a wrong offset!");
