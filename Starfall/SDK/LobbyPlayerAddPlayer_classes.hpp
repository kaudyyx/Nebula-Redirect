...
static_assert(sizeof(ULobbyPlayerAddPlayer_C) == 0x000C28, "Wrong size on ULobbyPlayerAddPlayer_C");
...
static_assert(offsetof(ULobbyPlayerAddPlayer_C, PlayerId) == 0x000C20, "Member 'ULobbyPlayerAddPlayer_C::PlayerId' has a wrong offset!");
