...
static_assert(sizeof(AAthenaFrontEndMiniMapManager_C) == 0x0002B0, "Wrong size on AAthenaFrontEndMiniMapManager_C");
static_assert(offsetof(AAthenaFrontEndMiniMapManager_C, DefaultSceneRoot) == 0x0002A8, "Member 'AAthenaFrontEndMiniMapManager_C::DefaultSceneRoot' has a wrong offset!");
