...
static_assert(sizeof(ABP_ZipLine_Athena_Harness_C) == 0x0002C8, "Wrong size on ABP_ZipLine_Athena_Harness_C");
...
static_assert(offsetof(ABP_ZipLine_Athena_Harness_C, DegreesPerUpdate) == 0x000278, "Member 'ABP_ZipLine_Athena_Harness_C::DegreesPerUpdate' has a wrong offset!");
static_assert(offsetof(ABP_ZipLine_Athena_Harness_C, SpawnSound) == 0x000280, "Member 'ABP_ZipLine_Athena_Harness_C::SpawnSound' has a wrong offset!");
static_assert(offsetof(ABP_ZipLine_Athena_Harness_C, UnSpawnSound) == 0x000288, "Member 'ABP_ZipLine_Athena_Harness_C::UnSpawnSound' has a wrong offset!");
static_assert(offsetof(ABP_ZipLine_Athena_Harness_C, CurrentAttachDetachSound) == 0x000290, "Member 'ABP_ZipLine_Athena_Harness_C::CurrentAttachDetachSound' has a wrong offset!");
static_assert(offsetof(ABP_ZipLine_Athena_Harness_C, AttachedPlayer) == 0x000298, "Member 'ABP_ZipLine_Athena_Harness_C::AttachedPlayer' has a wrong offset!");
static_assert(offsetof(ABP_ZipLine_Athena_Harness_C, OtherMotors) == 0x0002A0, "Member 'ABP_ZipLine_Athena_Harness_C::OtherMotors' has a wrong offset!");
static_assert(offsetof(ABP_ZipLine_Athena_Harness_C, DestroySound) == 0x0002B0, "Member 'ABP_ZipLine_Athena_Harness_C::DestroySound' has a wrong offset!");
static_assert(offsetof(ABP_ZipLine_Athena_Harness_C, HasHitAnotherPlayer) == 0x0002B8, "Member 'ABP_ZipLine_Athena_Harness_C::HasHitAnotherPlayer' has a wrong offset!");
static_assert(offsetof(ABP_ZipLine_Athena_Harness_C, ZiplineChimeVisualUpdate) == 0x0002BC, "Member 'ABP_ZipLine_Athena_Harness_C::ZiplineChimeVisualUpdate' has a wrong offset!");
static_assert(offsetof(ABP_ZipLine_Athena_Harness_C, ChimeTimer) == 0x0002C0, "Member 'ABP_ZipLine_Athena_Harness_C::ChimeTimer' has a wrong offset!");
