...
static_assert(sizeof(UGAB_ThrowPlayer_C) == 0x000AE8, "Wrong size on UGAB_ThrowPlayer_C");
static_assert(offsetof(UGAB_ThrowPlayer_C, UberGraphFrame) == 0x000AD8, "Member 'UGAB_ThrowPlayer_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGAB_ThrowPlayer_C, PlayerPawn) == 0x000AE0, "Member 'UGAB_ThrowPlayer_C::PlayerPawn' has a wrong offset!");
