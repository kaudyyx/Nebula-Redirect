...
static_assert(offsetof(StreamingRadioPlayerComponent_AuthPlayIndex, Index_0) == 0x000000, "Member 'StreamingRadioPlayerComponent_AuthPlayIndex::Index_0' has a wrong offset!");
...
static_assert(alignof(StreamingRadioPlayerComponent_AuthSaveAutoStart) == 0x000001, "Wrong alignment on StreamingRadioPlayerComponent_AuthSaveAutoStart");
...
static_assert(alignof(StreamingRadioPlayerComponent_AuthSaveFadeOutTime) == 0x000004, "Wrong alignment on StreamingRadioPlayerComponent_AuthSaveFadeOutTime");
...
static_assert(alignof(StreamingRadioPlayerComponent_AuthSetDisabledForCurrentPlayerState) == 0x000001, "Wrong alignment on StreamingRadioPlayerComponent_AuthSetDisabledForCurrentPlayerState");
