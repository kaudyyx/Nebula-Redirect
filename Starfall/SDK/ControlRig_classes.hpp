...
static_assert(sizeof(UMovieSceneControlRigSection) == 0x000218, "Wrong size on UMovieSceneControlRigSection");
static_assert(offsetof(UMovieSceneControlRigSection, bAdditive) == 0x000160, "Member 'UMovieSceneControlRigSection::bAdditive' has a wrong offset!");
static_assert(offsetof(UMovieSceneControlRigSection, bApplyBoneFilter) == 0x000161, "Member 'UMovieSceneControlRigSection::bApplyBoneFilter' has a wrong offset!");
static_assert(offsetof(UMovieSceneControlRigSection, BoneFilter) == 0x000168, "Member 'UMovieSceneControlRigSection::BoneFilter' has a wrong offset!");
static_assert(offsetof(UMovieSceneControlRigSection, Weight) == 0x000178, "Member 'UMovieSceneControlRigSection::Weight' has a wrong offset!");
