...
static_assert(offsetof(FortAbilityTask_ApplyRootMotionMantisForce_ApplyRootMotionMantisForce, Duration_0) == 0x000008, "Member 'FortAbilityTask_ApplyRootMotionMantisForce_ApplyRootMotionMantisForce::Duration_0' has a wrong offset!");
static_assert(offsetof(FortAbilityTask_ApplyRootMotionMantisForce_ApplyRootMotionMantisForce, TechniqueMontage_0) == 0x000010, "Member 'FortAbilityTask_ApplyRootMotionMantisForce_ApplyRootMotionMantisForce::TechniqueMontage_0' has a wrong offset!");
