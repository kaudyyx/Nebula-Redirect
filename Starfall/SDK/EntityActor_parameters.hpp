...
static_assert(sizeof(EntityActorCollisionComponent_OnNativeComponentBeginOverlap) == 0x0000B0, "Wrong size on EntityActorCollisionComponent_OnNativeComponentBeginOverlap");
...
static_assert(sizeof(EntityActorCollisionComponent_OnNativeComponentHit) == 0x0000B0, "Wrong size on EntityActorCollisionComponent_OnNativeComponentHit");
...
static_assert(offsetof(EntityActorCollisionComponent_OnNativeComponentHit, Hit) == 0x000024, "Member 'EntityActorCollisionComponent_OnNativeComponentHit::Hit' has a wrong offset!");
...
static_assert(alignof(EntityActorTextDisplayComponent_GetRelativeLocation) == 0x000004, "Wrong alignment on EntityActorTextDisplayComponent_GetRelativeLocation");
static_assert(sizeof(EntityActorTextDisplayComponent_GetRelativeLocation) == 0x00000C, "Wrong size on EntityActorTextDisplayComponent_GetRelativeLocation");
...
static_assert(alignof(EntityActorTextDisplayComponent_SetRelativeLocation) == 0x000004, "Wrong alignment on EntityActorTextDisplayComponent_SetRelativeLocation");
static_assert(sizeof(EntityActorTextDisplayComponent_SetRelativeLocation) == 0x00000C, "Wrong size on EntityActorTextDisplayComponent_SetRelativeLocation");
...
static_assert(alignof(EntityActorTextDisplayComponent_SetRelativeRotation) == 0x000004, "Wrong alignment on EntityActorTextDisplayComponent_SetRelativeRotation");
static_assert(sizeof(EntityActorTextDisplayComponent_SetRelativeRotation) == 0x00000C, "Wrong size on EntityActorTextDisplayComponent_SetRelativeRotation");
...
static_assert(alignof(EntityActorTextDisplayComponent_SetRelativeScale) == 0x000004, "Wrong alignment on EntityActorTextDisplayComponent_SetRelativeScale");
static_assert(sizeof(EntityActorTextDisplayComponent_SetRelativeScale) == 0x00000C, "Wrong size on EntityActorTextDisplayComponent_SetRelativeScale");
