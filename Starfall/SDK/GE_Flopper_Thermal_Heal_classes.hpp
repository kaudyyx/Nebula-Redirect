...
static_assert(alignof(UGE_Flopper_Thermal_Heal_C) == 0x000008, "Wrong alignment on UGE_Flopper_Thermal_Heal_C");
static_assert(sizeof(UGE_Flopper_Thermal_Heal_C) == 0x0007B8, "Wrong size on UGE_Flopper_Thermal_Heal_C");
