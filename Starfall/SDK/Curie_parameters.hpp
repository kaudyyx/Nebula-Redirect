...
static_assert(alignof(CurieComponent_HandleOwningActorDestroyed) == 0x000008, "Wrong alignment on CurieComponent_HandleOwningActorDestroyed");
static_assert(sizeof(CurieComponent_HandleOwningActorDestroyed) == 0x000008, "Wrong size on CurieComponent_HandleOwningActorDestroyed");
static_assert(offsetof(CurieComponent_HandleOwningActorDestroyed, Owner) == 0x000000, "Member 'CurieComponent_HandleOwningActorDestroyed::Owner' has a wrong offset!");
...
static_assert(alignof(CurieComponent_HasAnyElementAttached) == 0x000008, "Wrong alignment on CurieComponent_HasAnyElementAttached");
static_assert(sizeof(CurieComponent_HasAnyElementAttached) == 0x000028, "Wrong size on CurieComponent_HasAnyElementAttached");
static_assert(offsetof(CurieComponent_HasAnyElementAttached, ElementIdentifiers) == 0x000000, "Member 'CurieComponent_HasAnyElementAttached::ElementIdentifiers' has a wrong offset!");
static_assert(offsetof(CurieComponent_HasAnyElementAttached, ReturnValue) == 0x000020, "Member 'CurieComponent_HasAnyElementAttached::ReturnValue' has a wrong offset!");
...
static_assert(alignof(CurieComponent_HasElementAttached) == 0x000004, "Wrong alignment on CurieComponent_HasElementAttached");
static_assert(sizeof(CurieComponent_HasElementAttached) == 0x00000C, "Wrong size on CurieComponent_HasElementAttached");
static_assert(offsetof(CurieComponent_HasElementAttached, ElementIdentifier) == 0x000000, "Member 'CurieComponent_HasElementAttached::ElementIdentifier' has a wrong offset!");
static_assert(offsetof(CurieComponent_HasElementAttached, ReturnValue) == 0x000008, "Member 'CurieComponent_HasElementAttached::ReturnValue' has a wrong offset!");
...
static_assert(alignof(CurieComponent_HasStateAttached) == 0x000004, "Wrong alignment on CurieComponent_HasStateAttached");
static_assert(sizeof(CurieComponent_HasStateAttached) == 0x00000C, "Wrong size on CurieComponent_HasStateAttached");
static_assert(offsetof(CurieComponent_HasStateAttached, StateIdentifier) == 0x000000, "Member 'CurieComponent_HasStateAttached::StateIdentifier' has a wrong offset!");
static_assert(offsetof(CurieComponent_HasStateAttached, ReturnValue) == 0x000008, "Member 'CurieComponent_HasStateAttached::ReturnValue' has a wrong offset!");
...
static_assert(alignof(CurieComponent_IsInteractingWithElement) == 0x000004, "Wrong alignment on CurieComponent_IsInteractingWithElement");
static_assert(sizeof(CurieComponent_IsInteractingWithElement) == 0x00000C, "Wrong size on CurieComponent_IsInteractingWithElement");
static_assert(offsetof(CurieComponent_IsInteractingWithElement, Element) == 0x000000, "Member 'CurieComponent_IsInteractingWithElement::Element' has a wrong offset!");
static_assert(offsetof(CurieComponent_IsInteractingWithElement, ReturnValue) == 0x000008, "Member 'CurieComponent_IsInteractingWithElement::ReturnValue' has a wrong offset!");
...
static_assert(alignof(CurieInterface_OnCurieContainerInitialized_BP) == 0x000004, "Wrong alignment on CurieInterface_OnCurieContainerInitialized_BP");
static_assert(sizeof(CurieInterface_OnCurieContainerInitialized_BP) == 0x000004, "Wrong size on CurieInterface_OnCurieContainerInitialized_BP");
static_assert(offsetof(CurieInterface_OnCurieContainerInitialized_BP, CurieContainerHandle) == 0x000000, "Member 'CurieInterface_OnCurieContainerInitialized_BP::CurieContainerHandle' has a wrong offset!");
...
static_assert(alignof(CurieInterface_OnCurieContainerShutdown_BP) == 0x000004, "Wrong alignment on CurieInterface_OnCurieContainerShutdown_BP");
static_assert(sizeof(CurieInterface_OnCurieContainerShutdown_BP) == 0x000004, "Wrong size on CurieInterface_OnCurieContainerShutdown_BP");
static_assert(offsetof(CurieInterface_OnCurieContainerShutdown_BP, CurieContainerHandle) == 0x000000, "Member 'CurieInterface_OnCurieContainerShutdown_BP::CurieContainerHandle' has a wrong offset!");
...
static_assert(sizeof(CurieInterface_OnCurieElementAttached_BP) == 0x00000C, "Wrong size on CurieInterface_OnCurieElementAttached_BP");
...
static_assert(sizeof(CurieInterface_OnCurieElementDetached_BP) == 0x00000C, "Wrong size on CurieInterface_OnCurieElementDetached_BP");
...
static_assert(sizeof(CurieInterface_OnCurieElementInteract_BP) == 0x000020, "Wrong size on CurieInterface_OnCurieElementInteract_BP");
...
static_assert(offsetof(CurieInterface_OnCurieElementInteract_BP, InteractParamsHandle) == 0x000010, "Member 'CurieInterface_OnCurieElementInteract_BP::InteractParamsHandle' has a wrong offset!");
...
static_assert(sizeof(CurieInterface_OnCurieElementInteractBegun_BP) == 0x000020, "Wrong size on CurieInterface_OnCurieElementInteractBegun_BP");
...
static_assert(offsetof(CurieInterface_OnCurieElementInteractBegun_BP, InteractParamsHandle) == 0x000010, "Member 'CurieInterface_OnCurieElementInteractBegun_BP::InteractParamsHandle' has a wrong offset!");
...
static_assert(sizeof(CurieInterface_OnCurieElementInteractEnded_BP) == 0x000020, "Wrong size on CurieInterface_OnCurieElementInteractEnded_BP");
...
static_assert(offsetof(CurieInterface_OnCurieElementInteractEnded_BP, InteractParamsHandle) == 0x000010, "Member 'CurieInterface_OnCurieElementInteractEnded_BP::InteractParamsHandle' has a wrong offset!");
...
static_assert(sizeof(CurieInterface_OnCurieStateAttached_BP) == 0x00000C, "Wrong size on CurieInterface_OnCurieStateAttached_BP");
...
static_assert(alignof(CurieInterface_OnCurieStateConsumed_BP) == 0x000004, "Wrong alignment on CurieInterface_OnCurieStateConsumed_BP");
static_assert(sizeof(CurieInterface_OnCurieStateConsumed_BP) == 0x00000C, "Wrong size on CurieInterface_OnCurieStateConsumed_BP");
static_assert(offsetof(CurieInterface_OnCurieStateConsumed_BP, CurieContainerHandle) == 0x000000, "Member 'CurieInterface_OnCurieStateConsumed_BP::CurieContainerHandle' has a wrong offset!");
static_assert(offsetof(CurieInterface_OnCurieStateConsumed_BP, StateTag) == 0x000004, "Member 'CurieInterface_OnCurieStateConsumed_BP::StateTag' has a wrong offset!");
...
static_assert(sizeof(CurieInterface_OnCurieStateDetached_BP) == 0x00000C, "Wrong size on CurieInterface_OnCurieStateDetached_BP");
