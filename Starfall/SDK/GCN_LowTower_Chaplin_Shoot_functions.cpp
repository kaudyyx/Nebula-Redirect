...
#include "GCN_LowTower_Chaplin_Shoot_classes.hpp"
#include "GCN_LowTower_Chaplin_Shoot_parameters.hpp"
...
void AGCN_LowTower_Chaplin_Shoot_C::OnBurstGeneric(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UFXSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class UMatineeCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	...
	Params::GCN_LowTower_Chaplin_Shoot_C_OnBurstGeneric Parms{};
...
void AGCN_LowTower_Chaplin_Shoot_C::BurstApplied(class AFortPlayerPawn* PlayerPawn) const
{
	static class UFunction* Func = nullptr;
	...
	Params::GCN_LowTower_Chaplin_Shoot_C_BurstApplied Parms{};
