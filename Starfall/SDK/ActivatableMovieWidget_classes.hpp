...
static_assert(sizeof(UActivatableMovieWidget_C) == 0x000568, "Wrong size on UActivatableMovieWidget_C");
static_assert(offsetof(UActivatableMovieWidget_C, MainSafeZone) == 0x000560, "Member 'UActivatableMovieWidget_C::MainSafeZone' has a wrong offset!");
