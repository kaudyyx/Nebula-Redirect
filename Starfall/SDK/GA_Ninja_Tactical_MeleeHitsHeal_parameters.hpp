...
static_assert(sizeof(GA_Ninja_Tactical_MeleeHitsHeal_C_SetupAbility) == 0x0001A0, "Wrong size on GA_Ninja_Tactical_MeleeHitsHeal_C_SetupAbility");
...
static_assert(offsetof(GA_Ninja_Tactical_MeleeHitsHeal_C_SetupAbility, CallFunc_GetDataTableRowFromName_ReturnValue) == 0x000168, "Member 'GA_Ninja_Tactical_MeleeHitsHeal_C_SetupAbility::CallFunc_GetDataTableRowFromName_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_Ninja_Tactical_MeleeHitsHeal_C_SetupAbility, CallFunc_MakeLiteralGameplayTagContainer_ReturnValue) == 0x000170, "Member 'GA_Ninja_Tactical_MeleeHitsHeal_C_SetupAbility::CallFunc_MakeLiteralGameplayTagContainer_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_Ninja_Tactical_MeleeHitsHeal_C_SetupAbility, CallFunc_Multiply_FloatFloat_ReturnValue) == 0x000190, "Member 'GA_Ninja_Tactical_MeleeHitsHeal_C_SetupAbility::CallFunc_Multiply_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_Ninja_Tactical_MeleeHitsHeal_C_SetupAbility, CallFunc_EvaluateAttributeValueWithTagsAndBase_bSuccess) == 0x000194, "Member 'GA_Ninja_Tactical_MeleeHitsHeal_C_SetupAbility::CallFunc_EvaluateAttributeValueWithTagsAndBase_bSuccess' has a wrong offset!");
static_assert(offsetof(GA_Ninja_Tactical_MeleeHitsHeal_C_SetupAbility, CallFunc_EvaluateAttributeValueWithTagsAndBase_ReturnValue) == 0x000198, "Member 'GA_Ninja_Tactical_MeleeHitsHeal_C_SetupAbility::CallFunc_EvaluateAttributeValueWithTagsAndBase_ReturnValue' has a wrong offset!");
