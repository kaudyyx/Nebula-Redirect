...
static_assert(sizeof(FortMobileActionButtonBehavior_ToggleRadio_HandleRadioPlaying) == 0x000010, "Wrong size on FortMobileActionButtonBehavior_ToggleRadio_HandleRadioPlaying");
...
static_assert(sizeof(FortMobileActionButtonBehavior_ToggleRadio_HandleRadioStopped) == 0x000010, "Wrong size on FortMobileActionButtonBehavior_ToggleRadio_HandleRadioStopped");
...
static_assert(sizeof(RadioPlayerWidgetBase_OnFailedToOpenSource) == 0x000010, "Wrong size on RadioPlayerWidgetBase_OnFailedToOpenSource");
...
static_assert(sizeof(RadioPlayerWidgetBase_OnLoadingNewSource) == 0x000010, "Wrong size on RadioPlayerWidgetBase_OnLoadingNewSource");
...
static_assert(sizeof(RadioPlayerWidgetBase_OnRadioStopped) == 0x000010, "Wrong size on RadioPlayerWidgetBase_OnRadioStopped");
...
static_assert(sizeof(RadioPlayerWidgetBase_OnSourceFinished) == 0x000010, "Wrong size on RadioPlayerWidgetBase_OnSourceFinished");
...
static_assert(sizeof(RadioPlayerWidgetBase_OnSourcePlaying) == 0x000010, "Wrong size on RadioPlayerWidgetBase_OnSourcePlaying");
