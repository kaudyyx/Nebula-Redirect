...
static_assert(sizeof(UGamepadKeyTextButton_C) == 0x000CF8, "Wrong size on UGamepadKeyTextButton_C");
...
static_assert(offsetof(UGamepadKeyTextButton_C, IconBrush) == 0x000BF0, "Member 'UGamepadKeyTextButton_C::IconBrush' has a wrong offset!");
static_assert(offsetof(UGamepadKeyTextButton_C, ControllerInputStyle) == 0x000C78, "Member 'UGamepadKeyTextButton_C::ControllerInputStyle' has a wrong offset!");
static_assert(offsetof(UGamepadKeyTextButton_C, ButtonClickAction) == 0x000C80, "Member 'UGamepadKeyTextButton_C::ButtonClickAction' has a wrong offset!");
static_assert(offsetof(UGamepadKeyTextButton_C, ContentAlignment) == 0x000C90, "Member 'UGamepadKeyTextButton_C::ContentAlignment' has a wrong offset!");
static_assert(offsetof(UGamepadKeyTextButton_C, ChangeTheBinding_Button) == 0x000C98, "Member 'UGamepadKeyTextButton_C::ChangeTheBinding_Button' has a wrong offset!");
static_assert(offsetof(UGamepadKeyTextButton_C, ActionNameData) == 0x000CA8, "Member 'UGamepadKeyTextButton_C::ActionNameData' has a wrong offset!");
static_assert(offsetof(UGamepadKeyTextButton_C, KeyData) == 0x000CB0, "Member 'UGamepadKeyTextButton_C::KeyData' has a wrong offset!");
static_assert(offsetof(UGamepadKeyTextButton_C, TextData) == 0x000CC8, "Member 'UGamepadKeyTextButton_C::TextData' has a wrong offset!");
static_assert(offsetof(UGamepadKeyTextButton_C, KeyNone) == 0x000CE0, "Member 'UGamepadKeyTextButton_C::KeyNone' has a wrong offset!");
