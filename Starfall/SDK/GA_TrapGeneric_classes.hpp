...
static_assert(offsetof(UGA_TrapGeneric_C, UberGraphFrame) == 0x000AA8, "Member 'UGA_TrapGeneric_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGA_TrapGeneric_C, CeilingTrap) == 0x000AB0, "Member 'UGA_TrapGeneric_C::CeilingTrap' has a wrong offset!");
static_assert(offsetof(UGA_TrapGeneric_C, CachedDamageTargets) == 0x000AB8, "Member 'UGA_TrapGeneric_C::CachedDamageTargets' has a wrong offset!");
