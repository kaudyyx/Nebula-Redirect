...
public:
	...
	TArray<uint8>                                 BlockedAbilityBindings;                            // 0x1040(0x0010)(Net, ZeroConstructor, Transient, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(AGameplayCueNotify_Actor) == 0x000290, "Wrong size on AGameplayCueNotify_Actor");
...
static_assert(offsetof(AGameplayCueNotify_Actor, ReferenceHelper) == 0x000238, "Member 'AGameplayCueNotify_Actor::ReferenceHelper' has a wrong offset!");
...
static_assert(offsetof(AGameplayCueNotify_Actor, bAutoAttachToOwner) == 0x000250, "Member 'AGameplayCueNotify_Actor::bAutoAttachToOwner' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Actor, IsOverride) == 0x000251, "Member 'AGameplayCueNotify_Actor::IsOverride' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Actor, bUniqueInstancePerInstigator) == 0x000252, "Member 'AGameplayCueNotify_Actor::bUniqueInstancePerInstigator' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Actor, bUniqueInstancePerSourceObject) == 0x000253, "Member 'AGameplayCueNotify_Actor::bUniqueInstancePerSourceObject' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Actor, bAllowMultipleOnActiveEvents) == 0x000254, "Member 'AGameplayCueNotify_Actor::bAllowMultipleOnActiveEvents' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Actor, bAllowMultipleWhileActiveEvents) == 0x000255, "Member 'AGameplayCueNotify_Actor::bAllowMultipleWhileActiveEvents' has a wrong offset!");
static_assert(offsetof(AGameplayCueNotify_Actor, NumPreallocatedInstances) == 0x000258, "Member 'AGameplayCueNotify_Actor::NumPreallocatedInstances' has a wrong offset!");
...
{
public:
	struct FMovieSceneGameplayCueKey              Cue;                                               // 0x0100(0x0070)(Edit, NoDestructor, AssetRegistrySearchable, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieSceneGameplayCueSection) == 0x000170, "Wrong size on UMovieSceneGameplayCueSection");
...
static_assert(sizeof(UMovieSceneGameplayCueTrack) == 0x000088, "Wrong size on UMovieSceneGameplayCueTrack");
static_assert(offsetof(UMovieSceneGameplayCueTrack, Sections) == 0x000078, "Member 'UMovieSceneGameplayCueTrack::Sections' has a wrong offset!");
