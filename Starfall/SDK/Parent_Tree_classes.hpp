...
static_assert(sizeof(AParent_Tree_C) == 0x000C90, "Wrong size on AParent_Tree_C");
static_assert(offsetof(AParent_Tree_C, UberGraphFrame) == 0x000BD8, "Member 'AParent_Tree_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AParent_Tree_C, Wind_Direction) == 0x000BE0, "Member 'AParent_Tree_C::Wind_Direction' has a wrong offset!");
static_assert(offsetof(AParent_Tree_C, StormActive_) == 0x000BEC, "Member 'AParent_Tree_C::StormActive_' has a wrong offset!");
static_assert(offsetof(AParent_Tree_C, DistanceFieldsEnabled_) == 0x000BED, "Member 'AParent_Tree_C::DistanceFieldsEnabled_' has a wrong offset!");
static_assert(offsetof(AParent_Tree_C, WindHandle) == 0x000BF0, "Member 'AParent_Tree_C::WindHandle' has a wrong offset!");
static_assert(offsetof(AParent_Tree_C, DebugWind) == 0x000BF4, "Member 'AParent_Tree_C::DebugWind' has a wrong offset!");
static_assert(offsetof(AParent_Tree_C, Debug_Wind_Intensity) == 0x000BF8, "Member 'AParent_Tree_C::Debug_Wind_Intensity' has a wrong offset!");
static_assert(offsetof(AParent_Tree_C, Debug_TempMaterial) == 0x000C00, "Member 'AParent_Tree_C::Debug_TempMaterial' has a wrong offset!");
static_assert(offsetof(AParent_Tree_C, DebugWindYaw) == 0x000C08, "Member 'AParent_Tree_C::DebugWindYaw' has a wrong offset!");
static_assert(offsetof(AParent_Tree_C, Wind_Intensity_Debug_Mesh) == 0x000C10, "Member 'AParent_Tree_C::Wind_Intensity_Debug_Mesh' has a wrong offset!");
static_assert(offsetof(AParent_Tree_C, SpawnWindFX_) == 0x000C18, "Member 'AParent_Tree_C::SpawnWindFX_' has a wrong offset!");
static_assert(offsetof(AParent_Tree_C, WindFX_Transform) == 0x000C20, "Member 'AParent_Tree_C::WindFX_Transform' has a wrong offset!");
static_assert(offsetof(AParent_Tree_C, WindFX_MaxDrawDistance) == 0x000C50, "Member 'AParent_Tree_C::WindFX_MaxDrawDistance' has a wrong offset!");
static_assert(offsetof(AParent_Tree_C, WindFX) == 0x000C58, "Member 'AParent_Tree_C::WindFX' has a wrong offset!");
static_assert(offsetof(AParent_Tree_C, LeafRadius) == 0x000C60, "Member 'AParent_Tree_C::LeafRadius' has a wrong offset!");
static_assert(offsetof(AParent_Tree_C, LeafCenter_Offset) == 0x000C64, "Member 'AParent_Tree_C::LeafCenter_Offset' has a wrong offset!");
static_assert(offsetof(AParent_Tree_C, UseCylinder) == 0x000C70, "Member 'AParent_Tree_C::UseCylinder' has a wrong offset!");
static_assert(offsetof(AParent_Tree_C, Hue) == 0x000C74, "Member 'AParent_Tree_C::Hue' has a wrong offset!");
static_assert(offsetof(AParent_Tree_C, WindDirection) == 0x000C78, "Member 'AParent_Tree_C::WindDirection' has a wrong offset!");
static_assert(offsetof(AParent_Tree_C, BoundRadius) == 0x000C84, "Member 'AParent_Tree_C::BoundRadius' has a wrong offset!");
static_assert(offsetof(AParent_Tree_C, BoundsHeight_CylinderOnly_) == 0x000C88, "Member 'AParent_Tree_C::BoundsHeight_CylinderOnly_' has a wrong offset!");
