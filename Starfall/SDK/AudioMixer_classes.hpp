...
static_assert(sizeof(USynthSound) == 0x0003C0, "Wrong size on USynthSound");
static_assert(offsetof(USynthSound, OwningSynthComponent) == 0x0003A0, "Member 'USynthSound::OwningSynthComponent' has a wrong offset!");
