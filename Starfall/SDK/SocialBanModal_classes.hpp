...
static_assert(offsetof(USocialBanModal_C, AckSucceeded) == 0x0004E0, "Member 'USocialBanModal_C::AckSucceeded' has a wrong offset!");
static_assert(offsetof(USocialBanModal_C, BanInformation) == 0x0004E8, "Member 'USocialBanModal_C::BanInformation' has a wrong offset!");
static_assert(offsetof(USocialBanModal_C, OnCloseSucceeded) == 0x000500, "Member 'USocialBanModal_C::OnCloseSucceeded' has a wrong offset!");
static_assert(offsetof(USocialBanModal_C, TryCount) == 0x000510, "Member 'USocialBanModal_C::TryCount' has a wrong offset!");
static_assert(offsetof(USocialBanModal_C, bIsWarning) == 0x000514, "Member 'USocialBanModal_C::bIsWarning' has a wrong offset!");
static_assert(offsetof(USocialBanModal_C, McpBanInfo) == 0x000518, "Member 'USocialBanModal_C::McpBanInfo' has a wrong offset!");
static_assert(offsetof(USocialBanModal_C, BanType) == 0x000558, "Member 'USocialBanModal_C::BanType' has a wrong offset!");
static_assert(offsetof(USocialBanModal_C, bIsCompetitiveBan) == 0x000570, "Member 'USocialBanModal_C::bIsCompetitiveBan' has a wrong offset!");
