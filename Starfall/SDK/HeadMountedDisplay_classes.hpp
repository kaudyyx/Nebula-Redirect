...
public:
	...
	TArray<class UMaterialInterface*>             DisplayMeshMaterialOverrides;                      // 0x0468(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
