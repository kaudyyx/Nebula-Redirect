...
static_assert(sizeof(ATrap_Floor_Player_Jump_Free_Direction_Pad_C) == 0x000E00, "Wrong size on ATrap_Floor_Player_Jump_Free_Direction_Pad_C");
static_assert(offsetof(ATrap_Floor_Player_Jump_Free_Direction_Pad_C, UberGraphFrame) == 0x000DA8, "Member 'ATrap_Floor_Player_Jump_Free_Direction_Pad_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ATrap_Floor_Player_Jump_Free_Direction_Pad_C, Trigger) == 0x000DB0, "Member 'ATrap_Floor_Player_Jump_Free_Direction_Pad_C::Trigger' has a wrong offset!");
static_assert(offsetof(ATrap_Floor_Player_Jump_Free_Direction_Pad_C, JumpParticleSystem) == 0x000DB8, "Member 'ATrap_Floor_Player_Jump_Free_Direction_Pad_C::JumpParticleSystem' has a wrong offset!");
static_assert(offsetof(ATrap_Floor_Player_Jump_Free_Direction_Pad_C, Scene1) == 0x000DC0, "Member 'ATrap_Floor_Player_Jump_Free_Direction_Pad_C::Scene1' has a wrong offset!");
static_assert(offsetof(ATrap_Floor_Player_Jump_Free_Direction_Pad_C, Trap_Placed_Sound) == 0x000DC8, "Member 'ATrap_Floor_Player_Jump_Free_Direction_Pad_C::Trap_Placed_Sound' has a wrong offset!");
static_assert(offsetof(ATrap_Floor_Player_Jump_Free_Direction_Pad_C, Trap_Active_Sound) == 0x000DD0, "Member 'ATrap_Floor_Player_Jump_Free_Direction_Pad_C::Trap_Active_Sound' has a wrong offset!");
static_assert(offsetof(ATrap_Floor_Player_Jump_Free_Direction_Pad_C, Trap_Fire_Sound) == 0x000DD8, "Member 'ATrap_Floor_Player_Jump_Free_Direction_Pad_C::Trap_Fire_Sound' has a wrong offset!");
static_assert(offsetof(ATrap_Floor_Player_Jump_Free_Direction_Pad_C, Trap_Reload_Sound) == 0x000DE0, "Member 'ATrap_Floor_Player_Jump_Free_Direction_Pad_C::Trap_Reload_Sound' has a wrong offset!");
static_assert(offsetof(ATrap_Floor_Player_Jump_Free_Direction_Pad_C, Trap_Explode_Sound) == 0x000DE8, "Member 'ATrap_Floor_Player_Jump_Free_Direction_Pad_C::Trap_Explode_Sound' has a wrong offset!");
static_assert(offsetof(ATrap_Floor_Player_Jump_Free_Direction_Pad_C, JumpMaterial) == 0x000DF0, "Member 'ATrap_Floor_Player_Jump_Free_Direction_Pad_C::JumpMaterial' has a wrong offset!");
static_assert(offsetof(ATrap_Floor_Player_Jump_Free_Direction_Pad_C, LaunchStrength) == 0x000DF8, "Member 'ATrap_Floor_Player_Jump_Free_Direction_Pad_C::LaunchStrength' has a wrong offset!");
static_assert(offsetof(ATrap_Floor_Player_Jump_Free_Direction_Pad_C, LaunchPitch) == 0x000DFC, "Member 'ATrap_Floor_Player_Jump_Free_Direction_Pad_C::LaunchPitch' has a wrong offset!");
