...
static_assert(offsetof(UEnableMultiFactorAuthModalBP_C, DesiredFrontEndCamera) == 0x000568, "Member 'UEnableMultiFactorAuthModalBP_C::DesiredFrontEndCamera' has a wrong offset!");
static_assert(offsetof(UEnableMultiFactorAuthModalBP_C, PreviewItemDef) == 0x000570, "Member 'UEnableMultiFactorAuthModalBP_C::PreviewItemDef' has a wrong offset!");
