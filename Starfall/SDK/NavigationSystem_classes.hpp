...
static_assert(sizeof(UNavMeshRenderingComponent) == 0x000450, "Wrong size on UNavMeshRenderingComponent");
...
static_assert(sizeof(UNavLinkRenderingComponent) == 0x000440, "Wrong size on UNavLinkRenderingComponent");
...
public:
	...
	TArray<struct FNavigationLink>                Links;                                             // 0x0448(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UNavLinkComponent) == 0x000460, "Wrong size on UNavLinkComponent");
static_assert(offsetof(UNavLinkComponent, Links) == 0x000448, "Member 'UNavLinkComponent::Links' has a wrong offset!");
...
static_assert(sizeof(UNavTestRenderingComponent) == 0x000440, "Wrong size on UNavTestRenderingComponent");
