...
static_assert(offsetof(UMovieSceneCameraCutSection, CameraGuid) == 0x0000F0, "Member 'UMovieSceneCameraCutSection::CameraGuid' has a wrong offset!");
static_assert(offsetof(UMovieSceneCameraCutSection, CameraBindingID) == 0x000100, "Member 'UMovieSceneCameraCutSection::CameraBindingID' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneSkeletalAnimationSection) == 0x0001E8, "Wrong size on UMovieSceneSkeletalAnimationSection");
...
static_assert(sizeof(UMovieSceneSkeletalAnimationTrack) == 0x000098, "Wrong size on UMovieSceneSkeletalAnimationTrack");
