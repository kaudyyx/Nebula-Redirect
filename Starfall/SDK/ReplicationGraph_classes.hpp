...
static_assert(sizeof(UReplicationGraphNode_ConnectionDormancyNode) == 0x000148, "Wrong size on UReplicationGraphNode_ConnectionDormancyNode");
...
public:
	...
	TArray<struct FLastLocationGatherInfo>        LastGatherLocations;                               // 0x0188(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_198[0x8];                                      // 0x0198(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UReplicationGraphNode*>          ConnectionGraphNodes;                              // 0x01A0(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
