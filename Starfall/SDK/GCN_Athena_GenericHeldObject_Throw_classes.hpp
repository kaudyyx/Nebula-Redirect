...
static_assert(sizeof(UGCN_Athena_GenericHeldObject_Throw_C) == 0x0001C0, "Wrong size on UGCN_Athena_GenericHeldObject_Throw_C");
static_assert(offsetof(UGCN_Athena_GenericHeldObject_Throw_C, Throw_Sound) == 0x0001B8, "Member 'UGCN_Athena_GenericHeldObject_Throw_C::Throw_Sound' has a wrong offset!");
