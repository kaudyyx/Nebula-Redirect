...
static_assert(offsetof(B_ShootingTarget_Master_C_WeakPointWasHit, CallFunc_BreakHitResult_ElementIndex) == 0x0000FC, "Member 'B_ShootingTarget_Master_C_WeakPointWasHit::CallFunc_BreakHitResult_ElementIndex' has a wrong offset!");
static_assert(offsetof(B_ShootingTarget_Master_C_WeakPointWasHit, CallFunc_BreakHitResult_FaceIndex) == 0x000100, "Member 'B_ShootingTarget_Master_C_WeakPointWasHit::CallFunc_BreakHitResult_FaceIndex' has a wrong offset!");
static_assert(offsetof(B_ShootingTarget_Master_C_WeakPointWasHit, CallFunc_BreakHitResult_TraceStart) == 0x000104, "Member 'B_ShootingTarget_Master_C_WeakPointWasHit::CallFunc_BreakHitResult_TraceStart' has a wrong offset!");
static_assert(offsetof(B_ShootingTarget_Master_C_WeakPointWasHit, CallFunc_BreakHitResult_TraceEnd) == 0x000110, "Member 'B_ShootingTarget_Master_C_WeakPointWasHit::CallFunc_BreakHitResult_TraceEnd' has a wrong offset!");
static_assert(offsetof(B_ShootingTarget_Master_C_WeakPointWasHit, CallFunc_ComponentHasTag_ReturnValue) == 0x00011C, "Member 'B_ShootingTarget_Master_C_WeakPointWasHit::CallFunc_ComponentHasTag_ReturnValue' has a wrong offset!");
static_assert(offsetof(B_ShootingTarget_Master_C_WeakPointWasHit, CallFunc_Conv_VectorToRotator_ReturnValue) == 0x000120, "Member 'B_ShootingTarget_Master_C_WeakPointWasHit::CallFunc_Conv_VectorToRotator_ReturnValue' has a wrong offset!");
