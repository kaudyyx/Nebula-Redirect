...
static_assert(sizeof(AMASTER_TODM_C) == 0x001090, "Wrong size on AMASTER_TODM_C");
...
static_assert(offsetof(AMASTER_TODM_C, Night) == 0x001050, "Member 'AMASTER_TODM_C::Night' has a wrong offset!");
static_assert(offsetof(AMASTER_TODM_C, Evening) == 0x001060, "Member 'AMASTER_TODM_C::Evening' has a wrong offset!");
static_assert(offsetof(AMASTER_TODM_C, Day) == 0x001070, "Member 'AMASTER_TODM_C::Day' has a wrong offset!");
static_assert(offsetof(AMASTER_TODM_C, Morning) == 0x001080, "Member 'AMASTER_TODM_C::Morning' has a wrong offset!");
