...
static_assert(sizeof(UGA_Athena_Grenade_Rethrow_C) == 0x000E88, "Wrong size on UGA_Athena_Grenade_Rethrow_C");
static_assert(offsetof(UGA_Athena_Grenade_Rethrow_C, UberGraphFrame_GA_Athena_Grenade_Rethrow_C) == 0x000E68, "Member 'UGA_Athena_Grenade_Rethrow_C::UberGraphFrame_GA_Athena_Grenade_Rethrow_C' has a wrong offset!");
static_assert(offsetof(UGA_Athena_Grenade_Rethrow_C, Projectile) == 0x000E70, "Member 'UGA_Athena_Grenade_Rethrow_C::Projectile' has a wrong offset!");
static_assert(offsetof(UGA_Athena_Grenade_Rethrow_C, TossDelay) == 0x000E78, "Member 'UGA_Athena_Grenade_Rethrow_C::TossDelay' has a wrong offset!");
static_assert(offsetof(UGA_Athena_Grenade_Rethrow_C, HolsterId) == 0x000E7C, "Member 'UGA_Athena_Grenade_Rethrow_C::HolsterId' has a wrong offset!");
