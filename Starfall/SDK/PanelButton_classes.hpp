...
static_assert(sizeof(UPanelButton_C) == 0x000BE8, "Wrong size on UPanelButton_C");
...
static_assert(offsetof(UPanelButton_C, ButtonClickAction) == 0x000BC0, "Member 'UPanelButton_C::ButtonClickAction' has a wrong offset!");
static_assert(offsetof(UPanelButton_C, InputActionHorizontalAlignment) == 0x000BD0, "Member 'UPanelButton_C::InputActionHorizontalAlignment' has a wrong offset!");
static_assert(offsetof(UPanelButton_C, InputActionVerticalAlignment) == 0x000BD1, "Member 'UPanelButton_C::InputActionVerticalAlignment' has a wrong offset!");
static_assert(offsetof(UPanelButton_C, InputActionRenderTranslation) == 0x000BD4, "Member 'UPanelButton_C::InputActionRenderTranslation' has a wrong offset!");
static_assert(offsetof(UPanelButton_C, InputActionUseRimBrush) == 0x000BDC, "Member 'UPanelButton_C::InputActionUseRimBrush' has a wrong offset!");
static_assert(offsetof(UPanelButton_C, InputActionRimBrushSize) == 0x000BE0, "Member 'UPanelButton_C::InputActionRimBrushSize' has a wrong offset!");
