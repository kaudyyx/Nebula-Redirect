...
static_assert(sizeof(UVoiceChatMemberListEntry_C) == 0x000C60, "Wrong size on UVoiceChatMemberListEntry_C");
...
static_assert(offsetof(UVoiceChatMemberListEntry_C, Encourage) == 0x000C38, "Member 'UVoiceChatMemberListEntry_C::Encourage' has a wrong offset!");
static_assert(offsetof(UVoiceChatMemberListEntry_C, EncourageEpicFriend_IdleColor) == 0x000C3C, "Member 'UVoiceChatMemberListEntry_C::EncourageEpicFriend_IdleColor' has a wrong offset!");
static_assert(offsetof(UVoiceChatMemberListEntry_C, EncourageEpicFriend_HoveredColor) == 0x000C4C, "Member 'UVoiceChatMemberListEntry_C::EncourageEpicFriend_HoveredColor' has a wrong offset!");
