...
static_assert(sizeof(UGA_Athena_Track_PurpleMouse_C) == 0x000AF0, "Wrong size on UGA_Athena_Track_PurpleMouse_C");
static_assert(offsetof(UGA_Athena_Track_PurpleMouse_C, UberGraphFrame) == 0x000AA8, "Member 'UGA_Athena_Track_PurpleMouse_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGA_Athena_Track_PurpleMouse_C, PlayerPawn) == 0x000AB0, "Member 'UGA_Athena_Track_PurpleMouse_C::PlayerPawn' has a wrong offset!");
static_assert(offsetof(UGA_Athena_Track_PurpleMouse_C, TrackGroupTag) == 0x000AB8, "Member 'UGA_Athena_Track_PurpleMouse_C::TrackGroupTag' has a wrong offset!");
static_assert(offsetof(UGA_Athena_Track_PurpleMouse_C, ProxMineActors) == 0x000AC0, "Member 'UGA_Athena_Track_PurpleMouse_C::ProxMineActors' has a wrong offset!");
static_assert(offsetof(UGA_Athena_Track_PurpleMouse_C, MaxPropsInWorld) == 0x000AD0, "Member 'UGA_Athena_Track_PurpleMouse_C::MaxPropsInWorld' has a wrong offset!");
