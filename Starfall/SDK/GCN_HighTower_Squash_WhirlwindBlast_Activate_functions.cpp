...
#include "GCN_HighTower_Squash_WhirlwindBlast_Activate_classes.hpp"
#include "GCN_HighTower_Squash_WhirlwindBlast_Activate_parameters.hpp"
...
void UGCN_HighTower_Squash_WhirlwindBlast_Activate_C::OnBurstNiagara(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UNiagaraComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class UMatineeCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	...
	Params::GCN_HighTower_Squash_WhirlwindBlast_Activate_C_OnBurstNiagara Parms{};
