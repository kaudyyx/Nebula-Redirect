...
static_assert(sizeof(USettingsListEntry_Discrete_C) == 0x000320, "Wrong size on USettingsListEntry_Discrete_C");
static_assert(offsetof(USettingsListEntry_Discrete_C, UberGraphFrame) == 0x0002F0, "Member 'USettingsListEntry_Discrete_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(USettingsListEntry_Discrete_C, OnHover) == 0x0002F8, "Member 'USettingsListEntry_Discrete_C::OnHover' has a wrong offset!");
static_assert(offsetof(USettingsListEntry_Discrete_C, Button_FirstOption) == 0x000300, "Member 'USettingsListEntry_Discrete_C::Button_FirstOption' has a wrong offset!");
static_assert(offsetof(USettingsListEntry_Discrete_C, Button_SecondOption) == 0x000308, "Member 'USettingsListEntry_Discrete_C::Button_SecondOption' has a wrong offset!");
static_assert(offsetof(USettingsListEntry_Discrete_C, OptionsSets) == 0x000310, "Member 'USettingsListEntry_Discrete_C::OptionsSets' has a wrong offset!");
static_assert(offsetof(USettingsListEntry_Discrete_C, Several_Options) == 0x000318, "Member 'USettingsListEntry_Discrete_C::Several_Options' has a wrong offset!");
