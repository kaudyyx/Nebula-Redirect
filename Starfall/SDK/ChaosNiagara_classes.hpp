...
static_assert(sizeof(UNiagaraDataInterfaceFieldSystem) == 0x000090, "Wrong size on UNiagaraDataInterfaceFieldSystem");
static_assert(offsetof(UNiagaraDataInterfaceFieldSystem, BlueprintSource) == 0x000038, "Member 'UNiagaraDataInterfaceFieldSystem::BlueprintSource' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceFieldSystem, SourceActor) == 0x000040, "Member 'UNiagaraDataInterfaceFieldSystem::SourceActor' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceFieldSystem, FieldDimensions) == 0x000048, "Member 'UNiagaraDataInterfaceFieldSystem::FieldDimensions' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceFieldSystem, MinBounds) == 0x000054, "Member 'UNiagaraDataInterfaceFieldSystem::MinBounds' has a wrong offset!");
static_assert(offsetof(UNiagaraDataInterfaceFieldSystem, MaxBounds) == 0x000060, "Member 'UNiagaraDataInterfaceFieldSystem::MaxBounds' has a wrong offset!");
