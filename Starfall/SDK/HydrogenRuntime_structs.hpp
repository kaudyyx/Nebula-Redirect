...
static_assert(sizeof(FHydrogenPathNames) == 0x000038, "Wrong size on FHydrogenPathNames");
...
static_assert(offsetof(FHydrogenPathNames, PathGameplayTag) == 0x000020, "Member 'FHydrogenPathNames::PathGameplayTag' has a wrong offset!");
static_assert(offsetof(FHydrogenPathNames, PathNames) == 0x000028, "Member 'FHydrogenPathNames::PathNames' has a wrong offset!");
