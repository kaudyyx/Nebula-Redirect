...
#include "GCN_HighTower_Wasabi_Claws_Finisher_AirAttack_Impact_classes.hpp"
#include "GCN_HighTower_Wasabi_Claws_Finisher_AirAttack_Impact_parameters.hpp"
...
void UGCN_HighTower_Wasabi_Claws_Finisher_AirAttack_Impact_C::OnBurst(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UParticleSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class UMatineeCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCN_HighTower_Wasabi_Claws_Finisher_AirAttack_Impact_C", "OnBurst");

	Params::GCN_HighTower_Wasabi_Claws_Finisher_AirAttack_Impact_C_OnBurst Parms{};
