...
static_assert(alignof(NitrogenWidgetBase_BP_BindToMutator) == 0x000008, "Wrong alignment on NitrogenWidgetBase_BP_BindToMutator");
static_assert(sizeof(NitrogenWidgetBase_BP_BindToMutator) == 0x000008, "Wrong size on NitrogenWidgetBase_BP_BindToMutator");
static_assert(offsetof(NitrogenWidgetBase_BP_BindToMutator, Mutator) == 0x000000, "Member 'NitrogenWidgetBase_BP_BindToMutator::Mutator' has a wrong offset!");
...
static_assert(alignof(NitrogenFareInteractionWidget_OnBeginInteraction) == 0x000008, "Wrong alignment on NitrogenFareInteractionWidget_OnBeginInteraction");
static_assert(sizeof(NitrogenFareInteractionWidget_OnBeginInteraction) == 0x000018, "Wrong size on NitrogenFareInteractionWidget_OnBeginInteraction");
static_assert(offsetof(NitrogenFareInteractionWidget_OnBeginInteraction, FareInteractionData) == 0x000000, "Member 'NitrogenFareInteractionWidget_OnBeginInteraction::FareInteractionData' has a wrong offset!");
...
static_assert(alignof(NitrogenFareInteractionWidget_UpdateTimerDisplay) == 0x000001, "Wrong alignment on NitrogenFareInteractionWidget_UpdateTimerDisplay");
static_assert(sizeof(NitrogenFareInteractionWidget_UpdateTimerDisplay) == 0x000001, "Wrong size on NitrogenFareInteractionWidget_UpdateTimerDisplay");
static_assert(offsetof(NitrogenFareInteractionWidget_UpdateTimerDisplay, bCanceled) == 0x000000, "Member 'NitrogenFareInteractionWidget_UpdateTimerDisplay::bCanceled' has a wrong offset!");
...
static_assert(alignof(NitrogenFareMeterWidget_OnBeginInteraction) == 0x000008, "Wrong alignment on NitrogenFareMeterWidget_OnBeginInteraction");
static_assert(sizeof(NitrogenFareMeterWidget_OnBeginInteraction) == 0x000018, "Wrong size on NitrogenFareMeterWidget_OnBeginInteraction");
static_assert(offsetof(NitrogenFareMeterWidget_OnBeginInteraction, FareInteractionData) == 0x000000, "Member 'NitrogenFareMeterWidget_OnBeginInteraction::FareInteractionData' has a wrong offset!");
...
static_assert(alignof(NitrogenSpeedyBonusTimerWidget_OnEndFare) == 0x000001, "Wrong alignment on NitrogenSpeedyBonusTimerWidget_OnEndFare");
static_assert(sizeof(NitrogenSpeedyBonusTimerWidget_OnEndFare) == 0x000001, "Wrong size on NitrogenSpeedyBonusTimerWidget_OnEndFare");
static_assert(offsetof(NitrogenSpeedyBonusTimerWidget_OnEndFare, bFareCompleted) == 0x000000, "Member 'NitrogenSpeedyBonusTimerWidget_OnEndFare::bFareCompleted' has a wrong offset!");
...
static_assert(alignof(NitrogenSpeedyBonusTimerWidget_OnSpeedyDeliveryFailed) == 0x000001, "Wrong alignment on NitrogenSpeedyBonusTimerWidget_OnSpeedyDeliveryFailed");
static_assert(sizeof(NitrogenSpeedyBonusTimerWidget_OnSpeedyDeliveryFailed) == 0x000001, "Wrong size on NitrogenSpeedyBonusTimerWidget_OnSpeedyDeliveryFailed");
static_assert(offsetof(NitrogenSpeedyBonusTimerWidget_OnSpeedyDeliveryFailed, bPlayAnimation) == 0x000000, "Member 'NitrogenSpeedyBonusTimerWidget_OnSpeedyDeliveryFailed::bPlayAnimation' has a wrong offset!");
...
static_assert(alignof(NitrogenSpeedyBonusTimerWidget_OnSpeedyDeliveryTimeUpdate) == 0x000004, "Wrong alignment on NitrogenSpeedyBonusTimerWidget_OnSpeedyDeliveryTimeUpdate");
static_assert(sizeof(NitrogenSpeedyBonusTimerWidget_OnSpeedyDeliveryTimeUpdate) == 0x000008, "Wrong size on NitrogenSpeedyBonusTimerWidget_OnSpeedyDeliveryTimeUpdate");
static_assert(offsetof(NitrogenSpeedyBonusTimerWidget_OnSpeedyDeliveryTimeUpdate, TimePrecentage) == 0x000000, "Member 'NitrogenSpeedyBonusTimerWidget_OnSpeedyDeliveryTimeUpdate::TimePrecentage' has a wrong offset!");
static_assert(offsetof(NitrogenSpeedyBonusTimerWidget_OnSpeedyDeliveryTimeUpdate, TotalObjectiveTime) == 0x000004, "Member 'NitrogenSpeedyBonusTimerWidget_OnSpeedyDeliveryTimeUpdate::TotalObjectiveTime' has a wrong offset!");
