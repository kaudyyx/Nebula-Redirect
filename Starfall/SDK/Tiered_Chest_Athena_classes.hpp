...
static_assert(sizeof(ATiered_Chest_Athena_C) == 0x000E08, "Wrong size on ATiered_Chest_Athena_C");
static_assert(offsetof(ATiered_Chest_Athena_C, UberGraphFrame) == 0x000D28, "Member 'ATiered_Chest_Athena_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ATiered_Chest_Athena_C, P_Loot_Chest_Aura_Athena) == 0x000D30, "Member 'ATiered_Chest_Athena_C::P_Loot_Chest_Aura_Athena' has a wrong offset!");
static_assert(offsetof(ATiered_Chest_Athena_C, S_Chest_SmokeSheet) == 0x000D38, "Member 'ATiered_Chest_Athena_C::S_Chest_SmokeSheet' has a wrong offset!");
static_assert(offsetof(ATiered_Chest_Athena_C, TreasureLight) == 0x000D40, "Member 'ATiered_Chest_Athena_C::TreasureLight' has a wrong offset!");
static_assert(offsetof(ATiered_Chest_Athena_C, Chest_Ambient_Sound) == 0x000D48, "Member 'ATiered_Chest_Athena_C::Chest_Ambient_Sound' has a wrong offset!");
static_assert(offsetof(ATiered_Chest_Athena_C, Timeline_0_Time_C3D8BC62418047EE3E783F89FAF8EEB6) == 0x000D50, "Member 'ATiered_Chest_Athena_C::Timeline_0_Time_C3D8BC62418047EE3E783F89FAF8EEB6' has a wrong offset!");
static_assert(offsetof(ATiered_Chest_Athena_C, Timeline_0__Direction_C3D8BC62418047EE3E783F89FAF8EEB6) == 0x000D54, "Member 'ATiered_Chest_Athena_C::Timeline_0__Direction_C3D8BC62418047EE3E783F89FAF8EEB6' has a wrong offset!");
static_assert(offsetof(ATiered_Chest_Athena_C, Timeline_0) == 0x000D58, "Member 'ATiered_Chest_Athena_C::Timeline_0' has a wrong offset!");
...
static_assert(offsetof(ATiered_Chest_Athena_C, ChestChimeVisualUpdate) == 0x000DAC, "Member 'ATiered_Chest_Athena_C::ChestChimeVisualUpdate' has a wrong offset!");
static_assert(offsetof(ATiered_Chest_Athena_C, MobileInteractionMaterial) == 0x000DB0, "Member 'ATiered_Chest_Athena_C::MobileInteractionMaterial' has a wrong offset!");
static_assert(offsetof(ATiered_Chest_Athena_C, MobileInteractIcon) == 0x000DB8, "Member 'ATiered_Chest_Athena_C::MobileInteractIcon' has a wrong offset!");
static_assert(offsetof(ATiered_Chest_Athena_C, MobileInteractIconLocation) == 0x000DC0, "Member 'ATiered_Chest_Athena_C::MobileInteractIconLocation' has a wrong offset!");
static_assert(offsetof(ATiered_Chest_Athena_C, MobileInteractIconScale) == 0x000DCC, "Member 'ATiered_Chest_Athena_C::MobileInteractIconScale' has a wrong offset!");
static_assert(offsetof(ATiered_Chest_Athena_C, Open_Chest_Sound) == 0x000DD8, "Member 'ATiered_Chest_Athena_C::Open_Chest_Sound' has a wrong offset!");
static_assert(offsetof(ATiered_Chest_Athena_C, P_Loot_Chest_Opened_FX) == 0x000DE0, "Member 'ATiered_Chest_Athena_C::P_Loot_Chest_Opened_FX' has a wrong offset!");
static_assert(offsetof(ATiered_Chest_Athena_C, NewVar_0) == 0x000DE8, "Member 'ATiered_Chest_Athena_C::NewVar_0' has a wrong offset!");
static_assert(offsetof(ATiered_Chest_Athena_C, NewVar_1) == 0x000DF0, "Member 'ATiered_Chest_Athena_C::NewVar_1' has a wrong offset!");
static_assert(offsetof(ATiered_Chest_Athena_C, Galileo_Chest_Open_FX) == 0x000DF8, "Member 'ATiered_Chest_Athena_C::Galileo_Chest_Open_FX' has a wrong offset!");
static_assert(offsetof(ATiered_Chest_Athena_C, OpenFX_Rotation) == 0x000E00, "Member 'ATiered_Chest_Athena_C::OpenFX_Rotation' has a wrong offset!");
