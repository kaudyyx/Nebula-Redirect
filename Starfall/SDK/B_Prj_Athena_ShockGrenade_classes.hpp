...
static_assert(sizeof(AB_Prj_Athena_ShockGrenade_C) == 0x000A20, "Wrong size on AB_Prj_Athena_ShockGrenade_C");
...
static_assert(offsetof(AB_Prj_Athena_ShockGrenade_C, ShouldDestroy) == 0x000938, "Member 'AB_Prj_Athena_ShockGrenade_C::ShouldDestroy' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_ShockGrenade_C, LaunchVelocity) == 0x000958, "Member 'AB_Prj_Athena_ShockGrenade_C::LaunchVelocity' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_ShockGrenade_C, ExplodeDelay) == 0x000978, "Member 'AB_Prj_Athena_ShockGrenade_C::ExplodeDelay' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_ShockGrenade_C, EnemiesTakeFallDamage) == 0x000998, "Member 'AB_Prj_Athena_ShockGrenade_C::EnemiesTakeFallDamage' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_ShockGrenade_C, AllPlayersTakeFallDamage) == 0x0009B8, "Member 'AB_Prj_Athena_ShockGrenade_C::AllPlayersTakeFallDamage' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_ShockGrenade_C, Cue_StopSound) == 0x0009D8, "Member 'AB_Prj_Athena_ShockGrenade_C::Cue_StopSound' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_ShockGrenade_C, ChestLootTableName) == 0x0009E0, "Member 'AB_Prj_Athena_ShockGrenade_C::ChestLootTableName' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_ShockGrenade_C, FeedbackCue) == 0x0009E8, "Member 'AB_Prj_Athena_ShockGrenade_C::FeedbackCue' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_ShockGrenade_C, HitWater) == 0x0009F0, "Member 'AB_Prj_Athena_ShockGrenade_C::HitWater' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_ShockGrenade_C, Water_Debris_Explosion) == 0x0009F8, "Member 'AB_Prj_Athena_ShockGrenade_C::Water_Debris_Explosion' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_ShockGrenade_C, P_WaterExplosion) == 0x000A00, "Member 'AB_Prj_Athena_ShockGrenade_C::P_WaterExplosion' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_ShockGrenade_C, TargetVehicle) == 0x000A08, "Member 'AB_Prj_Athena_ShockGrenade_C::TargetVehicle' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_ShockGrenade_C, GE_KnockbackStatus) == 0x000A10, "Member 'AB_Prj_Athena_ShockGrenade_C::GE_KnockbackStatus' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_ShockGrenade_C, Tag_BuildingPhysocs) == 0x000A18, "Member 'AB_Prj_Athena_ShockGrenade_C::Tag_BuildingPhysocs' has a wrong offset!");
