...
static_assert(sizeof(AGCN_Athena_Interrogation_Reveal_Latent_C) == 0x0004E8, "Wrong size on AGCN_Athena_Interrogation_Reveal_Latent_C");
...
static_assert(offsetof(AGCN_Athena_Interrogation_Reveal_Latent_C, StencilSweepDuration) == 0x0004C0, "Member 'AGCN_Athena_Interrogation_Reveal_Latent_C::StencilSweepDuration' has a wrong offset!");
static_assert(offsetof(AGCN_Athena_Interrogation_Reveal_Latent_C, StencilDuration) == 0x0004C8, "Member 'AGCN_Athena_Interrogation_Reveal_Latent_C::StencilDuration' has a wrong offset!");
