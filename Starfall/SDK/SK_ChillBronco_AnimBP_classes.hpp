...
static_assert(sizeof(USK_ChillBronco_AnimBP_C) == 0x000F70, "Wrong size on USK_ChillBronco_AnimBP_C");
...
static_assert(offsetof(USK_ChillBronco_AnimBP_C, AnimGraphNode_ModifyBone) == 0x000E60, "Member 'USK_ChillBronco_AnimBP_C::AnimGraphNode_ModifyBone' has a wrong offset!");
