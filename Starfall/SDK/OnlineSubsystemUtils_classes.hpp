...
public:
	...
	uint8                                         Pad_1B04[0x4C];                                    // 0x1B04(0x004C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UIpConnection) == 0x001B50, "Wrong size on UIpConnection");
static_assert(offsetof(UIpConnection, SocketErrorDisconnectDelay) == 0x001B00, "Member 'UIpConnection::SocketErrorDisconnectDelay' has a wrong offset!");
