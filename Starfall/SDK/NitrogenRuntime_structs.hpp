...
static_assert(offsetof(FNitrogenBonusStat, CosmeticLoadoutData) == 0x000088, "Member 'FNitrogenBonusStat::CosmeticLoadoutData' has a wrong offset!");
...
static_assert(alignof(FNitrogenFareInteractionData) == 0x000008, "Wrong alignment on FNitrogenFareInteractionData");
static_assert(sizeof(FNitrogenFareInteractionData) == 0x000018, "Wrong size on FNitrogenFareInteractionData");
static_assert(offsetof(FNitrogenFareInteractionData, Fare) == 0x000000, "Member 'FNitrogenFareInteractionData::Fare' has a wrong offset!");
static_assert(offsetof(FNitrogenFareInteractionData, StartTime) == 0x000008, "Member 'FNitrogenFareInteractionData::StartTime' has a wrong offset!");
static_assert(offsetof(FNitrogenFareInteractionData, TotalTime) == 0x00000C, "Member 'FNitrogenFareInteractionData::TotalTime' has a wrong offset!");
static_assert(offsetof(FNitrogenFareInteractionData, CurrentBonusIndex) == 0x000010, "Member 'FNitrogenFareInteractionData::CurrentBonusIndex' has a wrong offset!");
static_assert(offsetof(FNitrogenFareInteractionData, bIsDropoff) == 0x000014, "Member 'FNitrogenFareInteractionData::bIsDropoff' has a wrong offset!");
