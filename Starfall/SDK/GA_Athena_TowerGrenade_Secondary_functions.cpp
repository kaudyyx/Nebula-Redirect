...
#include "GA_Athena_TowerGrenade_Secondary_parameters.hpp"
...
void UGA_Athena_TowerGrenade_Secondary_C::ExecuteUbergraph_GA_Athena_TowerGrenade_Secondary(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GA_Athena_TowerGrenade_Secondary_C", "ExecuteUbergraph_GA_Athena_TowerGrenade_Secondary");

	Params::GA_Athena_TowerGrenade_Secondary_C_ExecuteUbergraph_GA_Athena_TowerGrenade_Secondary Parms{};
...
void UGA_Athena_TowerGrenade_Secondary_C::UpdateTrajectorySpline()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("GA_Athena_TowerGrenade_Secondary_C", "UpdateTrajectorySpline");
...
void UGA_Athena_TowerGrenade_Secondary_C::CleanupTrajectory()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("GA_Athena_TowerGrenade_Secondary_C", "CleanupTrajectory");
...
void UGA_Athena_TowerGrenade_Secondary_C::K2_ActivateAbility()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("GA_Athena_TowerGrenade_Secondary_C", "K2_ActivateAbility");
...
bool UGA_Athena_TowerGrenade_Secondary_C::IsTrajectoryHidden()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("GA_Athena_TowerGrenade_Secondary_C", "IsTrajectoryHidden");

	Params::GA_Athena_TowerGrenade_Secondary_C_IsTrajectoryHidden Parms{};
...
void UGA_Athena_TowerGrenade_Secondary_C::SetupDummyProjectileRed()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("GA_Athena_TowerGrenade_Secondary_C", "SetupDummyProjectileRed");
...
class AFortProjectileTrajectory* UGA_Athena_TowerGrenade_Secondary_C::SpawnTrajectoryIndicator(bool bSpawnOnEquip)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("GA_Athena_TowerGrenade_Secondary_C", "SpawnTrajectoryIndicator");

	Params::GA_Athena_TowerGrenade_Secondary_C_SpawnTrajectoryIndicator Parms{};
