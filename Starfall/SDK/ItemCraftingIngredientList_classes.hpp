...
static_assert(offsetof(UItemCraftingIngredientList_C, IconSize) == 0x000330, "Member 'UItemCraftingIngredientList_C::IconSize' has a wrong offset!");
static_assert(offsetof(UItemCraftingIngredientList_C, Quantity) == 0x000334, "Member 'UItemCraftingIngredientList_C::Quantity' has a wrong offset!");
