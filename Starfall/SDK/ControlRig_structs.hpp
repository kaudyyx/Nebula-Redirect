...
static_assert(offsetof(FRigUnit_Clamp_Float, min_0) == 0x00000C, "Member 'FRigUnit_Clamp_Float::min_0' has a wrong offset!");
static_assert(offsetof(FRigUnit_Clamp_Float, max_0) == 0x000010, "Member 'FRigUnit_Clamp_Float::max_0' has a wrong offset!");
