...
static_assert(sizeof(ItemOnPawnPreview_C_ExecuteUbergraph_ItemOnPawnPreview) == 0x000078, "Wrong size on ItemOnPawnPreview_C_ExecuteUbergraph_ItemOnPawnPreview");
...
static_assert(offsetof(ItemOnPawnPreview_C_ExecuteUbergraph_ItemOnPawnPreview, CallFunc_SpawnEmitterAtLocation_ReturnValue_1) == 0x000030, "Member 'ItemOnPawnPreview_C_ExecuteUbergraph_ItemOnPawnPreview::CallFunc_SpawnEmitterAtLocation_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(ItemOnPawnPreview_C_ExecuteUbergraph_ItemOnPawnPreview, Temp_bool_A_Execution_Happened_Variable) == 0x000038, "Member 'ItemOnPawnPreview_C_ExecuteUbergraph_ItemOnPawnPreview::Temp_bool_A_Execution_Happened_Variable' has a wrong offset!");
