...
static_assert(sizeof(AB_Prj_Bullet_Sniper_C) == 0x000AC8, "Wrong size on AB_Prj_Bullet_Sniper_C");
...
static_assert(offsetof(AB_Prj_Bullet_Sniper_C, WaterImpactFX) == 0x0009F8, "Member 'AB_Prj_Bullet_Sniper_C::WaterImpactFX' has a wrong offset!");
static_assert(offsetof(AB_Prj_Bullet_Sniper_C, WaterHit) == 0x000A00, "Member 'AB_Prj_Bullet_Sniper_C::WaterHit' has a wrong offset!");
static_assert(offsetof(AB_Prj_Bullet_Sniper_C, WaterHitMat) == 0x000A90, "Member 'AB_Prj_Bullet_Sniper_C::WaterHitMat' has a wrong offset!");
static_assert(offsetof(AB_Prj_Bullet_Sniper_C, WaterDepthTrace) == 0x000A98, "Member 'AB_Prj_Bullet_Sniper_C::WaterDepthTrace' has a wrong offset!");
static_assert(offsetof(AB_Prj_Bullet_Sniper_C, WaterIndexTrace) == 0x000A9C, "Member 'AB_Prj_Bullet_Sniper_C::WaterIndexTrace' has a wrong offset!");
static_assert(offsetof(AB_Prj_Bullet_Sniper_C, TraceImpactLocation) == 0x000AA0, "Member 'AB_Prj_Bullet_Sniper_C::TraceImpactLocation' has a wrong offset!");
static_assert(offsetof(AB_Prj_Bullet_Sniper_C, TraceImpactNormal) == 0x000AAC, "Member 'AB_Prj_Bullet_Sniper_C::TraceImpactNormal' has a wrong offset!");
static_assert(offsetof(AB_Prj_Bullet_Sniper_C, Sniper_Rifle_WaterImpactSound) == 0x000AB8, "Member 'AB_Prj_Bullet_Sniper_C::Sniper_Rifle_WaterImpactSound' has a wrong offset!");
static_assert(offsetof(AB_Prj_Bullet_Sniper_C, bHasPlayedWaterSound) == 0x000AC0, "Member 'AB_Prj_Bullet_Sniper_C::bHasPlayedWaterSound' has a wrong offset!");
