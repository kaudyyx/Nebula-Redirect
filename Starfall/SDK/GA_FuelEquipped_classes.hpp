...
static_assert(sizeof(UGA_FuelEquipped_C) == 0x000AB0, "Wrong size on UGA_FuelEquipped_C");
static_assert(offsetof(UGA_FuelEquipped_C, UberGraphFrame) == 0x000AA8, "Member 'UGA_FuelEquipped_C::UberGraphFrame' has a wrong offset!");
