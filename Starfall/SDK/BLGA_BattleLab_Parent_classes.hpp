...
static_assert(offsetof(ABLGA_BattleLab_Parent_C, UberGraphFrame) == 0x0007C8, "Member 'ABLGA_BattleLab_Parent_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ABLGA_BattleLab_Parent_C, FortWaterInteraction) == 0x0007D0, "Member 'ABLGA_BattleLab_Parent_C::FortWaterInteraction' has a wrong offset!");
static_assert(offsetof(ABLGA_BattleLab_Parent_C, FortLinkToActor) == 0x0007D8, "Member 'ABLGA_BattleLab_Parent_C::FortLinkToActor' has a wrong offset!");
static_assert(offsetof(ABLGA_BattleLab_Parent_C, FortHeldObject) == 0x0007E0, "Member 'ABLGA_BattleLab_Parent_C::FortHeldObject' has a wrong offset!");
static_assert(offsetof(ABLGA_BattleLab_Parent_C, FortProjectileMovement) == 0x0007E8, "Member 'ABLGA_BattleLab_Parent_C::FortProjectileMovement' has a wrong offset!");
static_assert(offsetof(ABLGA_BattleLab_Parent_C, Capsule) == 0x0007F0, "Member 'ABLGA_BattleLab_Parent_C::Capsule' has a wrong offset!");
static_assert(offsetof(ABLGA_BattleLab_Parent_C, FortCurie) == 0x0007F8, "Member 'ABLGA_BattleLab_Parent_C::FortCurie' has a wrong offset!");
static_assert(offsetof(ABLGA_BattleLab_Parent_C, RepStartMoving) == 0x000800, "Member 'ABLGA_BattleLab_Parent_C::RepStartMoving' has a wrong offset!");
static_assert(offsetof(ABLGA_BattleLab_Parent_C, GC_HitPlayer) == 0x000804, "Member 'ABLGA_BattleLab_Parent_C::GC_HitPlayer' has a wrong offset!");
static_assert(offsetof(ABLGA_BattleLab_Parent_C, GC_HitWorld) == 0x00080C, "Member 'ABLGA_BattleLab_Parent_C::GC_HitWorld' has a wrong offset!");
static_assert(offsetof(ABLGA_BattleLab_Parent_C, GC_Throw) == 0x000814, "Member 'ABLGA_BattleLab_Parent_C::GC_Throw' has a wrong offset!");
static_assert(offsetof(ABLGA_BattleLab_Parent_C, GC_EnterWater) == 0x00081C, "Member 'ABLGA_BattleLab_Parent_C::GC_EnterWater' has a wrong offset!");
static_assert(offsetof(ABLGA_BattleLab_Parent_C, GC_Pickup) == 0x000824, "Member 'ABLGA_BattleLab_Parent_C::GC_Pickup' has a wrong offset!");
static_assert(offsetof(ABLGA_BattleLab_Parent_C, GC_Death) == 0x00082C, "Member 'ABLGA_BattleLab_Parent_C::GC_Death' has a wrong offset!");
static_assert(offsetof(ABLGA_BattleLab_Parent_C, PlayDeathGC) == 0x000834, "Member 'ABLGA_BattleLab_Parent_C::PlayDeathGC' has a wrong offset!");
static_assert(offsetof(ABLGA_BattleLab_Parent_C, RepHideActor) == 0x000835, "Member 'ABLGA_BattleLab_Parent_C::RepHideActor' has a wrong offset!");
static_assert(offsetof(ABLGA_BattleLab_Parent_C, SetHideActorOnDeath) == 0x000836, "Member 'ABLGA_BattleLab_Parent_C::SetHideActorOnDeath' has a wrong offset!");
static_assert(offsetof(ABLGA_BattleLab_Parent_C, IsDestructable) == 0x000837, "Member 'ABLGA_BattleLab_Parent_C::IsDestructable' has a wrong offset!");
static_assert(offsetof(ABLGA_BattleLab_Parent_C, GC_GenericDeath) == 0x000838, "Member 'ABLGA_BattleLab_Parent_C::GC_GenericDeath' has a wrong offset!");
static_assert(offsetof(ABLGA_BattleLab_Parent_C, WorldStopSlop) == 0x000840, "Member 'ABLGA_BattleLab_Parent_C::WorldStopSlop' has a wrong offset!");
static_assert(offsetof(ABLGA_BattleLab_Parent_C, AttachToWallsAndCeilings) == 0x000844, "Member 'ABLGA_BattleLab_Parent_C::AttachToWallsAndCeilings' has a wrong offset!");
static_assert(offsetof(ABLGA_BattleLab_Parent_C, Map_DirectionToRelativeVector) == 0x000848, "Member 'ABLGA_BattleLab_Parent_C::Map_DirectionToRelativeVector' has a wrong offset!");
static_assert(offsetof(ABLGA_BattleLab_Parent_C, DirectionToAttach) == 0x000898, "Member 'ABLGA_BattleLab_Parent_C::DirectionToAttach' has a wrong offset!");
static_assert(offsetof(ABLGA_BattleLab_Parent_C, EmptyAttachLinkActor) == 0x0008A0, "Member 'ABLGA_BattleLab_Parent_C::EmptyAttachLinkActor' has a wrong offset!");
