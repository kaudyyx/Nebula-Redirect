...
static_assert(sizeof(FArgonSupplyDropPointData) == 0x000228, "Wrong size on FArgonSupplyDropPointData");
...
static_assert(offsetof(FArgonSupplyDropPointData, NumDropsPerSide) == 0x000020, "Member 'FArgonSupplyDropPointData::NumDropsPerSide' has a wrong offset!");
static_assert(offsetof(FArgonSupplyDropPointData, SpaceBetweenDrops) == 0x000040, "Member 'FArgonSupplyDropPointData::SpaceBetweenDrops' has a wrong offset!");
static_assert(offsetof(FArgonSupplyDropPointData, MaxDistanceFromSpawnPointPerpendicularToRace) == 0x000060, "Member 'FArgonSupplyDropPointData::MaxDistanceFromSpawnPointPerpendicularToRace' has a wrong offset!");
static_assert(offsetof(FArgonSupplyDropPointData, MaxDistanceFromSpawnPointParallelToRace) == 0x000080, "Member 'FArgonSupplyDropPointData::MaxDistanceFromSpawnPointParallelToRace' has a wrong offset!");
static_assert(offsetof(FArgonSupplyDropPointData, DistanceFromCenter) == 0x0000A0, "Member 'FArgonSupplyDropPointData::DistanceFromCenter' has a wrong offset!");
static_assert(offsetof(FArgonSupplyDropPointData, MinDropDistanceFromCenter) == 0x0000C0, "Member 'FArgonSupplyDropPointData::MinDropDistanceFromCenter' has a wrong offset!");
static_assert(offsetof(FArgonSupplyDropPointData, MinPercentDistanceFromEnd) == 0x0000E0, "Member 'FArgonSupplyDropPointData::MinPercentDistanceFromEnd' has a wrong offset!");
static_assert(offsetof(FArgonSupplyDropPointData, MaxPercentDistanceFromEnd) == 0x000100, "Member 'FArgonSupplyDropPointData::MaxPercentDistanceFromEnd' has a wrong offset!");
static_assert(offsetof(FArgonSupplyDropPointData, MinTimeUntilSpawn) == 0x000120, "Member 'FArgonSupplyDropPointData::MinTimeUntilSpawn' has a wrong offset!");
static_assert(offsetof(FArgonSupplyDropPointData, MaxTimeUntilSpawn) == 0x000140, "Member 'FArgonSupplyDropPointData::MaxTimeUntilSpawn' has a wrong offset!");
static_assert(offsetof(FArgonSupplyDropPointData, MaxRepopulations) == 0x000160, "Member 'FArgonSupplyDropPointData::MaxRepopulations' has a wrong offset!");
static_assert(offsetof(FArgonSupplyDropPointData, MinRepopulationTime) == 0x000180, "Member 'FArgonSupplyDropPointData::MinRepopulationTime' has a wrong offset!");
static_assert(offsetof(FArgonSupplyDropPointData, MaxRepopulationTime) == 0x0001A0, "Member 'FArgonSupplyDropPointData::MaxRepopulationTime' has a wrong offset!");
...
static_assert(sizeof(FArgonRoute) == 0x000040, "Wrong size on FArgonRoute");
...
static_assert(sizeof(FArgonVehicleOption) == 0x000030, "Wrong size on FArgonVehicleOption");
