...
static_assert(sizeof(UEventPlayerStatProfileSelectorEntry_C) == 0x000C00, "Wrong size on UEventPlayerStatProfileSelectorEntry_C");
...
static_assert(offsetof(UEventPlayerStatProfileSelectorEntry_C, ProfileStatSelector) == 0x000BD8, "Member 'UEventPlayerStatProfileSelectorEntry_C::ProfileStatSelector' has a wrong offset!");
static_assert(offsetof(UEventPlayerStatProfileSelectorEntry_C, Hovered) == 0x000BE0, "Member 'UEventPlayerStatProfileSelectorEntry_C::Hovered' has a wrong offset!");
static_assert(offsetof(UEventPlayerStatProfileSelectorEntry_C, Unhovered) == 0x000BF0, "Member 'UEventPlayerStatProfileSelectorEntry_C::Unhovered' has a wrong offset!");
