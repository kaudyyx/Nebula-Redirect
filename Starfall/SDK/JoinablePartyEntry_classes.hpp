...
static_assert(sizeof(UJoinablePartyEntry_C) == 0x000C98, "Wrong size on UJoinablePartyEntry_C");
...
static_assert(offsetof(UJoinablePartyEntry_C, InviteMaterial) == 0x000C38, "Member 'UJoinablePartyEntry_C::InviteMaterial' has a wrong offset!");
static_assert(offsetof(UJoinablePartyEntry_C, DefaultMaterial) == 0x000C40, "Member 'UJoinablePartyEntry_C::DefaultMaterial' has a wrong offset!");
static_assert(offsetof(UJoinablePartyEntry_C, InviteFontColor) == 0x000C48, "Member 'UJoinablePartyEntry_C::InviteFontColor' has a wrong offset!");
static_assert(offsetof(UJoinablePartyEntry_C, DefaultFontColor) == 0x000C70, "Member 'UJoinablePartyEntry_C::DefaultFontColor' has a wrong offset!");
