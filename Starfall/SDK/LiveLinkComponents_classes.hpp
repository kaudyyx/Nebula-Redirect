...
static_assert(sizeof(ULiveLinkControllerBase) == 0x000030, "Wrong size on ULiveLinkControllerBase");
...
static_assert(sizeof(ULiveLinkCameraController) == 0x000030, "Wrong size on ULiveLinkCameraController");
...
static_assert(sizeof(ULiveLinkLightController) == 0x000030, "Wrong size on ULiveLinkLightController");
...
static_assert(sizeof(ULiveLinkTransformController) == 0x000038, "Wrong size on ULiveLinkTransformController");
static_assert(offsetof(ULiveLinkTransformController, TransformData) == 0x000030, "Member 'ULiveLinkTransformController::TransformData' has a wrong offset!");
