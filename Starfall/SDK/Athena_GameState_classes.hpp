...
static_assert(sizeof(AAthena_GameState_C) == 0x0029F8, "Wrong size on AAthena_GameState_C");
static_assert(offsetof(AAthena_GameState_C, UberGraphFrame) == 0x0029D0, "Member 'AAthena_GameState_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AAthena_GameState_C, DefaultSceneRoot) == 0x0029D8, "Member 'AAthena_GameState_C::DefaultSceneRoot' has a wrong offset!");
static_assert(offsetof(AAthena_GameState_C, Timeline_0_NewTrack_0_21F3C11243B4DF8C6B6A958D51E85950) == 0x0029E0, "Member 'AAthena_GameState_C::Timeline_0_NewTrack_0_21F3C11243B4DF8C6B6A958D51E85950' has a wrong offset!");
static_assert(offsetof(AAthena_GameState_C, Timeline_0__Direction_21F3C11243B4DF8C6B6A958D51E85950) == 0x0029E4, "Member 'AAthena_GameState_C::Timeline_0__Direction_21F3C11243B4DF8C6B6A958D51E85950' has a wrong offset!");
static_assert(offsetof(AAthena_GameState_C, Timeline_0) == 0x0029E8, "Member 'AAthena_GameState_C::Timeline_0' has a wrong offset!");
static_assert(offsetof(AAthena_GameState_C, Victory_Royale_Sound) == 0x0029F0, "Member 'AAthena_GameState_C::Victory_Royale_Sound' has a wrong offset!");
