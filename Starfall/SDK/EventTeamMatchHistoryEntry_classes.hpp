...
static_assert(sizeof(UEventTeamMatchHistoryEntry_C) == 0x000C48, "Wrong size on UEventTeamMatchHistoryEntry_C");
...
static_assert(offsetof(UEventTeamMatchHistoryEntry_C, ProfileStatSelector) == 0x000C20, "Member 'UEventTeamMatchHistoryEntry_C::ProfileStatSelector' has a wrong offset!");
static_assert(offsetof(UEventTeamMatchHistoryEntry_C, Hovered) == 0x000C28, "Member 'UEventTeamMatchHistoryEntry_C::Hovered' has a wrong offset!");
static_assert(offsetof(UEventTeamMatchHistoryEntry_C, Unhovered) == 0x000C38, "Member 'UEventTeamMatchHistoryEntry_C::Unhovered' has a wrong offset!");
