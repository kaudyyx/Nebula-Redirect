...
static_assert(sizeof(UGA_ThrowConsumable_C) == 0x000E28, "Wrong size on UGA_ThrowConsumable_C");
static_assert(offsetof(UGA_ThrowConsumable_C, UberGraphFrame) == 0x000AA8, "Member 'UGA_ThrowConsumable_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGA_ThrowConsumable_C, PlayerPawn) == 0x000AB0, "Member 'UGA_ThrowConsumable_C::PlayerPawn' has a wrong offset!");
static_assert(offsetof(UGA_ThrowConsumable_C, AbilityKeyPressed) == 0x000AB8, "Member 'UGA_ThrowConsumable_C::AbilityKeyPressed' has a wrong offset!");
static_assert(offsetof(UGA_ThrowConsumable_C, InThrowWindup) == 0x000AB9, "Member 'UGA_ThrowConsumable_C::InThrowWindup' has a wrong offset!");
static_assert(offsetof(UGA_ThrowConsumable_C, AdditionalThrowAngle) == 0x000ABC, "Member 'UGA_ThrowConsumable_C::AdditionalThrowAngle' has a wrong offset!");
static_assert(offsetof(UGA_ThrowConsumable_C, MaxTossPitch) == 0x000AC0, "Member 'UGA_ThrowConsumable_C::MaxTossPitch' has a wrong offset!");
static_assert(offsetof(UGA_ThrowConsumable_C, GrenadeTargetingOriginOffset) == 0x000AC4, "Member 'UGA_ThrowConsumable_C::GrenadeTargetingOriginOffset' has a wrong offset!");
static_assert(offsetof(UGA_ThrowConsumable_C, GrenadeTargetingOriginOffset_Crouched) == 0x000AD0, "Member 'UGA_ThrowConsumable_C::GrenadeTargetingOriginOffset_Crouched' has a wrong offset!");
static_assert(offsetof(UGA_ThrowConsumable_C, SpawnedProjectile) == 0x000AE0, "Member 'UGA_ThrowConsumable_C::SpawnedProjectile' has a wrong offset!");
static_assert(offsetof(UGA_ThrowConsumable_C, Proj_ThrownProjectile) == 0x000AE8, "Member 'UGA_ThrowConsumable_C::Proj_ThrownProjectile' has a wrong offset!");
static_assert(offsetof(UGA_ThrowConsumable_C, ProjectileSpeed) == 0x000AF0, "Member 'UGA_ThrowConsumable_C::ProjectileSpeed' has a wrong offset!");
static_assert(offsetof(UGA_ThrowConsumable_C, ProjectileGravityScale) == 0x000B10, "Member 'UGA_ThrowConsumable_C::ProjectileGravityScale' has a wrong offset!");
static_assert(offsetof(UGA_ThrowConsumable_C, TrajectoryUpdateInterval) == 0x000B30, "Member 'UGA_ThrowConsumable_C::TrajectoryUpdateInterval' has a wrong offset!");
static_assert(offsetof(UGA_ThrowConsumable_C, CookMonage) == 0x000B38, "Member 'UGA_ThrowConsumable_C::CookMonage' has a wrong offset!");
static_assert(offsetof(UGA_ThrowConsumable_C, ThrowMontage) == 0x000B40, "Member 'UGA_ThrowConsumable_C::ThrowMontage' has a wrong offset!");
static_assert(offsetof(UGA_ThrowConsumable_C, GC_OnThrow) == 0x000B48, "Member 'UGA_ThrowConsumable_C::GC_OnThrow' has a wrong offset!");
static_assert(offsetof(UGA_ThrowConsumable_C, TrajectoryIndicator) == 0x000B50, "Member 'UGA_ThrowConsumable_C::TrajectoryIndicator' has a wrong offset!");
static_assert(offsetof(UGA_ThrowConsumable_C, TrajectoryIndicatorClass) == 0x000B58, "Member 'UGA_ThrowConsumable_C::TrajectoryIndicatorClass' has a wrong offset!");
static_assert(offsetof(UGA_ThrowConsumable_C, DummyProjectile) == 0x000B60, "Member 'UGA_ThrowConsumable_C::DummyProjectile' has a wrong offset!");
static_assert(offsetof(UGA_ThrowConsumable_C, DummyMaxSpeed) == 0x000B68, "Member 'UGA_ThrowConsumable_C::DummyMaxSpeed' has a wrong offset!");
static_assert(offsetof(UGA_ThrowConsumable_C, DummyGravity) == 0x000B6C, "Member 'UGA_ThrowConsumable_C::DummyGravity' has a wrong offset!");
static_assert(offsetof(UGA_ThrowConsumable_C, DummyExtent) == 0x000B70, "Member 'UGA_ThrowConsumable_C::DummyExtent' has a wrong offset!");
static_assert(offsetof(UGA_ThrowConsumable_C, DummyTimeStep) == 0x000B74, "Member 'UGA_ThrowConsumable_C::DummyTimeStep' has a wrong offset!");
static_assert(offsetof(UGA_ThrowConsumable_C, TrajectoryCollisionProfileName) == 0x000B78, "Member 'UGA_ThrowConsumable_C::TrajectoryCollisionProfileName' has a wrong offset!");
static_assert(offsetof(UGA_ThrowConsumable_C, GE_InWindup) == 0x000B80, "Member 'UGA_ThrowConsumable_C::GE_InWindup' has a wrong offset!");
static_assert(offsetof(UGA_ThrowConsumable_C, GrenadeTargetingOriginOffsetWater) == 0x000B88, "Member 'UGA_ThrowConsumable_C::GrenadeTargetingOriginOffsetWater' has a wrong offset!");
static_assert(offsetof(UGA_ThrowConsumable_C, Handle_GE_InWindup) == 0x000B94, "Member 'UGA_ThrowConsumable_C::Handle_GE_InWindup' has a wrong offset!");
static_assert(offsetof(UGA_ThrowConsumable_C, EC_DefaultExplosion) == 0x000B9C, "Member 'UGA_ThrowConsumable_C::EC_DefaultExplosion' has a wrong offset!");
static_assert(offsetof(UGA_ThrowConsumable_C, ExplosionEffectLevel) == 0x000BA4, "Member 'UGA_ThrowConsumable_C::ExplosionEffectLevel' has a wrong offset!");
static_assert(offsetof(UGA_ThrowConsumable_C, ExplosionEffectContainerSpec) == 0x000BA8, "Member 'UGA_ThrowConsumable_C::ExplosionEffectContainerSpec' has a wrong offset!");
static_assert(offsetof(UGA_ThrowConsumable_C, SpawnedOnEquip) == 0x000C60, "Member 'UGA_ThrowConsumable_C::SpawnedOnEquip' has a wrong offset!");
static_assert(offsetof(UGA_ThrowConsumable_C, EC_DefaultHit) == 0x000C64, "Member 'UGA_ThrowConsumable_C::EC_DefaultHit' has a wrong offset!");
static_assert(offsetof(UGA_ThrowConsumable_C, HitEffectLevel) == 0x000C6C, "Member 'UGA_ThrowConsumable_C::HitEffectLevel' has a wrong offset!");
static_assert(offsetof(UGA_ThrowConsumable_C, HitEffectContainerSpec) == 0x000C70, "Member 'UGA_ThrowConsumable_C::HitEffectContainerSpec' has a wrong offset!");
static_assert(offsetof(UGA_ThrowConsumable_C, OnProjectileSpawn) == 0x000D28, "Member 'UGA_ThrowConsumable_C::OnProjectileSpawn' has a wrong offset!");
static_assert(offsetof(UGA_ThrowConsumable_C, HasAdditionalExplosion) == 0x000D38, "Member 'UGA_ThrowConsumable_C::HasAdditionalExplosion' has a wrong offset!");
static_assert(offsetof(UGA_ThrowConsumable_C, EC_AdditionalExplosion) == 0x000D3C, "Member 'UGA_ThrowConsumable_C::EC_AdditionalExplosion' has a wrong offset!");
static_assert(offsetof(UGA_ThrowConsumable_C, AdditionalExplodeLevel) == 0x000D44, "Member 'UGA_ThrowConsumable_C::AdditionalExplodeLevel' has a wrong offset!");
static_assert(offsetof(UGA_ThrowConsumable_C, AdditionalContainerSpec) == 0x000D48, "Member 'UGA_ThrowConsumable_C::AdditionalContainerSpec' has a wrong offset!");
static_assert(offsetof(UGA_ThrowConsumable_C, QuestCreditTargetTag) == 0x000E00, "Member 'UGA_ThrowConsumable_C::QuestCreditTargetTag' has a wrong offset!");
static_assert(offsetof(UGA_ThrowConsumable_C, DummyMaxSteps) == 0x000E20, "Member 'UGA_ThrowConsumable_C::DummyMaxSteps' has a wrong offset!");
