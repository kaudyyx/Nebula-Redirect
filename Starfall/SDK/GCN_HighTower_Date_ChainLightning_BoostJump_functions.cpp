...
#include "GCN_HighTower_Date_ChainLightning_BoostJump_classes.hpp"
#include "GCN_HighTower_Date_ChainLightning_BoostJump_parameters.hpp"
...
void UGCN_HighTower_Date_ChainLightning_BoostJump_C::OnBurst(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UParticleSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class UMatineeCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	...
	Params::GCN_HighTower_Date_ChainLightning_BoostJump_C_OnBurst Parms{};
