...
static_assert(sizeof(UEntityActorRotationComponent) == 0x000078, "Wrong size on UEntityActorRotationComponent");
...
static_assert(sizeof(UEntityActorScaleComponent) == 0x000078, "Wrong size on UEntityActorScaleComponent");
...
static_assert(sizeof(UEntityActorPositionComponent) == 0x000078, "Wrong size on UEntityActorPositionComponent");
...
static_assert(sizeof(UEntityActorSkeletalMeshRenderComponent) == 0x000078, "Wrong size on UEntityActorSkeletalMeshRenderComponent");
static_assert(offsetof(UEntityActorSkeletalMeshRenderComponent, ShadowVar_SkeletalMesh) == 0x000068, "Member 'UEntityActorSkeletalMeshRenderComponent::ShadowVar_SkeletalMesh' has a wrong offset!");
static_assert(offsetof(UEntityActorSkeletalMeshRenderComponent, ShadowVar_EnableCollision) == 0x000070, "Member 'UEntityActorSkeletalMeshRenderComponent::ShadowVar_EnableCollision' has a wrong offset!");
...
static_assert(sizeof(UEntityActorTextDisplayComponent) == 0x000080, "Wrong size on UEntityActorTextDisplayComponent");
