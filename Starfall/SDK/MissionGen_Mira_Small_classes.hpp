...
static_assert(alignof(UMissionGen_Mira_Small_C) == 0x000008, "Wrong alignment on UMissionGen_Mira_Small_C");
static_assert(sizeof(UMissionGen_Mira_Small_C) == 0x0006C0, "Wrong size on UMissionGen_Mira_Small_C");
