...
static_assert(sizeof(ADA_BoostJumpPack_C) == 0x000DA8, "Wrong size on ADA_BoostJumpPack_C");
static_assert(offsetof(ADA_BoostJumpPack_C, UberGraphFrame) == 0x000D40, "Member 'ADA_BoostJumpPack_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ADA_BoostJumpPack_C, ErrorReason) == 0x000D48, "Member 'ADA_BoostJumpPack_C::ErrorReason' has a wrong offset!");
static_assert(offsetof(ADA_BoostJumpPack_C, ErrorReasonGamepad) == 0x000D68, "Member 'ADA_BoostJumpPack_C::ErrorReasonGamepad' has a wrong offset!");
static_assert(offsetof(ADA_BoostJumpPack_C, ErrorCannotUse) == 0x000D88, "Member 'ADA_BoostJumpPack_C::ErrorCannotUse' has a wrong offset!");
