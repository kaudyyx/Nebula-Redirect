...
static_assert(sizeof(UGAB_AthenaDBNO_C) == 0x000BB8, "Wrong size on UGAB_AthenaDBNO_C");
...
static_assert(offsetof(UGAB_AthenaDBNO_C, HolsterId) == 0x000BA0, "Member 'UGAB_AthenaDBNO_C::HolsterId' has a wrong offset!");
static_assert(offsetof(UGAB_AthenaDBNO_C, DeathMontageSwimming) == 0x000BA8, "Member 'UGAB_AthenaDBNO_C::DeathMontageSwimming' has a wrong offset!");
static_assert(offsetof(UGAB_AthenaDBNO_C, Pawn) == 0x000BB0, "Member 'UGAB_AthenaDBNO_C::Pawn' has a wrong offset!");
