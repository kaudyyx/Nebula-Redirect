...
#include "GCN_HighTower_Tapas_SkyStrike_Explode_classes.hpp"
#include "GCN_HighTower_Tapas_SkyStrike_Explode_parameters.hpp"
...
void UGCN_HighTower_Tapas_SkyStrike_Explode_C::OnBurst(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UParticleSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class UMatineeCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	...
	Params::GCN_HighTower_Tapas_SkyStrike_Explode_C_OnBurst Parms{};
