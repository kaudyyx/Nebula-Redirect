...
static_assert(offsetof(UCircleArrowButton_C, NewVar_0) == 0x000BFC, "Member 'UCircleArrowButton_C::NewVar_0' has a wrong offset!");
static_assert(offsetof(UCircleArrowButton_C, EdgeSoftness) == 0x000C00, "Member 'UCircleArrowButton_C::EdgeSoftness' has a wrong offset!");
static_assert(offsetof(UCircleArrowButton_C, HoverColor) == 0x000C04, "Member 'UCircleArrowButton_C::HoverColor' has a wrong offset!");
static_assert(offsetof(UCircleArrowButton_C, UseShadow) == 0x000C14, "Member 'UCircleArrowButton_C::UseShadow' has a wrong offset!");
static_assert(offsetof(UCircleArrowButton_C, InputActionOnSide) == 0x000C15, "Member 'UCircleArrowButton_C::InputActionOnSide' has a wrong offset!");
