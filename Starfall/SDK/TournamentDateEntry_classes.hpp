...
static_assert(sizeof(UTournamentDateEntry_C) == 0x000718, "Wrong size on UTournamentDateEntry_C");
...
static_assert(offsetof(UTournamentDateEntry_C, Two4HourFormat) == 0x000710, "Member 'UTournamentDateEntry_C::Two4HourFormat' has a wrong offset!");
