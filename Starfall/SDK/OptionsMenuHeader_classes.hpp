...
static_assert(sizeof(UOptionsMenuHeader_C) == 0x000340, "Wrong size on UOptionsMenuHeader_C");
...
static_assert(offsetof(UOptionsMenuHeader_C, Tab_Tooltip_Text) == 0x0002E0, "Member 'UOptionsMenuHeader_C::Tab_Tooltip_Text' has a wrong offset!");
static_assert(offsetof(UOptionsMenuHeader_C, FontMobile) == 0x0002E8, "Member 'UOptionsMenuHeader_C::FontMobile' has a wrong offset!");
static_assert(offsetof(UOptionsMenuHeader_C, FontSizeMobile) == 0x000338, "Member 'UOptionsMenuHeader_C::FontSizeMobile' has a wrong offset!");
