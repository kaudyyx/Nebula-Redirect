...
#include "GCN_HighTower_Date_ChainLightning_ChainBurst_classes.hpp"
#include "GCN_HighTower_Date_ChainLightning_ChainBurst_parameters.hpp"
...
void UGCN_HighTower_Date_ChainLightning_ChainBurst_C::OnBurstGeneric(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UFXSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class UMatineeCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCN_HighTower_Date_ChainLightning_ChainBurst_C", "OnBurstGeneric");

	Params::GCN_HighTower_Date_ChainLightning_ChainBurst_C_OnBurstGeneric Parms{};
