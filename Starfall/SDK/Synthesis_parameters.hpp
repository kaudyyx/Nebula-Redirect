...
static_assert(sizeof(SourceEffectChorusPreset_SetDepthModulator) == 0x000010, "Wrong size on SourceEffectChorusPreset_SetDepthModulator");
static_assert(offsetof(SourceEffectChorusPreset_SetDepthModulator, InModulatorSettings) == 0x000000, "Member 'SourceEffectChorusPreset_SetDepthModulator::InModulatorSettings' has a wrong offset!");
...
static_assert(sizeof(SourceEffectChorusPreset_SetDryModulator) == 0x000010, "Wrong size on SourceEffectChorusPreset_SetDryModulator");
static_assert(offsetof(SourceEffectChorusPreset_SetDryModulator, InModulatorSettings) == 0x000000, "Member 'SourceEffectChorusPreset_SetDryModulator::InModulatorSettings' has a wrong offset!");
...
static_assert(sizeof(SourceEffectChorusPreset_SetFeedbackModulator) == 0x000010, "Wrong size on SourceEffectChorusPreset_SetFeedbackModulator");
static_assert(offsetof(SourceEffectChorusPreset_SetFeedbackModulator, InModulatorSettings) == 0x000000, "Member 'SourceEffectChorusPreset_SetFeedbackModulator::InModulatorSettings' has a wrong offset!");
...
static_assert(sizeof(SourceEffectChorusPreset_SetFrequencyModulator) == 0x000010, "Wrong size on SourceEffectChorusPreset_SetFrequencyModulator");
static_assert(offsetof(SourceEffectChorusPreset_SetFrequencyModulator, InModulatorSettings) == 0x000000, "Member 'SourceEffectChorusPreset_SetFrequencyModulator::InModulatorSettings' has a wrong offset!");
...
static_assert(alignof(SourceEffectChorusPreset_SetSettings) == 0x000008, "Wrong alignment on SourceEffectChorusPreset_SetSettings");
static_assert(sizeof(SourceEffectChorusPreset_SetSettings) == 0x000090, "Wrong size on SourceEffectChorusPreset_SetSettings");
...
static_assert(sizeof(SourceEffectChorusPreset_SetSpreadModulator) == 0x000010, "Wrong size on SourceEffectChorusPreset_SetSpreadModulator");
static_assert(offsetof(SourceEffectChorusPreset_SetSpreadModulator, InModulatorSettings) == 0x000000, "Member 'SourceEffectChorusPreset_SetSpreadModulator::InModulatorSettings' has a wrong offset!");
...
static_assert(sizeof(SourceEffectChorusPreset_SetWetModulator) == 0x000010, "Wrong size on SourceEffectChorusPreset_SetWetModulator");
static_assert(offsetof(SourceEffectChorusPreset_SetWetModulator, InModulatorSettings) == 0x000000, "Member 'SourceEffectChorusPreset_SetWetModulator::InModulatorSettings' has a wrong offset!");
...
static_assert(sizeof(SourceEffectBitCrusherPreset_SetBitModulator) == 0x000010, "Wrong size on SourceEffectBitCrusherPreset_SetBitModulator");
static_assert(offsetof(SourceEffectBitCrusherPreset_SetBitModulator, InModulatorSettings) == 0x000000, "Member 'SourceEffectBitCrusherPreset_SetBitModulator::InModulatorSettings' has a wrong offset!");
...
static_assert(sizeof(SourceEffectBitCrusherPreset_SetSampleRateModulator) == 0x000010, "Wrong size on SourceEffectBitCrusherPreset_SetSampleRateModulator");
static_assert(offsetof(SourceEffectBitCrusherPreset_SetSampleRateModulator, InModulatorSettings) == 0x000000, "Member 'SourceEffectBitCrusherPreset_SetSampleRateModulator::InModulatorSettings' has a wrong offset!");
...
static_assert(alignof(SourceEffectBitCrusherPreset_SetSettings) == 0x000008, "Wrong alignment on SourceEffectBitCrusherPreset_SetSettings");
static_assert(sizeof(SourceEffectBitCrusherPreset_SetSettings) == 0x000020, "Wrong size on SourceEffectBitCrusherPreset_SetSettings");
