...
static_assert(sizeof(AGCNL_Athena_AppleSun_Bounced_C) == 0x0007D8, "Wrong size on AGCNL_Athena_AppleSun_Bounced_C");
static_assert(offsetof(AGCNL_Athena_AppleSun_Bounced_C, UberGraphFrame) == 0x0007C0, "Member 'AGCNL_Athena_AppleSun_Bounced_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AGCNL_Athena_AppleSun_Bounced_C, InUseLoopAudio) == 0x0007C8, "Member 'AGCNL_Athena_AppleSun_Bounced_C::InUseLoopAudio' has a wrong offset!");
static_assert(offsetof(AGCNL_Athena_AppleSun_Bounced_C, Target) == 0x0007D0, "Member 'AGCNL_Athena_AppleSun_Bounced_C::Target' has a wrong offset!");
