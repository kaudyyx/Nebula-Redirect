...
static_assert(sizeof(UGA_DefaultPlayer_Death_C) == 0x000C58, "Wrong size on UGA_DefaultPlayer_Death_C");
...
static_assert(offsetof(UGA_DefaultPlayer_Death_C, FadeCapsuleStWCue) == 0x000C48, "Member 'UGA_DefaultPlayer_Death_C::FadeCapsuleStWCue' has a wrong offset!");
static_assert(offsetof(UGA_DefaultPlayer_Death_C, FadeCapsuleAthenaCue) == 0x000C50, "Member 'UGA_DefaultPlayer_Death_C::FadeCapsuleAthenaCue' has a wrong offset!");
