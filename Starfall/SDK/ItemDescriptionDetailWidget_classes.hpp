...
static_assert(offsetof(UItemDescriptionDetailWidget_C, InCollectionBook) == 0x0002F9, "Member 'UItemDescriptionDetailWidget_C::InCollectionBook' has a wrong offset!");
