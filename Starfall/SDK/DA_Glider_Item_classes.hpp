...
static_assert(sizeof(ADA_Glider_Item_C) == 0x000DA8, "Wrong size on ADA_Glider_Item_C");
static_assert(offsetof(ADA_Glider_Item_C, UberGraphFrame) == 0x000D40, "Member 'ADA_Glider_Item_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ADA_Glider_Item_C, ErrorReason) == 0x000D48, "Member 'ADA_Glider_Item_C::ErrorReason' has a wrong offset!");
static_assert(offsetof(ADA_Glider_Item_C, ErrorReasonGamepad) == 0x000D68, "Member 'ADA_Glider_Item_C::ErrorReasonGamepad' has a wrong offset!");
static_assert(offsetof(ADA_Glider_Item_C, ErrorCannotUse) == 0x000D88, "Member 'ADA_Glider_Item_C::ErrorCannotUse' has a wrong offset!");
