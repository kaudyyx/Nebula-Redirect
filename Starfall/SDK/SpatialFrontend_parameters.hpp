...
static_assert(sizeof(SpatialFrontend_C_ExecuteUbergraph_SpatialFrontend) == 0x000060, "Wrong size on SpatialFrontend_C_ExecuteUbergraph_SpatialFrontend");
...
static_assert(offsetof(SpatialFrontend_C_ExecuteUbergraph_SpatialFrontend, K2Node_DynamicCast_AsBPS12Main_Room_POITag) == 0x000008, "Member 'SpatialFrontend_C_ExecuteUbergraph_SpatialFrontend::K2Node_DynamicCast_AsBPS12Main_Room_POITag' has a wrong offset!");
static_assert(offsetof(SpatialFrontend_C_ExecuteUbergraph_SpatialFrontend, K2Node_DynamicCast_bSuccess) == 0x000010, "Member 'SpatialFrontend_C_ExecuteUbergraph_SpatialFrontend::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(SpatialFrontend_C_ExecuteUbergraph_SpatialFrontend, K2Node_Event_TargetCamera) == 0x000014, "Member 'SpatialFrontend_C_ExecuteUbergraph_SpatialFrontend::K2Node_Event_TargetCamera' has a wrong offset!");
static_assert(offsetof(SpatialFrontend_C_ExecuteUbergraph_SpatialFrontend, K2Node_Event_TargetNavActor) == 0x000020, "Member 'SpatialFrontend_C_ExecuteUbergraph_SpatialFrontend::K2Node_Event_TargetNavActor' has a wrong offset!");
...
static_assert(offsetof(SpatialFrontend_C_ExecuteUbergraph_SpatialFrontend, CallFunc_IsValid_ReturnValue) == 0x000038, "Member 'SpatialFrontend_C_ExecuteUbergraph_SpatialFrontend::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(SpatialFrontend_C_ExecuteUbergraph_SpatialFrontend, CallFunc_Len_ReturnValue) == 0x00003C, "Member 'SpatialFrontend_C_ExecuteUbergraph_SpatialFrontend::CallFunc_Len_ReturnValue' has a wrong offset!");
static_assert(offsetof(SpatialFrontend_C_ExecuteUbergraph_SpatialFrontend, CallFunc_Conv_StringToText_ReturnValue) == 0x000040, "Member 'SpatialFrontend_C_ExecuteUbergraph_SpatialFrontend::CallFunc_Conv_StringToText_ReturnValue' has a wrong offset!");
static_assert(offsetof(SpatialFrontend_C_ExecuteUbergraph_SpatialFrontend, CallFunc_Greater_IntInt_ReturnValue) == 0x000058, "Member 'SpatialFrontend_C_ExecuteUbergraph_SpatialFrontend::CallFunc_Greater_IntInt_ReturnValue' has a wrong offset!");
