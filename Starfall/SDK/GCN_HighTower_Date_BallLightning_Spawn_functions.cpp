...
#include "GCN_HighTower_Date_BallLightning_Spawn_classes.hpp"
#include "GCN_HighTower_Date_BallLightning_Spawn_parameters.hpp"
...
void UGCN_HighTower_Date_BallLightning_Spawn_C::OnBurstGeneric(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UFXSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class UMatineeCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	...
	Params::GCN_HighTower_Date_BallLightning_Spawn_C_OnBurstGeneric Parms{};
