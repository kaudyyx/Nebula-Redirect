...
static_assert(sizeof(UGA_Athena_HookDestroy_C) == 0x000B60, "Wrong size on UGA_Athena_HookDestroy_C");
static_assert(offsetof(UGA_Athena_HookDestroy_C, UberGraphFrame) == 0x000AA8, "Member 'UGA_Athena_HookDestroy_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGA_Athena_HookDestroy_C, PlayerPawn) == 0x000AB0, "Member 'UGA_Athena_HookDestroy_C::PlayerPawn' has a wrong offset!");
static_assert(offsetof(UGA_Athena_HookDestroy_C, SwitchLockGE) == 0x000AB8, "Member 'UGA_Athena_HookDestroy_C::SwitchLockGE' has a wrong offset!");
static_assert(offsetof(UGA_Athena_HookDestroy_C, Hit_) == 0x000AC0, "Member 'UGA_Athena_HookDestroy_C::Hit_' has a wrong offset!");
static_assert(offsetof(UGA_Athena_HookDestroy_C, CleanedAngle) == 0x000AC4, "Member 'UGA_Athena_HookDestroy_C::CleanedAngle' has a wrong offset!");
static_assert(offsetof(UGA_Athena_HookDestroy_C, LaunchAngleVariations) == 0x000AC8, "Member 'UGA_Athena_HookDestroy_C::LaunchAngleVariations' has a wrong offset!");
static_assert(offsetof(UGA_Athena_HookDestroy_C, TravelMontage) == 0x000AD8, "Member 'UGA_Athena_HookDestroy_C::TravelMontage' has a wrong offset!");
static_assert(offsetof(UGA_Athena_HookDestroy_C, Debug) == 0x000AE0, "Member 'UGA_Athena_HookDestroy_C::Debug' has a wrong offset!");
static_assert(offsetof(UGA_Athena_HookDestroy_C, WeaponActor) == 0x000AE8, "Member 'UGA_Athena_HookDestroy_C::WeaponActor' has a wrong offset!");
static_assert(offsetof(UGA_Athena_HookDestroy_C, ChangeEquipmentTag) == 0x000AF0, "Member 'UGA_Athena_HookDestroy_C::ChangeEquipmentTag' has a wrong offset!");
static_assert(offsetof(UGA_Athena_HookDestroy_C, RopeActiveTag) == 0x000B10, "Member 'UGA_Athena_HookDestroy_C::RopeActiveTag' has a wrong offset!");
static_assert(offsetof(UGA_Athena_HookDestroy_C, NullMontage) == 0x000B18, "Member 'UGA_Athena_HookDestroy_C::NullMontage' has a wrong offset!");
static_assert(offsetof(UGA_Athena_HookDestroy_C, GliderGrappler) == 0x000B20, "Member 'UGA_Athena_HookDestroy_C::GliderGrappler' has a wrong offset!");
static_assert(offsetof(UGA_Athena_HookDestroy_C, BadgerGrapeDelayFailsafe) == 0x000B24, "Member 'UGA_Athena_HookDestroy_C::BadgerGrapeDelayFailsafe' has a wrong offset!");
static_assert(offsetof(UGA_Athena_HookDestroy_C, DestroyEvent) == 0x000B28, "Member 'UGA_Athena_HookDestroy_C::DestroyEvent' has a wrong offset!");
static_assert(offsetof(UGA_Athena_HookDestroy_C, Event_GrapplerHit) == 0x000B30, "Member 'UGA_Athena_HookDestroy_C::Event_GrapplerHit' has a wrong offset!");
static_assert(offsetof(UGA_Athena_HookDestroy_C, Event_GrapplerReturn) == 0x000B38, "Member 'UGA_Athena_HookDestroy_C::Event_GrapplerReturn' has a wrong offset!");
static_assert(offsetof(UGA_Athena_HookDestroy_C, T_HoverboardMontage) == 0x000B40, "Member 'UGA_Athena_HookDestroy_C::T_HoverboardMontage' has a wrong offset!");
