...
static_assert(sizeof(FortDagwoodVehicle_GetCurrentRuntimeProperties) == 0x000048, "Wrong size on FortDagwoodVehicle_GetCurrentRuntimeProperties");
...
static_assert(alignof(FortDagwoodVehicle_ServerSetRuntimeProperties) == 0x000008, "Wrong alignment on FortDagwoodVehicle_ServerSetRuntimeProperties");
static_assert(sizeof(FortDagwoodVehicle_ServerSetRuntimeProperties) == 0x000048, "Wrong size on FortDagwoodVehicle_ServerSetRuntimeProperties");
static_assert(offsetof(FortDagwoodVehicle_ServerSetRuntimeProperties, RunTimeProps) == 0x000000, "Member 'FortDagwoodVehicle_ServerSetRuntimeProperties::RunTimeProps' has a wrong offset!");
...
static_assert(sizeof(FortDagwoodVehicle_ServerSetRuntimeSpringsInfo) == 0x00000C, "Wrong size on FortDagwoodVehicle_ServerSetRuntimeSpringsInfo");
