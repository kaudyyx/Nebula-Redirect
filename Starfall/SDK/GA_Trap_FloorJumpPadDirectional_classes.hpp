...
static_assert(sizeof(UGA_Trap_FloorJumpPadDirectional_C) == 0x000B28, "Wrong size on UGA_Trap_FloorJumpPadDirectional_C");
...
static_assert(offsetof(UGA_Trap_FloorJumpPadDirectional_C, TC_LaunchTag) == 0x000AE8, "Member 'UGA_Trap_FloorJumpPadDirectional_C::TC_LaunchTag' has a wrong offset!");
static_assert(offsetof(UGA_Trap_FloorJumpPadDirectional_C, OverlappingTargets) == 0x000AF0, "Member 'UGA_Trap_FloorJumpPadDirectional_C::OverlappingTargets' has a wrong offset!");
static_assert(offsetof(UGA_Trap_FloorJumpPadDirectional_C, TargetData) == 0x000B00, "Member 'UGA_Trap_FloorJumpPadDirectional_C::TargetData' has a wrong offset!");
