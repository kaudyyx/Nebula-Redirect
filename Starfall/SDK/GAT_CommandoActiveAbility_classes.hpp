...
static_assert(sizeof(UGAT_CommandoActiveAbility_C) == 0x000BB0, "Wrong size on UGAT_CommandoActiveAbility_C");
static_assert(offsetof(UGAT_CommandoActiveAbility_C, UberGraphFrame_GAT_CommandoActiveAbility_C) == 0x000AE8, "Member 'UGAT_CommandoActiveAbility_C::UberGraphFrame_GAT_CommandoActiveAbility_C' has a wrong offset!");
static_assert(offsetof(UGAT_CommandoActiveAbility_C, Event_Data) == 0x000AF0, "Member 'UGAT_CommandoActiveAbility_C::Event_Data' has a wrong offset!");
static_assert(offsetof(UGAT_CommandoActiveAbility_C, CommandoPlayerPawn) == 0x000BA0, "Member 'UGAT_CommandoActiveAbility_C::CommandoPlayerPawn' has a wrong offset!");
static_assert(offsetof(UGAT_CommandoActiveAbility_C, isAutoCommitted) == 0x000BA8, "Member 'UGAT_CommandoActiveAbility_C::isAutoCommitted' has a wrong offset!");
static_assert(offsetof(UGAT_CommandoActiveAbility_C, isStaminaLockedOut) == 0x000BA9, "Member 'UGAT_CommandoActiveAbility_C::isStaminaLockedOut' has a wrong offset!");
