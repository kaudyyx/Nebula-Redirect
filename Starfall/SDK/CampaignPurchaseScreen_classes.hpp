...
static_assert(offsetof(UCampaignPurchaseScreen_C, WasLastPlayForward) == 0x0003B8, "Member 'UCampaignPurchaseScreen_C::WasLastPlayForward' has a wrong offset!");
static_assert(offsetof(UCampaignPurchaseScreen_C, LeavingMatchmakingDialog) == 0x0003C0, "Member 'UCampaignPurchaseScreen_C::LeavingMatchmakingDialog' has a wrong offset!");
