...
static_assert(offsetof(UOceanCollisionComponent, CachedBodySetup) == 0x000440, "Member 'UOceanCollisionComponent::CachedBodySetup' has a wrong offset!");
...
static_assert(sizeof(UBuoyancyComponent) == 0x0001A8, "Wrong size on UBuoyancyComponent");
...
static_assert(offsetof(ULakeCollisionComponent, CachedBodySetup) == 0x000440, "Member 'ULakeCollisionComponent::CachedBodySetup' has a wrong offset!");
static_assert(offsetof(ULakeCollisionComponent, BoxExtent) == 0x000448, "Member 'ULakeCollisionComponent::BoxExtent' has a wrong offset!");
...
static_assert(sizeof(UWaterMeshComponent) == 0x000570, "Wrong size on UWaterMeshComponent");
static_assert(offsetof(UWaterMeshComponent, ForceCollapseDensityLevel) == 0x000468, "Member 'UWaterMeshComponent::ForceCollapseDensityLevel' has a wrong offset!");
static_assert(offsetof(UWaterMeshComponent, TileSize) == 0x00046C, "Member 'UWaterMeshComponent::TileSize' has a wrong offset!");
static_assert(offsetof(UWaterMeshComponent, ExtentInTiles) == 0x000470, "Member 'UWaterMeshComponent::ExtentInTiles' has a wrong offset!");
static_assert(offsetof(UWaterMeshComponent, FarDistanceMaterial) == 0x000478, "Member 'UWaterMeshComponent::FarDistanceMaterial' has a wrong offset!");
static_assert(offsetof(UWaterMeshComponent, FarDistanceMeshExtent) == 0x000480, "Member 'UWaterMeshComponent::FarDistanceMeshExtent' has a wrong offset!");
static_assert(offsetof(UWaterMeshComponent, TessellationFactor) == 0x000568, "Member 'UWaterMeshComponent::TessellationFactor' has a wrong offset!");
static_assert(offsetof(UWaterMeshComponent, LODScale) == 0x00056C, "Member 'UWaterMeshComponent::LODScale' has a wrong offset!");
...
static_assert(offsetof(UWaterSplineComponent, WaterSplineDefaults) == 0x000530, "Member 'UWaterSplineComponent::WaterSplineDefaults' has a wrong offset!");
static_assert(offsetof(UWaterSplineComponent, PreviousWaterSplineDefaults) == 0x000544, "Member 'UWaterSplineComponent::PreviousWaterSplineDefaults' has a wrong offset!");
