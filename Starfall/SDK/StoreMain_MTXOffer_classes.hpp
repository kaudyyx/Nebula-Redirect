...
static_assert(sizeof(UStoreMain_MTXOffer_C) == 0x000D60, "Wrong size on UStoreMain_MTXOffer_C");
...
static_assert(offsetof(UStoreMain_MTXOffer_C, Plus) == 0x000CD8, "Member 'UStoreMain_MTXOffer_C::Plus' has a wrong offset!");
static_assert(offsetof(UStoreMain_MTXOffer_C, RMTBundle) == 0x000CE0, "Member 'UStoreMain_MTXOffer_C::RMTBundle' has a wrong offset!");
static_assert(offsetof(UStoreMain_MTXOffer_C, RMTCurrency) == 0x000CE8, "Member 'UStoreMain_MTXOffer_C::RMTCurrency' has a wrong offset!");
static_assert(offsetof(UStoreMain_MTXOffer_C, RMTTypeSwitcher) == 0x000CF0, "Member 'UStoreMain_MTXOffer_C::RMTTypeSwitcher' has a wrong offset!");
static_assert(offsetof(UStoreMain_MTXOffer_C, RMTVBucksHB) == 0x000CF8, "Member 'UStoreMain_MTXOffer_C::RMTVBucksHB' has a wrong offset!");
static_assert(offsetof(UStoreMain_MTXOffer_C, ScaleBoxKeyArt) == 0x000D00, "Member 'UStoreMain_MTXOffer_C::ScaleBoxKeyArt' has a wrong offset!");
static_assert(offsetof(UStoreMain_MTXOffer_C, Switcher_Price) == 0x000D08, "Member 'UStoreMain_MTXOffer_C::Switcher_Price' has a wrong offset!");
static_assert(offsetof(UStoreMain_MTXOffer_C, TextOfferDisplayPrice) == 0x000D10, "Member 'UStoreMain_MTXOffer_C::TextOfferDisplayPrice' has a wrong offset!");
static_assert(offsetof(UStoreMain_MTXOffer_C, TextOfferName) == 0x000D18, "Member 'UStoreMain_MTXOffer_C::TextOfferName' has a wrong offset!");
static_assert(offsetof(UStoreMain_MTXOffer_C, TextOfferPurchaseUnvailable) == 0x000D20, "Member 'UStoreMain_MTXOffer_C::TextOfferPurchaseUnvailable' has a wrong offset!");
static_assert(offsetof(UStoreMain_MTXOffer_C, TextOriginalPrice) == 0x000D28, "Member 'UStoreMain_MTXOffer_C::TextOriginalPrice' has a wrong offset!");
static_assert(offsetof(UStoreMain_MTXOffer_C, TileSize) == 0x000D30, "Member 'UStoreMain_MTXOffer_C::TileSize' has a wrong offset!");
static_assert(offsetof(UStoreMain_MTXOffer_C, VBucksText) == 0x000D38, "Member 'UStoreMain_MTXOffer_C::VBucksText' has a wrong offset!");
static_assert(offsetof(UStoreMain_MTXOffer_C, AboutToShowDetails) == 0x000D40, "Member 'UStoreMain_MTXOffer_C::AboutToShowDetails' has a wrong offset!");
static_assert(offsetof(UStoreMain_MTXOffer_C, bCanSetPrice) == 0x000D50, "Member 'UStoreMain_MTXOffer_C::bCanSetPrice' has a wrong offset!");
static_assert(offsetof(UStoreMain_MTXOffer_C, CatalogMessaging) == 0x000D58, "Member 'UStoreMain_MTXOffer_C::CatalogMessaging' has a wrong offset!");
