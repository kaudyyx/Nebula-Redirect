...
static_assert(sizeof(ADA_SpookyMist_C) == 0x000D80, "Wrong size on ADA_SpookyMist_C");
static_assert(offsetof(ADA_SpookyMist_C, UberGraphFrame) == 0x000D40, "Member 'ADA_SpookyMist_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ADA_SpookyMist_C, CanCancelAbility) == 0x000D48, "Member 'ADA_SpookyMist_C::CanCancelAbility' has a wrong offset!");
static_assert(offsetof(ADA_SpookyMist_C, CanCancelTimer) == 0x000D50, "Member 'ADA_SpookyMist_C::CanCancelTimer' has a wrong offset!");
static_assert(offsetof(ADA_SpookyMist_C, CancelDelay) == 0x000D58, "Member 'ADA_SpookyMist_C::CancelDelay' has a wrong offset!");
static_assert(offsetof(ADA_SpookyMist_C, PlayerPawn) == 0x000D78, "Member 'ADA_SpookyMist_C::PlayerPawn' has a wrong offset!");
