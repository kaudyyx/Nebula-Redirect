...
static_assert(offsetof(UGA_DanceGrenade_Stun_C, UberGraphFrame) == 0x000AA8, "Member 'UGA_DanceGrenade_Stun_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGA_DanceGrenade_Stun_C, AnimMontage) == 0x000AB0, "Member 'UGA_DanceGrenade_Stun_C::AnimMontage' has a wrong offset!");
static_assert(offsetof(UGA_DanceGrenade_Stun_C, ShouldUseSharedAnim) == 0x000AB8, "Member 'UGA_DanceGrenade_Stun_C::ShouldUseSharedAnim' has a wrong offset!");
static_assert(offsetof(UGA_DanceGrenade_Stun_C, DanceGrenadeHolsterId) == 0x000ABC, "Member 'UGA_DanceGrenade_Stun_C::DanceGrenadeHolsterId' has a wrong offset!");
static_assert(offsetof(UGA_DanceGrenade_Stun_C, IsSkydiving) == 0x000AC4, "Member 'UGA_DanceGrenade_Stun_C::IsSkydiving' has a wrong offset!");
