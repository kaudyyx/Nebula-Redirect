...
static_assert(sizeof(UAthenaLobby_C) == 0x000640, "Wrong size on UAthenaLobby_C");
...
static_assert(offsetof(UAthenaLobby_C, StoreToastRequest) == 0x000620, "Member 'UAthenaLobby_C::StoreToastRequest' has a wrong offset!");
static_assert(offsetof(UAthenaLobby_C, TryShowToast) == 0x000628, "Member 'UAthenaLobby_C::TryShowToast' has a wrong offset!");
static_assert(offsetof(UAthenaLobby_C, InputAction_InspectChallenges) == 0x000630, "Member 'UAthenaLobby_C::InputAction_InspectChallenges' has a wrong offset!");
