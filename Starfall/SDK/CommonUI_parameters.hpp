...
static_assert(alignof(CommonButton_SetIsFocusable) == 0x000001, "Wrong alignment on CommonButton_SetIsFocusable");
static_assert(sizeof(CommonButton_SetIsFocusable) == 0x000001, "Wrong size on CommonButton_SetIsFocusable");
static_assert(offsetof(CommonButton_SetIsFocusable, bInIsFocusable) == 0x000000, "Member 'CommonButton_SetIsFocusable::bInIsFocusable' has a wrong offset!");
...
static_assert(alignof(CommonButton_GetIsFocusable) == 0x000001, "Wrong alignment on CommonButton_GetIsFocusable");
static_assert(sizeof(CommonButton_GetIsFocusable) == 0x000001, "Wrong size on CommonButton_GetIsFocusable");
static_assert(offsetof(CommonButton_GetIsFocusable, ReturnValue) == 0x000000, "Member 'CommonButton_GetIsFocusable::ReturnValue' has a wrong offset!");
