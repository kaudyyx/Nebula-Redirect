...
static_assert(offsetof(URichTextBlock, DefaultTextStyle) == 0x0003D0, "Member 'URichTextBlock::DefaultTextStyle' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_504[0x14];                                     // 0x0504(0x0014)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_3EF[0x1];                                      // 0x03EF(0x0001)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UWidgetInteractionComponent, LocalHitLocation) == 0x000344, "Member 'UWidgetInteractionComponent::LocalHitLocation' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, LastLocalHitLocation) == 0x00034C, "Member 'UWidgetInteractionComponent::LastLocalHitLocation' has a wrong offset!");
...
static_assert(offsetof(UWidgetInteractionComponent, bIsHoveredWidgetInteractable) == 0x0003EC, "Member 'UWidgetInteractionComponent::bIsHoveredWidgetInteractable' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, bIsHoveredWidgetFocusable) == 0x0003ED, "Member 'UWidgetInteractionComponent::bIsHoveredWidgetFocusable' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, bIsHoveredWidgetHitTestVisible) == 0x0003EE, "Member 'UWidgetInteractionComponent::bIsHoveredWidgetHitTestVisible' has a wrong offset!");
