...
static_assert(sizeof(GAB_InterrogatePlayer_Reveal_C_Reveal) == 0x000BF8, "Wrong size on GAB_InterrogatePlayer_Reveal_C_Reveal");
...
static_assert(offsetof(GAB_InterrogatePlayer_Reveal_C_Reveal, CallFunc_SendComplexCustomStatEvent_QuestActive_1) == 0x0008FA, "Member 'GAB_InterrogatePlayer_Reveal_C_Reveal::CallFunc_SendComplexCustomStatEvent_QuestActive_1' has a wrong offset!");
static_assert(offsetof(GAB_InterrogatePlayer_Reveal_C_Reveal, CallFunc_SendComplexCustomStatEvent_QuestCompleted_1) == 0x0008FB, "Member 'GAB_InterrogatePlayer_Reveal_C_Reveal::CallFunc_SendComplexCustomStatEvent_QuestCompleted_1' has a wrong offset!");
static_assert(offsetof(GAB_InterrogatePlayer_Reveal_C_Reveal, CallFunc_IsValid_ReturnValue) == 0x0008FC, "Member 'GAB_InterrogatePlayer_Reveal_C_Reveal::CallFunc_IsValid_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(GAB_InterrogatePlayer_Reveal_C_Reveal, K2Node_MakeArray_Array_3) == 0x000B60, "Member 'GAB_InterrogatePlayer_Reveal_C_Reveal::K2Node_MakeArray_Array_3' has a wrong offset!");
static_assert(offsetof(GAB_InterrogatePlayer_Reveal_C_Reveal, K2Node_DynamicCast_AsFort_Player_State_Athena_1) == 0x000B70, "Member 'GAB_InterrogatePlayer_Reveal_C_Reveal::K2Node_DynamicCast_AsFort_Player_State_Athena_1' has a wrong offset!");
static_assert(offsetof(GAB_InterrogatePlayer_Reveal_C_Reveal, K2Node_DynamicCast_bSuccess_3) == 0x000B78, "Member 'GAB_InterrogatePlayer_Reveal_C_Reveal::K2Node_DynamicCast_bSuccess_3' has a wrong offset!");
...
static_assert(offsetof(GAB_InterrogatePlayer_Reveal_C_Reveal, CallFunc_IsValid_ReturnValue_1) == 0x000B90, "Member 'GAB_InterrogatePlayer_Reveal_C_Reveal::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(GAB_InterrogatePlayer_Reveal_C_Reveal, CallFunc_Array_Get_Item_1) == 0x000B98, "Member 'GAB_InterrogatePlayer_Reveal_C_Reveal::CallFunc_Array_Get_Item_1' has a wrong offset!");
static_assert(offsetof(GAB_InterrogatePlayer_Reveal_C_Reveal, CallFunc_IsValid_ReturnValue_2) == 0x000BA0, "Member 'GAB_InterrogatePlayer_Reveal_C_Reveal::CallFunc_IsValid_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(GAB_InterrogatePlayer_Reveal_C_Reveal, CallFunc_GetPlayerPawnOrVehicleDriver_ReturnValue) == 0x000BA8, "Member 'GAB_InterrogatePlayer_Reveal_C_Reveal::CallFunc_GetPlayerPawnOrVehicleDriver_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(GAB_InterrogatePlayer_Reveal_C_Reveal, CallFunc_HasAnyMatchingGameplayTags_ReturnValue) == 0x000BC8, "Member 'GAB_InterrogatePlayer_Reveal_C_Reveal::CallFunc_HasAnyMatchingGameplayTags_ReturnValue' has a wrong offset!");
static_assert(offsetof(GAB_InterrogatePlayer_Reveal_C_Reveal, CallFunc_Array_Length_ReturnValue_1) == 0x000BCC, "Member 'GAB_InterrogatePlayer_Reveal_C_Reveal::CallFunc_Array_Length_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(GAB_InterrogatePlayer_Reveal_C_Reveal, CallFunc_Less_IntInt_ReturnValue_1) == 0x000BD0, "Member 'GAB_InterrogatePlayer_Reveal_C_Reveal::CallFunc_Less_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(GAB_InterrogatePlayer_Reveal_C_Reveal, CallFunc_Array_Length_ReturnValue_2) == 0x000BD4, "Member 'GAB_InterrogatePlayer_Reveal_C_Reveal::CallFunc_Array_Length_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(GAB_InterrogatePlayer_Reveal_C_Reveal, CallFunc_Greater_IntInt_ReturnValue) == 0x000BD8, "Member 'GAB_InterrogatePlayer_Reveal_C_Reveal::CallFunc_Greater_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(GAB_InterrogatePlayer_Reveal_C_Reveal, CallFunc_HasMatchingGameplayTag_self_CastInput) == 0x000BE0, "Member 'GAB_InterrogatePlayer_Reveal_C_Reveal::CallFunc_HasMatchingGameplayTag_self_CastInput' has a wrong offset!");
static_assert(offsetof(GAB_InterrogatePlayer_Reveal_C_Reveal, CallFunc_HasMatchingGameplayTag_ReturnValue) == 0x000BF0, "Member 'GAB_InterrogatePlayer_Reveal_C_Reveal::CallFunc_HasMatchingGameplayTag_ReturnValue' has a wrong offset!");
static_assert(offsetof(GAB_InterrogatePlayer_Reveal_C_Reveal, CallFunc_Not_PreBool_ReturnValue) == 0x000BF1, "Member 'GAB_InterrogatePlayer_Reveal_C_Reveal::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
