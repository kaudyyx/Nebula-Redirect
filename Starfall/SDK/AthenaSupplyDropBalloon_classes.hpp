...
static_assert(sizeof(AAthenaSupplyDropBalloon_C) == 0x000BA8, "Wrong size on AAthenaSupplyDropBalloon_C");
static_assert(offsetof(AAthenaSupplyDropBalloon_C, UberGraphFrame) == 0x000B68, "Member 'AAthenaSupplyDropBalloon_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AAthenaSupplyDropBalloon_C, FortHealthBar) == 0x000B70, "Member 'AAthenaSupplyDropBalloon_C::FortHealthBar' has a wrong offset!");
static_assert(offsetof(AAthenaSupplyDropBalloon_C, CrateDestroyed) == 0x000B78, "Member 'AAthenaSupplyDropBalloon_C::CrateDestroyed' has a wrong offset!");
static_assert(offsetof(AAthenaSupplyDropBalloon_C, OnBalloonDestroyed) == 0x000B80, "Member 'AAthenaSupplyDropBalloon_C::OnBalloonDestroyed' has a wrong offset!");
static_assert(offsetof(AAthenaSupplyDropBalloon_C, BalloonPopSound) == 0x000B90, "Member 'AAthenaSupplyDropBalloon_C::BalloonPopSound' has a wrong offset!");
static_assert(offsetof(AAthenaSupplyDropBalloon_C, BalloonPopFX) == 0x000B98, "Member 'AAthenaSupplyDropBalloon_C::BalloonPopFX' has a wrong offset!");
static_assert(offsetof(AAthenaSupplyDropBalloon_C, GE_DamageReduction) == 0x000BA0, "Member 'AAthenaSupplyDropBalloon_C::GE_DamageReduction' has a wrong offset!");
