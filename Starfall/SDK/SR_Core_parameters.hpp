...
static_assert(sizeof(SR_Core_C_HandleSeatStateUpdated) == 0x000038, "Wrong size on SR_Core_C_HandleSeatStateUpdated");
...
static_assert(offsetof(SR_Core_C_HandleSeatStateUpdated, K2Node_CreateDelegate_OutputDelegate_1) == 0x000028, "Member 'SR_Core_C_HandleSeatStateUpdated::K2Node_CreateDelegate_OutputDelegate_1' has a wrong offset!");
...
static_assert(sizeof(SR_Core_C_HandleOnSourcePlayed) == 0x000010, "Wrong size on SR_Core_C_HandleOnSourcePlayed");
