...
static_assert(offsetof(USmartObjectRenderingComponent, ReferenceDrawingMode) == 0x000440, "Member 'USmartObjectRenderingComponent::ReferenceDrawingMode' has a wrong offset!");
