...
static_assert(sizeof(UEventPlayerStatProfileSelector_C) == 0x0004D8, "Wrong size on UEventPlayerStatProfileSelector_C");
...
static_assert(offsetof(UEventPlayerStatProfileSelector_C, CommonTextBlock_2) == 0x0004C0, "Member 'UEventPlayerStatProfileSelector_C::CommonTextBlock_2' has a wrong offset!");
static_assert(offsetof(UEventPlayerStatProfileSelector_C, SafeZone_0) == 0x0004C8, "Member 'UEventPlayerStatProfileSelector_C::SafeZone_0' has a wrong offset!");
static_assert(offsetof(UEventPlayerStatProfileSelector_C, Switcher_Content) == 0x0004D0, "Member 'UEventPlayerStatProfileSelector_C::Switcher_Content' has a wrong offset!");
