...
public:
	...
	class UEmergencyNoticeWidget_C*               EmergencyNoticeWidget;                             // 0x04E0(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	struct FDataTableRowHandle                    LoginInputAction;                                  // 0x04E8(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)
...
static_assert(sizeof(USignInWidget_C) == 0x0004F8, "Wrong size on USignInWidget_C");
...
static_assert(offsetof(USignInWidget_C, EmergencyNoticeWidget) == 0x0004E0, "Member 'USignInWidget_C::EmergencyNoticeWidget' has a wrong offset!");
static_assert(offsetof(USignInWidget_C, LoginInputAction) == 0x0004E8, "Member 'USignInWidget_C::LoginInputAction' has a wrong offset!");
