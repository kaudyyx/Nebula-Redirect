...
static_assert(sizeof(AB_CameraLens_SwimBoost_C) == 0x000300, "Wrong size on AB_CameraLens_SwimBoost_C");
static_assert(offsetof(AB_CameraLens_SwimBoost_C, UberGraphFrame) == 0x0002E0, "Member 'AB_CameraLens_SwimBoost_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AB_CameraLens_SwimBoost_C, VelocityActor) == 0x0002E8, "Member 'AB_CameraLens_SwimBoost_C::VelocityActor' has a wrong offset!");
static_assert(offsetof(AB_CameraLens_SwimBoost_C, TargetRot) == 0x0002F0, "Member 'AB_CameraLens_SwimBoost_C::TargetRot' has a wrong offset!");
