...
static_assert(sizeof(ULeavePartyListEntry_C) == 0x000C70, "Wrong size on ULeavePartyListEntry_C");
...
static_assert(offsetof(ULeavePartyListEntry_C, InviteMaterial) == 0x000C10, "Member 'ULeavePartyListEntry_C::InviteMaterial' has a wrong offset!");
static_assert(offsetof(ULeavePartyListEntry_C, DefaultMaterial) == 0x000C18, "Member 'ULeavePartyListEntry_C::DefaultMaterial' has a wrong offset!");
static_assert(offsetof(ULeavePartyListEntry_C, InviteFontColor) == 0x000C20, "Member 'ULeavePartyListEntry_C::InviteFontColor' has a wrong offset!");
static_assert(offsetof(ULeavePartyListEntry_C, DefaultFontColor) == 0x000C48, "Member 'ULeavePartyListEntry_C::DefaultFontColor' has a wrong offset!");
