...
static_assert(sizeof(AAthena_Prop_SneakySnowman_C) == 0x000CA0, "Wrong size on AAthena_Prop_SneakySnowman_C");
static_assert(offsetof(AAthena_Prop_SneakySnowman_C, UberGraphFrame) == 0x000BD8, "Member 'AAthena_Prop_SneakySnowman_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AAthena_Prop_SneakySnowman_C, OverlapCheck) == 0x000BE0, "Member 'AAthena_Prop_SneakySnowman_C::OverlapCheck' has a wrong offset!");
static_assert(offsetof(AAthena_Prop_SneakySnowman_C, ProjectileMovementComp) == 0x000BE8, "Member 'AAthena_Prop_SneakySnowman_C::ProjectileMovementComp' has a wrong offset!");
static_assert(offsetof(AAthena_Prop_SneakySnowman_C, bSimulationRunning) == 0x000BF0, "Member 'AAthena_Prop_SneakySnowman_C::bSimulationRunning' has a wrong offset!");
static_assert(offsetof(AAthena_Prop_SneakySnowman_C, GE_ApplyEnemySnowman) == 0x000BF8, "Member 'AAthena_Prop_SneakySnowman_C::GE_ApplyEnemySnowman' has a wrong offset!");
static_assert(offsetof(AAthena_Prop_SneakySnowman_C, ShouldSnowmanEnemies) == 0x000C00, "Member 'AAthena_Prop_SneakySnowman_C::ShouldSnowmanEnemies' has a wrong offset!");
static_assert(offsetof(AAthena_Prop_SneakySnowman_C, PickupAthena) == 0x000C20, "Member 'AAthena_Prop_SneakySnowman_C::PickupAthena' has a wrong offset!");
static_assert(offsetof(AAthena_Prop_SneakySnowman_C, Ignored_Actors) == 0x000C28, "Member 'AAthena_Prop_SneakySnowman_C::Ignored_Actors' has a wrong offset!");
static_assert(offsetof(AAthena_Prop_SneakySnowman_C, LineTraceObjects) == 0x000C38, "Member 'AAthena_Prop_SneakySnowman_C::LineTraceObjects' has a wrong offset!");
static_assert(offsetof(AAthena_Prop_SneakySnowman_C, DestroyAfterHit) == 0x000C48, "Member 'AAthena_Prop_SneakySnowman_C::DestroyAfterHit' has a wrong offset!");
static_assert(offsetof(AAthena_Prop_SneakySnowman_C, LandedLocation) == 0x000C4C, "Member 'AAthena_Prop_SneakySnowman_C::LandedLocation' has a wrong offset!");
static_assert(offsetof(AAthena_Prop_SneakySnowman_C, InitialGravityScale) == 0x000C58, "Member 'AAthena_Prop_SneakySnowman_C::InitialGravityScale' has a wrong offset!");
static_assert(offsetof(AAthena_Prop_SneakySnowman_C, GamestateLoaded) == 0x000C5C, "Member 'AAthena_Prop_SneakySnowman_C::GamestateLoaded' has a wrong offset!");
static_assert(offsetof(AAthena_Prop_SneakySnowman_C, ObjectTypes) == 0x000C60, "Member 'AAthena_Prop_SneakySnowman_C::ObjectTypes' has a wrong offset!");
static_assert(offsetof(AAthena_Prop_SneakySnowman_C, StopLocation) == 0x000C70, "Member 'AAthena_Prop_SneakySnowman_C::StopLocation' has a wrong offset!");
static_assert(offsetof(AAthena_Prop_SneakySnowman_C, FallHeightToDestroy) == 0x000C80, "Member 'AAthena_Prop_SneakySnowman_C::FallHeightToDestroy' has a wrong offset!");
