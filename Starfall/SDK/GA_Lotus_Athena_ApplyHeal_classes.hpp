...
static_assert(sizeof(UGA_Lotus_Athena_ApplyHeal_C) == 0x000AB0, "Wrong size on UGA_Lotus_Athena_ApplyHeal_C");
static_assert(offsetof(UGA_Lotus_Athena_ApplyHeal_C, UberGraphFrame) == 0x000AA8, "Member 'UGA_Lotus_Athena_ApplyHeal_C::UberGraphFrame' has a wrong offset!");
