...
static_assert(sizeof(UMissedInvitesEntry_C) == 0x000C78, "Wrong size on UMissedInvitesEntry_C");
...
static_assert(offsetof(UMissedInvitesEntry_C, InviteMaterial) == 0x000C18, "Member 'UMissedInvitesEntry_C::InviteMaterial' has a wrong offset!");
static_assert(offsetof(UMissedInvitesEntry_C, DefaultMaterial) == 0x000C20, "Member 'UMissedInvitesEntry_C::DefaultMaterial' has a wrong offset!");
static_assert(offsetof(UMissedInvitesEntry_C, InviteFontColor) == 0x000C28, "Member 'UMissedInvitesEntry_C::InviteFontColor' has a wrong offset!");
static_assert(offsetof(UMissedInvitesEntry_C, DefaultFontColor) == 0x000C50, "Member 'UMissedInvitesEntry_C::DefaultFontColor' has a wrong offset!");
