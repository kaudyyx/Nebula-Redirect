...
static_assert(sizeof(UGAT_Creative_TriggeredAbility_C) == 0x000AD8, "Wrong size on UGAT_Creative_TriggeredAbility_C");
static_assert(offsetof(UGAT_Creative_TriggeredAbility_C, UberGraphFrame_GAT_Creative_TriggeredAbility_C) == 0x000AC0, "Member 'UGAT_Creative_TriggeredAbility_C::UberGraphFrame_GAT_Creative_TriggeredAbility_C' has a wrong offset!");
static_assert(offsetof(UGAT_Creative_TriggeredAbility_C, OverriddenPropertyNames) == 0x000AC8, "Member 'UGAT_Creative_TriggeredAbility_C::OverriddenPropertyNames' has a wrong offset!");
