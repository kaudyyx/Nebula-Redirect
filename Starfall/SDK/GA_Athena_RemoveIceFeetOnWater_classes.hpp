...
static_assert(sizeof(UGA_Athena_RemoveIceFeetOnWater_C) == 0x000AB0, "Wrong size on UGA_Athena_RemoveIceFeetOnWater_C");
static_assert(offsetof(UGA_Athena_RemoveIceFeetOnWater_C, UberGraphFrame) == 0x000AA8, "Member 'UGA_Athena_RemoveIceFeetOnWater_C::UberGraphFrame' has a wrong offset!");
