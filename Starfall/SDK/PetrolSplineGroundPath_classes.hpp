...
static_assert(sizeof(APetrolSplineGroundPath_C) == 0x000A48, "Wrong size on APetrolSplineGroundPath_C");
static_assert(offsetof(APetrolSplineGroundPath_C, DefaultSceneRoot) == 0x000A40, "Member 'APetrolSplineGroundPath_C::DefaultSceneRoot' has a wrong offset!");
