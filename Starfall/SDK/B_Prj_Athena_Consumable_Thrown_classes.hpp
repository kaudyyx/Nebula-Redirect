...
static_assert(sizeof(AB_Prj_Athena_Consumable_Thrown_C) == 0x000908, "Wrong size on AB_Prj_Athena_Consumable_Thrown_C");
...
static_assert(offsetof(AB_Prj_Athena_Consumable_Thrown_C, BounceOffWallSound) == 0x0008D0, "Member 'AB_Prj_Athena_Consumable_Thrown_C::BounceOffWallSound' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_Consumable_Thrown_C, Pickup) == 0x0008D8, "Member 'AB_Prj_Athena_Consumable_Thrown_C::Pickup' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_Consumable_Thrown_C, SpawnFX) == 0x0008E0, "Member 'AB_Prj_Athena_Consumable_Thrown_C::SpawnFX' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_Consumable_Thrown_C, SpawnFX_Water) == 0x0008E8, "Member 'AB_Prj_Athena_Consumable_Thrown_C::SpawnFX_Water' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_Consumable_Thrown_C, SpawnSound) == 0x0008F0, "Member 'AB_Prj_Athena_Consumable_Thrown_C::SpawnSound' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_Consumable_Thrown_C, Splash_Sound_) == 0x0008F8, "Member 'AB_Prj_Athena_Consumable_Thrown_C::Splash_Sound_' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_Consumable_Thrown_C, WaterSpawnDelay) == 0x000900, "Member 'AB_Prj_Athena_Consumable_Thrown_C::WaterSpawnDelay' has a wrong offset!");
