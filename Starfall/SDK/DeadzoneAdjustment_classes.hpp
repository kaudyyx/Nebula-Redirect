...
static_assert(sizeof(UDeadzoneAdjustment_C) == 0x000298, "Wrong size on UDeadzoneAdjustment_C");
...
static_assert(offsetof(UDeadzoneAdjustment_C, ScaleValue) == 0x000288, "Member 'UDeadzoneAdjustment_C::ScaleValue' has a wrong offset!");
static_assert(offsetof(UDeadzoneAdjustment_C, MaxValue) == 0x00028C, "Member 'UDeadzoneAdjustment_C::MaxValue' has a wrong offset!");
static_assert(offsetof(UDeadzoneAdjustment_C, MinValue) == 0x000290, "Member 'UDeadzoneAdjustment_C::MinValue' has a wrong offset!");
static_assert(offsetof(UDeadzoneAdjustment_C, SettingType) == 0x000294, "Member 'UDeadzoneAdjustment_C::SettingType' has a wrong offset!");
