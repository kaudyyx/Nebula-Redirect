...
static_assert(sizeof(ATrap_Athena_WallSpikes_C) == 0x000E78, "Wrong size on ATrap_Athena_WallSpikes_C");
static_assert(offsetof(ATrap_Athena_WallSpikes_C, UberGraphFrame_Trap_Athena_WallSpikes_C) == 0x000E70, "Member 'ATrap_Athena_WallSpikes_C::UberGraphFrame_Trap_Athena_WallSpikes_C' has a wrong offset!");
