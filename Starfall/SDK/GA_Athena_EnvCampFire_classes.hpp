...
static_assert(sizeof(UGA_Athena_EnvCampFire_C) == 0x000BF0, "Wrong size on UGA_Athena_EnvCampFire_C");
static_assert(offsetof(UGA_Athena_EnvCampFire_C, UberGraphFrame) == 0x000AA8, "Member 'UGA_Athena_EnvCampFire_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGA_Athena_EnvCampFire_C, TimeBetweenHeals) == 0x000AB0, "Member 'UGA_Athena_EnvCampFire_C::TimeBetweenHeals' has a wrong offset!");
static_assert(offsetof(UGA_Athena_EnvCampFire_C, Timer_ApplyHeal) == 0x000AB8, "Member 'UGA_Athena_EnvCampFire_C::Timer_ApplyHeal' has a wrong offset!");
static_assert(offsetof(UGA_Athena_EnvCampFire_C, MaxHeals) == 0x000AC0, "Member 'UGA_Athena_EnvCampFire_C::MaxHeals' has a wrong offset!");
static_assert(offsetof(UGA_Athena_EnvCampFire_C, CurrentHeals) == 0x000AC4, "Member 'UGA_Athena_EnvCampFire_C::CurrentHeals' has a wrong offset!");
static_assert(offsetof(UGA_Athena_EnvCampFire_C, CustomTargeting) == 0x000AD0, "Member 'UGA_Athena_EnvCampFire_C::CustomTargeting' has a wrong offset!");
static_assert(offsetof(UGA_Athena_EnvCampFire_C, TargetingHeightOffset) == 0x000B00, "Member 'UGA_Athena_EnvCampFire_C::TargetingHeightOffset' has a wrong offset!");
static_assert(offsetof(UGA_Athena_EnvCampFire_C, Row_MaxHeals) == 0x000B08, "Member 'UGA_Athena_EnvCampFire_C::Row_MaxHeals' has a wrong offset!");
static_assert(offsetof(UGA_Athena_EnvCampFire_C, Row_TimeBetweenHeals) == 0x000B28, "Member 'UGA_Athena_EnvCampFire_C::Row_TimeBetweenHeals' has a wrong offset!");
static_assert(offsetof(UGA_Athena_EnvCampFire_C, StokeTimeBetweenHeals) == 0x000B48, "Member 'UGA_Athena_EnvCampFire_C::StokeTimeBetweenHeals' has a wrong offset!");
static_assert(offsetof(UGA_Athena_EnvCampFire_C, Row_StokeDuration) == 0x000B50, "Member 'UGA_Athena_EnvCampFire_C::Row_StokeDuration' has a wrong offset!");
static_assert(offsetof(UGA_Athena_EnvCampFire_C, Row_Stoke_TimeBetweenHeals) == 0x000B70, "Member 'UGA_Athena_EnvCampFire_C::Row_Stoke_TimeBetweenHeals' has a wrong offset!");
static_assert(offsetof(UGA_Athena_EnvCampFire_C, Row_Stoke_MaxHeals_Extension) == 0x000B90, "Member 'UGA_Athena_EnvCampFire_C::Row_Stoke_MaxHeals_Extension' has a wrong offset!");
static_assert(offsetof(UGA_Athena_EnvCampFire_C, IsStoked) == 0x000BB0, "Member 'UGA_Athena_EnvCampFire_C::IsStoked' has a wrong offset!");
static_assert(offsetof(UGA_Athena_EnvCampFire_C, Row_HealPerTick) == 0x000BB8, "Member 'UGA_Athena_EnvCampFire_C::Row_HealPerTick' has a wrong offset!");
static_assert(offsetof(UGA_Athena_EnvCampFire_C, GC_StokedLoop) == 0x000BD8, "Member 'UGA_Athena_EnvCampFire_C::GC_StokedLoop' has a wrong offset!");
static_assert(offsetof(UGA_Athena_EnvCampFire_C, GC_StokeBurst) == 0x000BE0, "Member 'UGA_Athena_EnvCampFire_C::GC_StokeBurst' has a wrong offset!");
static_assert(offsetof(UGA_Athena_EnvCampFire_C, Campfire) == 0x000BE8, "Member 'UGA_Athena_EnvCampFire_C::Campfire' has a wrong offset!");
