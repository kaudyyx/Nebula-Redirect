...
static_assert(sizeof(GCN_Zipline_SpeedLines_C_OnBurst) == 0x000450, "Wrong size on GCN_Zipline_SpeedLines_C_OnBurst");
...
static_assert(offsetof(GCN_Zipline_SpeedLines_C_OnBurst, CallFunc_BreakHitResult_ElementIndex) == 0x000374, "Member 'GCN_Zipline_SpeedLines_C_OnBurst::CallFunc_BreakHitResult_ElementIndex' has a wrong offset!");
static_assert(offsetof(GCN_Zipline_SpeedLines_C_OnBurst, CallFunc_BreakHitResult_FaceIndex) == 0x000378, "Member 'GCN_Zipline_SpeedLines_C_OnBurst::CallFunc_BreakHitResult_FaceIndex' has a wrong offset!");
static_assert(offsetof(GCN_Zipline_SpeedLines_C_OnBurst, CallFunc_BreakHitResult_TraceStart) == 0x00037C, "Member 'GCN_Zipline_SpeedLines_C_OnBurst::CallFunc_BreakHitResult_TraceStart' has a wrong offset!");
static_assert(offsetof(GCN_Zipline_SpeedLines_C_OnBurst, CallFunc_BreakHitResult_TraceEnd) == 0x000388, "Member 'GCN_Zipline_SpeedLines_C_OnBurst::CallFunc_BreakHitResult_TraceEnd' has a wrong offset!");
static_assert(offsetof(GCN_Zipline_SpeedLines_C_OnBurst, CallFunc_Multiply_VectorFloat_ReturnValue_1) == 0x000394, "Member 'GCN_Zipline_SpeedLines_C_OnBurst::CallFunc_Multiply_VectorFloat_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(GCN_Zipline_SpeedLines_C_OnBurst, CallFunc_Conv_VectorToRotator_ReturnValue) == 0x0003A0, "Member 'GCN_Zipline_SpeedLines_C_OnBurst::CallFunc_Conv_VectorToRotator_ReturnValue' has a wrong offset!");
static_assert(offsetof(GCN_Zipline_SpeedLines_C_OnBurst, CallFunc_Conv_VectorToRotator_ReturnValue_1) == 0x0003AC, "Member 'GCN_Zipline_SpeedLines_C_OnBurst::CallFunc_Conv_VectorToRotator_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(GCN_Zipline_SpeedLines_C_OnBurst, CallFunc_K2_SetWorldLocationAndRotation_SweepHitResult) == 0x0003B8, "Member 'GCN_Zipline_SpeedLines_C_OnBurst::CallFunc_K2_SetWorldLocationAndRotation_SweepHitResult' has a wrong offset!");
static_assert(offsetof(GCN_Zipline_SpeedLines_C_OnBurst, CallFunc_SpawnDecalAtLocation_ReturnValue) == 0x000448, "Member 'GCN_Zipline_SpeedLines_C_OnBurst::CallFunc_SpawnDecalAtLocation_ReturnValue' has a wrong offset!");
