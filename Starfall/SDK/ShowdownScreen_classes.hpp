...
static_assert(sizeof(UShowdownScreen_C) == 0x0005C0, "Wrong size on UShowdownScreen_C");
...
static_assert(offsetof(UShowdownScreen_C, Input_ShowAbout) == 0x000570, "Member 'UShowdownScreen_C::Input_ShowAbout' has a wrong offset!");
static_assert(offsetof(UShowdownScreen_C, PrimaryColor) == 0x000580, "Member 'UShowdownScreen_C::PrimaryColor' has a wrong offset!");
static_assert(offsetof(UShowdownScreen_C, Input_ShowDetails) == 0x0005A8, "Member 'UShowdownScreen_C::Input_ShowDetails' has a wrong offset!");
static_assert(offsetof(UShowdownScreen_C, SelectedTile) == 0x0005B8, "Member 'UShowdownScreen_C::SelectedTile' has a wrong offset!");
