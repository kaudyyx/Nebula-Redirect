...
static_assert(sizeof(AFrontendCamera_Manage_C) == 0x000800, "Wrong size on AFrontendCamera_Manage_C");
...
static_assert(offsetof(AFrontendCamera_Manage_C, ChangeTimeOfDayOnActivate) == 0x0007F0, "Member 'AFrontendCamera_Manage_C::ChangeTimeOfDayOnActivate' has a wrong offset!");
