...
static_assert(sizeof(GA_Ranged_Mustache_Attribute_C_K2_CanActivateAbility) == 0x0000A8, "Wrong size on GA_Ranged_Mustache_Attribute_C_K2_CanActivateAbility");
...
static_assert(offsetof(GA_Ranged_Mustache_Attribute_C_K2_CanActivateAbility, Handle) == 0x000048, "Member 'GA_Ranged_Mustache_Attribute_C_K2_CanActivateAbility::Handle' has a wrong offset!");
static_assert(offsetof(GA_Ranged_Mustache_Attribute_C_K2_CanActivateAbility, RelevantTags) == 0x000050, "Member 'GA_Ranged_Mustache_Attribute_C_K2_CanActivateAbility::RelevantTags' has a wrong offset!");
static_assert(offsetof(GA_Ranged_Mustache_Attribute_C_K2_CanActivateAbility, ReturnValue) == 0x000070, "Member 'GA_Ranged_Mustache_Attribute_C_K2_CanActivateAbility::ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_Ranged_Mustache_Attribute_C_K2_CanActivateAbility, CallFunc_GetAvatarActorFromActorInfo_ReturnValue) == 0x000078, "Member 'GA_Ranged_Mustache_Attribute_C_K2_CanActivateAbility::CallFunc_GetAvatarActorFromActorInfo_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_Ranged_Mustache_Attribute_C_K2_CanActivateAbility, K2Node_DynamicCast_AsFort_Player_Pawn) == 0x000080, "Member 'GA_Ranged_Mustache_Attribute_C_K2_CanActivateAbility::K2Node_DynamicCast_AsFort_Player_Pawn' has a wrong offset!");
static_assert(offsetof(GA_Ranged_Mustache_Attribute_C_K2_CanActivateAbility, K2Node_DynamicCast_bSuccess) == 0x000088, "Member 'GA_Ranged_Mustache_Attribute_C_K2_CanActivateAbility::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(GA_Ranged_Mustache_Attribute_C_K2_CanActivateAbility, CallFunc_GetFloatAttribute_bSuccessfullyFoundAttribute) == 0x000089, "Member 'GA_Ranged_Mustache_Attribute_C_K2_CanActivateAbility::CallFunc_GetFloatAttribute_bSuccessfullyFoundAttribute' has a wrong offset!");
static_assert(offsetof(GA_Ranged_Mustache_Attribute_C_K2_CanActivateAbility, CallFunc_GetFloatAttribute_ReturnValue) == 0x00008C, "Member 'GA_Ranged_Mustache_Attribute_C_K2_CanActivateAbility::CallFunc_GetFloatAttribute_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_Ranged_Mustache_Attribute_C_K2_CanActivateAbility, CallFunc_GreaterEqual_FloatFloat_ReturnValue) == 0x000090, "Member 'GA_Ranged_Mustache_Attribute_C_K2_CanActivateAbility::CallFunc_GreaterEqual_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_Ranged_Mustache_Attribute_C_K2_CanActivateAbility, K2Node_DynamicCast_AsB_Ranged_Lotus_Mustache) == 0x000098, "Member 'GA_Ranged_Mustache_Attribute_C_K2_CanActivateAbility::K2Node_DynamicCast_AsB_Ranged_Lotus_Mustache' has a wrong offset!");
static_assert(offsetof(GA_Ranged_Mustache_Attribute_C_K2_CanActivateAbility, K2Node_DynamicCast_bSuccess_1) == 0x0000A0, "Member 'GA_Ranged_Mustache_Attribute_C_K2_CanActivateAbility::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(GA_Ranged_Mustache_Attribute_C_K2_CanActivateAbility, CallFunc_GreaterEqual_FloatFloat_ReturnValue_1) == 0x0000A1, "Member 'GA_Ranged_Mustache_Attribute_C_K2_CanActivateAbility::CallFunc_GreaterEqual_FloatFloat_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(GA_Ranged_Mustache_Attribute_C_K2_CanActivateAbility, CallFunc_IsValid_ReturnValue) == 0x0000A2, "Member 'GA_Ranged_Mustache_Attribute_C_K2_CanActivateAbility::CallFunc_IsValid_ReturnValue' has a wrong offset!");
