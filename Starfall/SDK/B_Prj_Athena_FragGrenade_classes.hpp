...
static_assert(sizeof(AB_Prj_Athena_FragGrenade_C) == 0x000968, "Wrong size on AB_Prj_Athena_FragGrenade_C");
static_assert(offsetof(AB_Prj_Athena_FragGrenade_C, UberGraphFrame_B_Prj_Athena_FragGrenade_C) == 0x000940, "Member 'AB_Prj_Athena_FragGrenade_C::UberGraphFrame_B_Prj_Athena_FragGrenade_C' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_FragGrenade_C, BP_SurfaceTypeSoundComponent) == 0x000948, "Member 'AB_Prj_Athena_FragGrenade_C::BP_SurfaceTypeSoundComponent' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_FragGrenade_C, PreExploWarning_PreExplo_E5859FFE443F57359EC2C0AB73DFA4CD) == 0x000950, "Member 'AB_Prj_Athena_FragGrenade_C::PreExploWarning_PreExplo_E5859FFE443F57359EC2C0AB73DFA4CD' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_FragGrenade_C, PreExploWarning__Direction_E5859FFE443F57359EC2C0AB73DFA4CD) == 0x000954, "Member 'AB_Prj_Athena_FragGrenade_C::PreExploWarning__Direction_E5859FFE443F57359EC2C0AB73DFA4CD' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_FragGrenade_C, PreExploWarning) == 0x000958, "Member 'AB_Prj_Athena_FragGrenade_C::PreExploWarning' has a wrong offset!");
static_assert(offsetof(AB_Prj_Athena_FragGrenade_C, FeedbackCue) == 0x000960, "Member 'AB_Prj_Athena_FragGrenade_C::FeedbackCue' has a wrong offset!");
