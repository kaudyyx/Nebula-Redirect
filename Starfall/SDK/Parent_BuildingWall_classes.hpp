...
static_assert(sizeof(AParent_BuildingWall_C) == 0x000CE8, "Wrong size on AParent_BuildingWall_C");
static_assert(offsetof(AParent_BuildingWall_C, BuildingBoundsMax) == 0x000CD0, "Member 'AParent_BuildingWall_C::BuildingBoundsMax' has a wrong offset!");
static_assert(offsetof(AParent_BuildingWall_C, BuildingBoundsMin) == 0x000CDC, "Member 'AParent_BuildingWall_C::BuildingBoundsMin' has a wrong offset!");
