...
#include "GCN_LowTower_Chaplin_PrjImpact_classes.hpp"
#include "GCN_LowTower_Chaplin_PrjImpact_parameters.hpp"
...
void UGCN_LowTower_Chaplin_PrjImpact_C::OnBurstGeneric(class AActor* MyTarget, const struct FGameplayCueParameters& Parameters, const TArray<class UFXSystemComponent*>& ParticleComponents, const TArray<class UAudioComponent*>& AudioComponents, class UMatineeCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCN_LowTower_Chaplin_PrjImpact_C", "OnBurstGeneric");

	Params::GCN_LowTower_Chaplin_PrjImpact_C_OnBurstGeneric Parms{};
