...
static_assert(sizeof(AGCNL_Athena_HidingProp_Teleporting_C) == 0x0007E8, "Wrong size on AGCNL_Athena_HidingProp_Teleporting_C");
static_assert(offsetof(AGCNL_Athena_HidingProp_Teleporting_C, UberGraphFrame) == 0x0007C0, "Member 'AGCNL_Athena_HidingProp_Teleporting_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AGCNL_Athena_HidingProp_Teleporting_C, Timeline_0_LerpWhiteWash_3C12694840EC8C9B33E562A2C6B279BA) == 0x0007C8, "Member 'AGCNL_Athena_HidingProp_Teleporting_C::Timeline_0_LerpWhiteWash_3C12694840EC8C9B33E562A2C6B279BA' has a wrong offset!");
static_assert(offsetof(AGCNL_Athena_HidingProp_Teleporting_C, Timeline_0__Direction_3C12694840EC8C9B33E562A2C6B279BA) == 0x0007CC, "Member 'AGCNL_Athena_HidingProp_Teleporting_C::Timeline_0__Direction_3C12694840EC8C9B33E562A2C6B279BA' has a wrong offset!");
static_assert(offsetof(AGCNL_Athena_HidingProp_Teleporting_C, Timeline_0) == 0x0007D0, "Member 'AGCNL_Athena_HidingProp_Teleporting_C::Timeline_0' has a wrong offset!");
static_assert(offsetof(AGCNL_Athena_HidingProp_Teleporting_C, LensEffect) == 0x0007D8, "Member 'AGCNL_Athena_HidingProp_Teleporting_C::LensEffect' has a wrong offset!");
static_assert(offsetof(AGCNL_Athena_HidingProp_Teleporting_C, OnePTravelAudio) == 0x0007E0, "Member 'AGCNL_Athena_HidingProp_Teleporting_C::OnePTravelAudio' has a wrong offset!");
