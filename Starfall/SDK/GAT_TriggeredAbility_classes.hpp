...
static_assert(offsetof(UGAT_TriggeredAbility_C, UberGraphFrame) == 0x000AA8, "Member 'UGAT_TriggeredAbility_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGAT_TriggeredAbility_C, TC_AbilitiesGenericTriggeredAbilityActivate) == 0x000AB0, "Member 'UGAT_TriggeredAbility_C::TC_AbilitiesGenericTriggeredAbilityActivate' has a wrong offset!");
static_assert(offsetof(UGAT_TriggeredAbility_C, bPlayerHolsterState) == 0x000AB8, "Member 'UGAT_TriggeredAbility_C::bPlayerHolsterState' has a wrong offset!");
