...
static_assert(sizeof(AB_WilliePete_WaterBodyChild_C) == 0x000F30, "Wrong size on AB_WilliePete_WaterBodyChild_C");
static_assert(offsetof(AB_WilliePete_WaterBodyChild_C, UberGraphFrame) == 0x000F20, "Member 'AB_WilliePete_WaterBodyChild_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AB_WilliePete_WaterBodyChild_C, Debug) == 0x000F28, "Member 'AB_WilliePete_WaterBodyChild_C::Debug' has a wrong offset!");
