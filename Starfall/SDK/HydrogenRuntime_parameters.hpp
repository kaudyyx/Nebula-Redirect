...
static_assert(alignof(FortAthenaMutator_Hydrogen_OnGamePhaseStepChanged) == 0x000008, "Wrong alignment on FortAthenaMutator_Hydrogen_OnGamePhaseStepChanged");
static_assert(sizeof(FortAthenaMutator_Hydrogen_OnGamePhaseStepChanged) == 0x000018, "Wrong size on FortAthenaMutator_Hydrogen_OnGamePhaseStepChanged");
static_assert(offsetof(FortAthenaMutator_Hydrogen_OnGamePhaseStepChanged, SafeZoneInterfaceConst) == 0x000000, "Member 'FortAthenaMutator_Hydrogen_OnGamePhaseStepChanged::SafeZoneInterfaceConst' has a wrong offset!");
static_assert(offsetof(FortAthenaMutator_Hydrogen_OnGamePhaseStepChanged, GamePhaseStep) == 0x000010, "Member 'FortAthenaMutator_Hydrogen_OnGamePhaseStepChanged::GamePhaseStep' has a wrong offset!");
