...
static_assert(sizeof(UGA_Athena_ShockGrenade_RemoveFX_C) == 0x000AD0, "Wrong size on UGA_Athena_ShockGrenade_RemoveFX_C");
static_assert(offsetof(UGA_Athena_ShockGrenade_RemoveFX_C, UberGraphFrame) == 0x000AA8, "Member 'UGA_Athena_ShockGrenade_RemoveFX_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGA_Athena_ShockGrenade_RemoveFX_C, PlayerPawn) == 0x000AB0, "Member 'UGA_Athena_ShockGrenade_RemoveFX_C::PlayerPawn' has a wrong offset!");
static_assert(offsetof(UGA_Athena_ShockGrenade_RemoveFX_C, Looping_GC) == 0x000AB8, "Member 'UGA_Athena_ShockGrenade_RemoveFX_C::Looping_GC' has a wrong offset!");
static_assert(offsetof(UGA_Athena_ShockGrenade_RemoveFX_C, Player_Landing_GC) == 0x000AC0, "Member 'UGA_Athena_ShockGrenade_RemoveFX_C::Player_Landing_GC' has a wrong offset!");
static_assert(offsetof(UGA_Athena_ShockGrenade_RemoveFX_C, VehicleOnGroundTimer) == 0x000AC8, "Member 'UGA_Athena_ShockGrenade_RemoveFX_C::VehicleOnGroundTimer' has a wrong offset!");
