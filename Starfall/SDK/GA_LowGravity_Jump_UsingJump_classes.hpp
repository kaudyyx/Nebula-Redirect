...
static_assert(sizeof(UGA_LowGravity_Jump_UsingJump_C) == 0x000AE8, "Wrong size on UGA_LowGravity_Jump_UsingJump_C");
...
static_assert(offsetof(UGA_LowGravity_Jump_UsingJump_C, JumpType) == 0x000AC8, "Member 'UGA_LowGravity_Jump_UsingJump_C::JumpType' has a wrong offset!");
static_assert(offsetof(UGA_LowGravity_Jump_UsingJump_C, JumpIdle) == 0x000AC9, "Member 'UGA_LowGravity_Jump_UsingJump_C::JumpIdle' has a wrong offset!");
static_assert(offsetof(UGA_LowGravity_Jump_UsingJump_C, JumpWalk) == 0x000ACA, "Member 'UGA_LowGravity_Jump_UsingJump_C::JumpWalk' has a wrong offset!");
static_assert(offsetof(UGA_LowGravity_Jump_UsingJump_C, JumpSprint) == 0x000ACB, "Member 'UGA_LowGravity_Jump_UsingJump_C::JumpSprint' has a wrong offset!");
static_assert(offsetof(UGA_LowGravity_Jump_UsingJump_C, PlayerPawn) == 0x000AD0, "Member 'UGA_LowGravity_Jump_UsingJump_C::PlayerPawn' has a wrong offset!");
static_assert(offsetof(UGA_LowGravity_Jump_UsingJump_C, LiftOffCue) == 0x000AD8, "Member 'UGA_LowGravity_Jump_UsingJump_C::LiftOffCue' has a wrong offset!");
static_assert(offsetof(UGA_LowGravity_Jump_UsingJump_C, LandCue) == 0x000AE0, "Member 'UGA_LowGravity_Jump_UsingJump_C::LandCue' has a wrong offset!");
