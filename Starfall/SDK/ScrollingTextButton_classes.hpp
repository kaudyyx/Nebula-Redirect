...
public:
	...
	struct FDataTableRowHandle                    ButtonClickAction;                                 // 0x0C70(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)
...
static_assert(sizeof(UScrollingTextButton_C) == 0x000C88, "Wrong size on UScrollingTextButton_C");
...
static_assert(offsetof(UScrollingTextButton_C, ButtonClickAction) == 0x000C70, "Member 'UScrollingTextButton_C::ButtonClickAction' has a wrong offset!");
static_assert(offsetof(UScrollingTextButton_C, ContentAlignment) == 0x000C80, "Member 'UScrollingTextButton_C::ContentAlignment' has a wrong offset!");
static_assert(offsetof(UScrollingTextButton_C, bMouseKeyboardStyleSet) == 0x000C81, "Member 'UScrollingTextButton_C::bMouseKeyboardStyleSet' has a wrong offset!");
