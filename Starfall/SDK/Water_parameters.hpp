...
static_assert(sizeof(BuoyancyComponent_OnPontoonEnteredWater) == 0x000140, "Wrong size on BuoyancyComponent_OnPontoonEnteredWater");
...
static_assert(sizeof(BuoyancyComponent_OnPontoonExitedWater) == 0x000140, "Wrong size on BuoyancyComponent_OnPontoonExitedWater");
