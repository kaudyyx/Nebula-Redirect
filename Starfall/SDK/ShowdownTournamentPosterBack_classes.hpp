...
static_assert(sizeof(UShowdownTournamentPosterBack_C) == 0x000798, "Wrong size on UShowdownTournamentPosterBack_C");
...
static_assert(offsetof(UShowdownTournamentPosterBack_C, DateRowMax) == 0x000790, "Member 'UShowdownTournamentPosterBack_C::DateRowMax' has a wrong offset!");
