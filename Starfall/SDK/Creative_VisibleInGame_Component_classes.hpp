...
public:
	...
	TMulticastInlineDelegate<void(bool Visible)>  On_Visibility_Changed;                             // 0x00C0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
