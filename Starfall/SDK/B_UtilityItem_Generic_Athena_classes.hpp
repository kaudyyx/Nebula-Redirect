...
static_assert(sizeof(AB_UtilityItem_Generic_Athena_C) == 0x000CC8, "Wrong size on AB_UtilityItem_Generic_Athena_C");
static_assert(offsetof(AB_UtilityItem_Generic_Athena_C, UberGraphFrame) == 0x000CB8, "Member 'AB_UtilityItem_Generic_Athena_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AB_UtilityItem_Generic_Athena_C, UseThrowConsumableHudKeyActions) == 0x000CC0, "Member 'AB_UtilityItem_Generic_Athena_C::UseThrowConsumableHudKeyActions' has a wrong offset!");
